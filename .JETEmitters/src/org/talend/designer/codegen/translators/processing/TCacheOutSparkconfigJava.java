...
public class TCacheOutSparkconfigJava
{
  protected static String nl;
  public static synchronized TCacheOutSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCacheOutSparkconfigJava result = new TCacheOutSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_80 = "> rdd_cached_";
  protected final String TEXT_81 = " = rdd_";
  protected final String TEXT_82 = ".persist(org.apache.spark.storage.StorageLevel.";
  protected final String TEXT_83 = "());" + NL + "" + NL + "    globalMap.putLocal(\"rdd_cached_";
  protected final String TEXT_84 = "\", rdd_cached_";
...
functionGenerator.init(node, cid, null, tCacheUtil.getInConnName(), null, tCacheUtil.getOutConnMainName() != null? tCacheUtil.getOutConnMainName(): tCacheUtil.getOutConnRejectName());
    ...
    stringBuffer.append(tCacheUtil.getInConnName());
