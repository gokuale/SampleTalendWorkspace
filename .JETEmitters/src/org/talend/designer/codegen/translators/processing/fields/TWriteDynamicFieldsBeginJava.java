...
public class TWriteDynamicFieldsBeginJava
{
  protected static String nl;
  public static synchronized TWriteDynamicFieldsBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TWriteDynamicFieldsBeginJava result = new TWriteDynamicFieldsBeginJava();
    nl = null;
    return result;
  }
...
LogUtil log = null;
	...
	if(log.isActive()){
    	...
    	log.debug(log.str("The input columns are: " + inColumns.toString() + "."));
    	log.debug(log.str("The output columns are: " + outColumns.toString() + ", the dynamic column is " + dynamicColName + "."));
	}
