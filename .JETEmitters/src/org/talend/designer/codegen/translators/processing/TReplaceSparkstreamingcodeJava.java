...
public class TReplaceSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TReplaceSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TReplaceSparkstreamingcodeJava result = new TReplaceSparkstreamingcodeJava();
    nl = null;
    return result;
  }
...
sparkTransformUtil.generateSparkCode(tReplaceUtil, sparkFunction);
