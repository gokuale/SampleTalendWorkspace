...
public class TExtractDynamicFieldsBeginJava
{
  protected static String nl;
  public static synchronized TExtractDynamicFieldsBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractDynamicFieldsBeginJava result = new TExtractDynamicFieldsBeginJava();
    nl = null;
    return result;
  }
...
LogUtil log = null;
	...
	if(log.isActive()){
    	...
    	log.debug(log.str("The input columns are: " + inColumns.toString() + ", the dynamic column is " + dynamicColName + "."));
    	log.debug(log.str("The output columns are: " + outColumns.toString() + "."));
	}
