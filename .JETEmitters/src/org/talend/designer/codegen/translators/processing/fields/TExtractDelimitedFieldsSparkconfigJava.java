...
public class TExtractDelimitedFieldsSparkconfigJava
{
  protected static String nl;
  public static synchronized TExtractDelimitedFieldsSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractDelimitedFieldsSparkconfigJava result = new TExtractDelimitedFieldsSparkconfigJava();
    nl = null;
    return result;
  }
