...
public class TExtractDelimitedFieldsSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TExtractDelimitedFieldsSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractDelimitedFieldsSparkstreamingcodeJava result = new TExtractDelimitedFieldsSparkstreamingcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_81 = " == null)" + NL + "            return";
  protected final String TEXT_82 = ";" + NL + "" + NL + "" + NL + "        try {";
  protected final String TEXT_83 = NL + "                // We are on the CSV mode, we need to check if the escape char will merge some value together." + NL + "                // It allow the handle schema like \" 'abc;def' \" (with \"'\" as text enclosure character)";
  protected final String TEXT_84 = NL + NL + "                String[] temporaryValue_";
  protected final String TEXT_85 = " = routines.system.StringUtils.splitNotRegex(";
  protected final String TEXT_86 = ", ";
  protected final String TEXT_87 = ");" + NL + "" + NL + "                String currentLine = null;" + NL + "                int numberOfTextEnclosureChar = 0;" + NL + "" + NL + "                java.util.List<String> values_";
  protected final String TEXT_88 = " = new java.util.ArrayList<String>();" + NL + "                String buildedValue_";
  protected final String TEXT_89 = " = \"\";" + NL;
  protected final String TEXT_90 = NL + "                    boolean previousCharIsEscape = true;";
  protected final String TEXT_91 = NL + "                //////" + NL + "                for (int valueIterator = 0; valueIterator < temporaryValue_";
  protected final String TEXT_92 = ".length; valueIterator++) {" + NL + "                    for (int index = temporaryValue_";
  protected final String TEXT_93 = "[valueIterator].indexOf('";
  protected final String TEXT_94 = "');" + NL + "                            (index >= 0);" + NL + "                            index = temporaryValue_";
  protected final String TEXT_95 = "[valueIterator].indexOf('";
  protected final String TEXT_96 = "', index + 1)) {" + NL + "" + NL + "                        // Get the number of escape character on the current substring," + NL + "                        // in order to check if we have or not a complete column";
  protected final String TEXT_97 = NL + "                            if (index == 0) {" + NL + "                                // First character is an escape character, count it before any processing" + NL + "                                numberOfTextEnclosureChar++;" + NL + "                                previousCharIsEscape = false;" + NL + "                            } else if (index == temporaryValue_";
  protected final String TEXT_98 = "[valueIterator].length() - 1) {" + NL + "                                // last caracter, check if he is escaped or not" + NL + "                                if (!previousCharIsEscape) {" + NL + "                                    numberOfTextEnclosureChar++;" + NL + "                                } else {" + NL + "                                    previousCharIsEscape = false;" + NL + "                                    break;" + NL + "                                }" + NL + "                            } else if (previousCharIsEscape) {" + NL + "                                // if the previous character is defined as the escape one, don't do anything" + NL + "                                previousCharIsEscape = false;" + NL + "                            } else if (temporaryValue_";
  protected final String TEXT_99 = "[valueIterator].charAt(index + 1) == '";
  protected final String TEXT_100 = "') {" + NL + "                                // if the current character and the next character are defined as the text enclosure," + NL + "                                // we are on a escape character" + NL + "                                previousCharIsEscape = true;" + NL + "                            } else {" + NL + "                                // No particular case, we are on a true enclosure character" + NL + "                                numberOfTextEnclosureChar++;" + NL + "                            }";
  protected final String TEXT_101 = NL + "                            if ((index == 0) || (temporaryValue_";
  protected final String TEXT_102 = "[valueIterator].charAt(index - 1) != '";
  protected final String TEXT_103 = "')) {" + NL + "                                numberOfTextEnclosureChar++;" + NL + "                            }";
  protected final String TEXT_104 = NL + "                    }" + NL + "" + NL + "                    if (buildedValue_";
  protected final String TEXT_105 = ".equals(\"\")) {" + NL + "                        buildedValue_";
  protected final String TEXT_106 = " = temporaryValue_";
  protected final String TEXT_107 = "[valueIterator];" + NL + "                    } else {" + NL + "                        buildedValue_";
  protected final String TEXT_108 = " = buildedValue_";
  protected final String TEXT_109 = " + ";
  protected final String TEXT_110 = " + temporaryValue_";
  protected final String TEXT_111 = "[valueIterator];" + NL + "                    }" + NL + "" + NL + "                    if (numberOfTextEnclosureChar % 2 == 0) {" + NL + "                        if (buildedValue_";
  protected final String TEXT_112 = ".startsWith(String.valueOf('";
  protected final String TEXT_113 = "')) &&" + NL + "                                buildedValue_";
  protected final String TEXT_114 = ".endsWith(String.valueOf('";
  protected final String TEXT_115 = "'))) {" + NL + "                            buildedValue_";
  protected final String TEXT_116 = " = buildedValue_";
  protected final String TEXT_117 = ".substring(1, buildedValue_";
  protected final String TEXT_118 = ".length() - 1);" + NL + "                        }" + NL + "                        values_";
  protected final String TEXT_119 = ".add(buildedValue_";
  protected final String TEXT_120 = ".replace(\"\" + '";
  protected final String TEXT_121 = "' + '";
  protected final String TEXT_122 = "', \"\" + '";
  protected final String TEXT_123 = "'));" + NL + "                        buildedValue_";
  protected final String TEXT_124 = " = \"\";" + NL + "                        numberOfTextEnclosureChar = 0;" + NL + "                    }" + NL + "                }" + NL + "                if (!buildedValue_";
  protected final String TEXT_125 = ".equals(\"\")) {" + NL + "                    // Uncomplete quote" + NL + "                    values_";
  protected final String TEXT_126 = ".add(buildedValue_";
  protected final String TEXT_127 = ");" + NL + "                }" + NL + "" + NL + "                String[] values = values_";
  protected final String TEXT_128 = ".toArray(new String[values_";
  protected final String TEXT_129 = ".size()]);";
  protected final String TEXT_130 = NL + "                String[] values = routines.system.StringUtils.splitNotRegex(";
  protected final String TEXT_131 = ".toString(), ";
  protected final String TEXT_132 = ");";
  protected final String TEXT_133 = NL + "                if(values.length < ";
  protected final String TEXT_134 = " ){" + NL + "                    throw new RuntimeException(\"Column(s) missing\");" + NL + "                } else if(values.length > ";
  protected final String TEXT_135 = ") {" + NL + "                    throw new RuntimeException(\"Too many columns\");" + NL + "                }";
  protected final String TEXT_136 = NL + NL + "            String temp = \"\";";
  protected final String TEXT_137 = NL + "                if (values.length > ";
  protected final String TEXT_138 = ") {";
  protected final String TEXT_139 = NL + "                        temp = values[";
  protected final String TEXT_140 = "]";
  protected final String TEXT_141 = ";";
  protected final String TEXT_142 = NL + "                            if(temp.length() > 0){";
  protected final String TEXT_143 = NL + "                                ";
  protected final String TEXT_144 = NL + "                            } else {";
  protected final String TEXT_145 = NL + "                                ";
  protected final String TEXT_146 = NL + "                            }";
  protected final String TEXT_147 = NL + "                            ";
  protected final String TEXT_148 = NL + "                        temp = values[";
  ...
  protected final String TEXT_162 = NL + "                            // no default value => nothing";
  protected final String TEXT_163 = NL + "                    }";
  protected final String TEXT_164 = NL + "                ";
  protected final String TEXT_165 = NL + "                ";
  protected final String TEXT_166 = NL + "            ";
  protected final String TEXT_167 = NL + "        } catch (RuntimeException ex) {";
  protected final String TEXT_168 = NL + "        }";
  protected final String TEXT_169 = NL + "            // Die immediately on errors." + NL + "            throw new IOException(";
  protected final String TEXT_170 = ");";
  protected final String TEXT_171 = NL + "                ";
  protected final String TEXT_172 = NL + "                // Ignore errors processing this row and move to the next.";
  protected final String TEXT_173 = NL + "                // Send error rows to the reject output.";
