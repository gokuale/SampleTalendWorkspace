...
public class TExtractXMLFieldSparkcodeJava
{
  protected static String nl;
  public static synchronized TExtractXMLFieldSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractXMLFieldSparkcodeJava result = new TExtractXMLFieldSparkcodeJava();
    nl = null;
    return result;
  }
