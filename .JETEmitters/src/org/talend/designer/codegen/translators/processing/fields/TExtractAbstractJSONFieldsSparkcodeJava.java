...
public class TExtractAbstractJSONFieldsSparkcodeJava
{
  protected static String nl;
  public static synchronized TExtractAbstractJSONFieldsSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractAbstractJSONFieldsSparkcodeJava result = new TExtractAbstractJSONFieldsSparkcodeJava();
    nl = null;
    return result;
  }
