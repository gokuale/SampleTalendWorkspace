...
public class TExtractFullRowSparkconfigJava
{
  protected static String nl;
  public static synchronized TExtractFullRowSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractFullRowSparkconfigJava result = new TExtractFullRowSparkconfigJava();
    nl = null;
    return result;
  }
