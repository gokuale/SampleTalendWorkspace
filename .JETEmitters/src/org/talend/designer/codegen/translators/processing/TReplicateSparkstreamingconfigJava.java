...
public class TReplicateSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TReplicateSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TReplicateSparkstreamingconfigJava result = new TReplicateSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_82 = "> rdd_replicated_";
  protected final String TEXT_83 = " = rdd_";
  protected final String TEXT_84 = ".persist(org.apache.spark.storage.StorageLevel.";
  protected final String TEXT_85 = "());" + NL;
  protected final String TEXT_86 = NL + "\t";
  protected final String TEXT_87 = "<";
  protected final String TEXT_88 = "> rdd_replicated_";
  protected final String TEXT_89 = " = rdd_";
  protected final String TEXT_90 = ";";
  protected final String TEXT_91 = NL + "\t";
  protected final String TEXT_92 = "<";
  protected final String TEXT_93 = "> rdd_";
  protected final String TEXT_94 = " = rdd_replicated_";
 ...
 */
class TReplicateUtil extends org.talend.designer.common.TransformerBase {
    ...
    public TReplicateUtil(INode node,
...
final boolean cacheOutput = ("true").equals(ElementParameterParser.getValue(node, "__CACHEOUTPUT__"));
final String storageLevel = ElementParameterParser.getValue(node, "__STORAGELEVEL__");

// find output main connections (No reject output flow, only main)
...
final TReplicateUtil tReplicateUtil = new TReplicateUtil(node, codeGenArgument, sparkTransformUtil);
...
String returnedType = "org.apache.spark.api.java.JavaRDD";
...
if("SPARKSTREAMING".equals(node.getComponent().getType()) && !isNodeInBatchMode) {
    ...
    returnedType = "org.apache.spark.streaming.api.java.JavaDStream";
}

org.talend.designer.spark.generator.FunctionGenerator functionGenerator = null;
functionGenerator = new SOFunctionGenerator(tReplicateUtil, sparkFunction);

functionGenerator.init(node, cid, null, tReplicateUtil.getInConnName(), null, tReplicateUtil.getOutConnMainName() != null? tReplicateUtil.getOutConnMainName(): tReplicateUtil.getOutConnRejectName());
...
if(cacheOutput){
    ...
    stringBuffer.append(tReplicateUtil.getInConnName());
...
for(IConnection iconnection: outputCons){
    ...
    stringBuffer.append(iconnection.getName());
