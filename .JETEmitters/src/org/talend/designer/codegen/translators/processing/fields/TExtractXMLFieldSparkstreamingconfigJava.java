...
public class TExtractXMLFieldSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TExtractXMLFieldSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractXMLFieldSparkstreamingconfigJava result = new TExtractXMLFieldSparkstreamingconfigJava();
    nl = null;
    return result;
  }
