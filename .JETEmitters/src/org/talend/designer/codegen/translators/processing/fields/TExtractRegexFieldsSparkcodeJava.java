...
public class TExtractRegexFieldsSparkcodeJava
{
  protected static String nl;
  public static synchronized TExtractRegexFieldsSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractRegexFieldsSparkcodeJava result = new TExtractRegexFieldsSparkcodeJava();
    nl = null;
    return result;
  }
...
sparkTransformUtil.generateSparkCode(tExtractRegexFieldsUtil, sparkFunction);
