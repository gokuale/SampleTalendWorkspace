...
public class TExtractFullRowSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TExtractFullRowSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractFullRowSparkstreamingcodeJava result = new TExtractFullRowSparkstreamingcodeJava();
    nl = null;
    return result;
  }
