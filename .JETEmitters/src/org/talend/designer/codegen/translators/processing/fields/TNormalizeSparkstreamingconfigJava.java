...
public class TNormalizeSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TNormalizeSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNormalizeSparkstreamingconfigJava result = new TNormalizeSparkstreamingconfigJava();
    nl = null;
    return result;
  }
