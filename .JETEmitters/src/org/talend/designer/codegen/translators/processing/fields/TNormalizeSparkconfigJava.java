...
public class TNormalizeSparkconfigJava
{
  protected static String nl;
  public static synchronized TNormalizeSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNormalizeSparkconfigJava result = new TNormalizeSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_79 = NL + "            //getInValueClass() getInValue() = value_cid;" + NL + "" + NL + "            String tmp_";
  protected final String TEXT_80 = " = null;" + NL + "            String [] normalizeRecord_";
  protected final String TEXT_81 = " = null;" + NL + "            java.util.Set<String> recordSet_";
  protected final String TEXT_82 = " = new java.util.HashSet<String>();" + NL + "            if(";
  protected final String TEXT_83 = " != null) {" + NL + "                if(\"\".equals(";
  protected final String TEXT_84 = ")){" + NL + "                    normalizeRecord_";
  protected final String TEXT_85 = " = new String[1];" + NL + "                    normalizeRecord_";
  protected final String TEXT_86 = "[0] = \"\";" + NL + "                }else{";
  protected final String TEXT_87 = NL + "                        com.talend.csv.CSVReader reader_";
  protected final String TEXT_88 = " = new com.talend.csv.CSVReader(new java.io.StringReader(";
  protected final String TEXT_89 = "), ";
  protected final String TEXT_90 = ".charAt(0));" + NL + "                        reader_";
  protected final String TEXT_91 = ".setTrimWhitespace(false);";
  protected final String TEXT_92 = NL + "                            reader_";
  protected final String TEXT_93 = ".setEscapeChar('\\\\');";
  protected final String TEXT_94 = NL + "                            reader_";
  protected final String TEXT_95 = ".setEscapeChar(";
  protected final String TEXT_96 = ".charAt(0));";
  protected final String TEXT_97 = NL + "                        reader_";
  protected final String TEXT_98 = ".setQuoteChar(";
  protected final String TEXT_99 = ".charAt(0));" + NL + "                        if (reader_";
  protected final String TEXT_100 = ".readNext()) {" + NL + "                            normalizeRecord_";
  protected final String TEXT_101 = " = reader_";
  protected final String TEXT_102 = ".getValues();" + NL + "                        } else {" + NL + "                            normalizeRecord_";
  protected final String TEXT_103 = " = new String[1];" + NL + "                        }";
  protected final String TEXT_104 = NL + "                            normalizeRecord_";
  protected final String TEXT_105 = " = ";
  protected final String TEXT_106 = ".split(";
  protected final String TEXT_107 = ");";
  protected final String TEXT_108 = NL + "                            normalizeRecord_";
  protected final String TEXT_109 = " = ";
  protected final String TEXT_110 = ".split(";
  protected final String TEXT_111 = ",-1);";
  protected final String TEXT_112 = NL + "                }" + NL + "            } else {" + NL + "                normalizeRecord_";
  protected final String TEXT_113 = " = new String[1];" + NL + "            }";
  protected final String TEXT_114 = NL + "                int lastNoEmptyIndex_";
  protected final String TEXT_115 = "=0;" + NL + "                for(int i_";
  protected final String TEXT_116 = "=normalizeRecord_";
  protected final String TEXT_117 = ".length;i_";
  protected final String TEXT_118 = " > 0;i_";
  protected final String TEXT_119 = "--){" + NL + "                    if(!\"\".equals(normalizeRecord_";
  protected final String TEXT_120 = "[i_";
  protected final String TEXT_121 = " - 1])){" + NL + "                        lastNoEmptyIndex_";
  protected final String TEXT_122 = "=i_";
  protected final String TEXT_123 = ";" + NL + "                        break;" + NL + "                    }" + NL + "                }";
  protected final String TEXT_124 = NL + "                int lastNoEmptyIndex_";
  protected final String TEXT_125 = "=normalizeRecord_";
  protected final String TEXT_126 = ".length;";
  protected final String TEXT_127 = NL + "                    if(lastNoEmptyIndex_";
  protected final String TEXT_128 = " == 1 && \"\".equals(normalizeRecord_";
  protected final String TEXT_129 = "[0])){" + NL + "                        lastNoEmptyIndex_";
  protected final String TEXT_130 = " = 0;" + NL + "                    }";
  protected final String TEXT_131 = NL + NL + "            for(int i_";
  protected final String TEXT_132 = " = 0 ; i_";
  protected final String TEXT_133 = " < lastNoEmptyIndex_";
  protected final String TEXT_134 = " ; i_";
  protected final String TEXT_135 = "++) {";
  protected final String TEXT_136 = NL + "                    if(normalizeRecord_";
  protected final String TEXT_137 = "[i_";
  protected final String TEXT_138 = "] != null){" + NL + "                        normalizeRecord_";
  protected final String TEXT_139 = "[i_";
  protected final String TEXT_140 = "] = normalizeRecord_";
...
sparkTransformUtil.generateSparkConfig(tNormalizeUtil, sparkFunction);
