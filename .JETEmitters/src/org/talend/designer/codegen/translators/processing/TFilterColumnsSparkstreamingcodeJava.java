...
public class TFilterColumnsSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TFilterColumnsSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFilterColumnsSparkstreamingcodeJava result = new TFilterColumnsSparkstreamingcodeJava();
    nl = null;
    return result;
  }
...
sparkTransformUtil.generateSparkCode(tFilterColumnsUtil, sparkFunction);
