...
public class TExtractDelimitedFieldsMrcodeJava
{
  protected static String nl;
  public static synchronized TExtractDelimitedFieldsMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractDelimitedFieldsMrcodeJava result = new TExtractDelimitedFieldsMrcodeJava();
    nl = null;
    return result;
  }
...
mrTransformUtil.generateMrCode(tExtractDelimitedFieldsUtil);
