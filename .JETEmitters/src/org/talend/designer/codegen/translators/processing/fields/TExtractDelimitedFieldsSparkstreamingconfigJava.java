...
public class TExtractDelimitedFieldsSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TExtractDelimitedFieldsSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractDelimitedFieldsSparkstreamingconfigJava result = new TExtractDelimitedFieldsSparkstreamingconfigJava();
    nl = null;
    return result;
  }
...
sparkTransformUtil.generateSparkConfig(tExtractDelimitedFieldsUtil, sparkFunction);
