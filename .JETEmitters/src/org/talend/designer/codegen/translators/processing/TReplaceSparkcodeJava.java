...
public class TReplaceSparkcodeJava
{
  protected static String nl;
  public static synchronized TReplaceSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TReplaceSparkcodeJava result = new TReplaceSparkcodeJava();
    nl = null;
    return result;
  }
