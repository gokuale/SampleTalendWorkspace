...
public class TNormalizeSparkcodeJava
{
  protected static String nl;
  public static synchronized TNormalizeSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNormalizeSparkcodeJava result = new TNormalizeSparkcodeJava();
    nl = null;
    return result;
  }
