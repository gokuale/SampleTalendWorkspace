...
public class TFilterColumnsSparkcodeJava
{
  protected static String nl;
  public static synchronized TFilterColumnsSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFilterColumnsSparkcodeJava result = new TFilterColumnsSparkcodeJava();
    nl = null;
    return result;
  }
