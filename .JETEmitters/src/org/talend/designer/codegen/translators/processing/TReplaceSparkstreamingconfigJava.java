...
public class TReplaceSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TReplaceSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TReplaceSparkstreamingconfigJava result = new TReplaceSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_80 = NL + "                            String searchStr_";
  protected final String TEXT_81 = "_";
  protected final String TEXT_82 = " = ";
  protected final String TEXT_83 = ";";
  protected final String TEXT_84 = NL + "                            String searchStr_";
  protected final String TEXT_85 = "_";
  protected final String TEXT_86 = " = ";
  protected final String TEXT_87 = " + \"\";";
  protected final String TEXT_88 = NL + "                            searchStr_";
  protected final String TEXT_89 = "_";
  protected final String TEXT_90 = " = org.apache.oro.text.GlobCompiler.globToPerl5(searchStr_";
  protected final String TEXT_91 = "_";
  protected final String TEXT_92 = ".toCharArray(), org.apache.oro.text.GlobCompiler.DEFAULT_MASK);";
  protected final String TEXT_93 = NL + "                                searchStr_";
  protected final String TEXT_94 = "_";
  protected final String TEXT_95 = " = \"^\" + searchStr_";
  protected final String TEXT_96 = "_";
  protected final String TEXT_97 = " + \"$\";";
  protected final String TEXT_98 = NL + "                                searchStr_";
  protected final String TEXT_99 = "_";
  protected final String TEXT_100 = " = \"(?i)\" + searchStr_";
  protected final String TEXT_101 = "_";
  protected final String TEXT_102 = ";";
  protected final String TEXT_103 = NL + "                                ";
  protected final String TEXT_104 = " =" + NL + "                                routines.system.StringUtils.replaceAll(";
  protected final String TEXT_105 = ", searchStr_";
  protected final String TEXT_106 = "_";
  protected final String TEXT_107 = ", ";
  protected final String TEXT_108 = ");";
  protected final String TEXT_109 = NL + "                                ";
  protected final String TEXT_110 = " =" + NL + "                                routines.system.StringUtils.replaceAll(";
  protected final String TEXT_111 = ", searchStr_";
  protected final String TEXT_112 = "_";
  protected final String TEXT_113 = ", ";
  protected final String TEXT_114 = "+\"\");";
  protected final String TEXT_115 = NL + "                                ";
  protected final String TEXT_116 = " =" + NL + "                                routines.system.StringUtils.replaceAllStrictly(";
  protected final String TEXT_117 = ", searchStr_";
  ...
  protected final String TEXT_124 = " =" + NL + "                                routines.system.StringUtils.replaceAllStrictly(";
  protected final String TEXT_125 = ", searchStr_";
  ...
  protected final String TEXT_132 = " =" + NL + "                            routines.system.StringUtils.replaceAll(";
  protected final String TEXT_133 = ", ";
  protected final String TEXT_134 = ", ";
  protected final String TEXT_135 = ");";
  protected final String TEXT_136 = NL + "                            ";
  protected final String TEXT_137 = " =" + NL + "                            routines.system.StringUtils.replaceAll(";
...
/**
 * Contains common processing for tReplace code generation.  This is
 * used in spark components for now.
 *
 ...
 */
class TReplaceUtil extends org.talend.designer.common.TransformerBase {

    final String advancedMode = ElementParameterParser.getValue( node, "__ADVANCED_MODE__" );
    final String simpleMode = ElementParameterParser.getValue( node, "__SIMPLE_MODE__" );
    final boolean strictMatch = ("true").equals(ElementParameterParser.getValue( node, "__STRICT_MATCH__" ));
    List<Map<String, String>> patterns = null;

    /** TODO: Used in DI, tied to CHECK_NUM */
    private int columnsSize = 0;

    public TReplaceUtil(INode node,
        ...
        if(("true").equals(simpleMode)) {
            ...
            if(substitutions != null && substitutions.size() > 0) {
                ...
                for(Map<String,String> substitution : substitutions) {
                    ...
                    String inputColumn = substitution.get("INPUT_COLUMN");
                    ...
                    if(replaceStr != null && !("").equals(replaceStr)) {
                        ...
                        i++;
                        // Search using exact string
                        // Why are we comparing searchStr to "null" ? Legacy ?
    ...
    stringBuffer.append(TEXT_92);
                        ...
                        //this component supports only strict match from now on (Bug 10232).
                        //strictMatch is set to True in XML by default and not visible
    ...
    stringBuffer.append(TEXT_102);
                            ...
                            // Search and replace the input value
                            if(("null").equals(replaceStr.toLowerCase())){

    stringBuffer.append(TEXT_103);
    stringBuffer.append(getRowTransform().getCodeToGetInField(inputColumn));
        ...
        if(("true").equals(advancedMode)) {
            ...
            if(patterns != null && patterns.size() > 0) {
                for(Map<String,String> pattern:patterns){
                    ...
                    String inputColumn = pattern.get("INPUT_COLUMN");
    ...
    stringBuffer.append(TEXT_140);
        ...
        // Set output to input because the search and repalce was done on input.
        // Doing the search and replace on the output will cause the last search filter to be applied only
        for(IMetadataColumn outputCol : getOutColumnsMain()){

    stringBuffer.append(TEXT_141);
    stringBuffer.append(getRowTransform().getCodeToGetOutField(false, outputCol.getLabel()));
    stringBuffer.append(TEXT_142);
    stringBuffer.append(getRowTransform().getCodeToGetInField(outputCol.getLabel()));
...
final TReplaceUtil tReplaceUtil = new TReplaceUtil(
...
sparkTransformUtil.generateSparkConfig(tReplaceUtil, sparkFunction);
