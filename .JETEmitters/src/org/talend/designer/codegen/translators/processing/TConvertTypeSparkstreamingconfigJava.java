...
public class TConvertTypeSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TConvertTypeSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TConvertTypeSparkstreamingconfigJava result = new TConvertTypeSparkstreamingconfigJava();
    nl = null;
    return result;
  }
