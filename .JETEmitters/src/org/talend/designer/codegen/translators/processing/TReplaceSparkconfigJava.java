...
public class TReplaceSparkconfigJava
{
  protected static String nl;
  public static synchronized TReplaceSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TReplaceSparkconfigJava result = new TReplaceSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_79 = NL + "                            String searchStr_";
  protected final String TEXT_80 = "_";
  protected final String TEXT_81 = " = ";
  protected final String TEXT_82 = ";";
  protected final String TEXT_83 = NL + "                            String searchStr_";
  protected final String TEXT_84 = "_";
  protected final String TEXT_85 = " = ";
  protected final String TEXT_86 = " + \"\";";
  protected final String TEXT_87 = NL + "                            searchStr_";
  protected final String TEXT_88 = "_";
  protected final String TEXT_89 = " = org.apache.oro.text.GlobCompiler.globToPerl5(searchStr_";
  protected final String TEXT_90 = "_";
  protected final String TEXT_91 = ".toCharArray(), org.apache.oro.text.GlobCompiler.DEFAULT_MASK);";
  protected final String TEXT_92 = NL + "                                searchStr_";
  protected final String TEXT_93 = "_";
  protected final String TEXT_94 = " = \"^\" + searchStr_";
  protected final String TEXT_95 = "_";
  protected final String TEXT_96 = " + \"$\";";
  protected final String TEXT_97 = NL + "                                searchStr_";
  protected final String TEXT_98 = "_";
  protected final String TEXT_99 = " = \"(?i)\" + searchStr_";
  protected final String TEXT_100 = "_";
  protected final String TEXT_101 = ";";
  protected final String TEXT_102 = NL + "                                ";
  protected final String TEXT_103 = " =" + NL + "                                routines.system.StringUtils.replaceAll(";
  protected final String TEXT_104 = ", searchStr_";
  protected final String TEXT_105 = "_";
  protected final String TEXT_106 = ", ";
  protected final String TEXT_107 = ");";
  protected final String TEXT_108 = NL + "                                ";
  protected final String TEXT_109 = " =" + NL + "                                routines.system.StringUtils.replaceAll(";
  protected final String TEXT_110 = ", searchStr_";
  protected final String TEXT_111 = "_";
  protected final String TEXT_112 = ", ";
  protected final String TEXT_113 = "+\"\");";
  protected final String TEXT_114 = NL + "                                ";
  protected final String TEXT_115 = " =" + NL + "                                routines.system.StringUtils.replaceAllStrictly(";
  protected final String TEXT_116 = ", searchStr_";
  ...
  protected final String TEXT_123 = " =" + NL + "                                routines.system.StringUtils.replaceAllStrictly(";
  protected final String TEXT_124 = ", searchStr_";
  ...
  protected final String TEXT_131 = " =" + NL + "                            routines.system.StringUtils.replaceAll(";
  protected final String TEXT_132 = ", ";
  protected final String TEXT_133 = ", ";
  protected final String TEXT_134 = ");";
  protected final String TEXT_135 = NL + "                            ";
  protected final String TEXT_136 = " =" + NL + "                            routines.system.StringUtils.replaceAll(";
