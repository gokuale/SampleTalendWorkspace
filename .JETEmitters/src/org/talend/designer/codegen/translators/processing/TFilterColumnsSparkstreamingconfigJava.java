...
public class TFilterColumnsSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TFilterColumnsSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFilterColumnsSparkstreamingconfigJava result = new TFilterColumnsSparkstreamingconfigJava();
    nl = null;
    return result;
  }
 ...
 */
class TFilterColumnsUtil extends org.talend.designer.common.TransformerBase {
    ...
    public TFilterColumnsUtil(INode node,
...
final TFilterColumnsUtil tFilterColumnsUtil = new TFilterColumnsUtil(
...
sparkTransformUtil.generateSparkConfig(tFilterColumnsUtil, sparkFunction);
