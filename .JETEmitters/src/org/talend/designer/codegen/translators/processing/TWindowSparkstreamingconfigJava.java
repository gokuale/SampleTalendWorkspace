...
public class TWindowSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TWindowSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TWindowSparkstreamingconfigJava result = new TWindowSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_84 = ".window(org.apache.spark.streaming.Durations.milliseconds(";
  protected final String TEXT_85 = "));";
  protected final String TEXT_86 = NL + "        ";
  protected final String TEXT_87 = " rdd_";
  protected final String TEXT_88 = " = rdd_";
  protected final String TEXT_89 = ".window(org.apache.spark.streaming.Durations.milliseconds(";
  protected final String TEXT_90 = "), org.apache.spark.streaming.Durations.milliseconds(";
 ...
 */
class TWindowUtil extends org.talend.designer.common.TransformerBase {
    ...
    String windowDuration = ElementParameterParser.getValue(node, "__WINDOW_DURATION__");
    boolean defineSlidingDuration = "true".equals(ElementParameterParser.getValue(node, "__DEFINE_SLIDE_DURATION__"));
    String slideDuration = ElementParameterParser.getValue(node, "__SLIDE_DURATION__");

    final SparkRowTransformUtil sparkTransformUtil = new SparkRowTransformUtil();
    final TWindowUtil tWindowUtil = new TWindowUtil(node, codeGenArgument, sparkTransformUtil);
    ...
    functionGenerator = new SOFunctionGenerator(tWindowUtil, sparkFunction);

    functionGenerator.init(node, cid, null, tWindowUtil.getInConnName(), null, tWindowUtil.getOutConnMainName() != null? tWindowUtil.getOutConnMainName(): tWindowUtil.getOutConnRejectName());

    // Has a seed for random number generator ?
    if(!defineSlidingDuration){

    stringBuffer.append(TEXT_81);
    stringBuffer.append(sparkFunction.getConfigReturnedType(functionGenerator.getOutValueClass()));
    stringBuffer.append(TEXT_82);
    stringBuffer.append(tWindowUtil.getOutConnMainName());
    stringBuffer.append(TEXT_83);
    stringBuffer.append(tWindowUtil.getInConnName());
    stringBuffer.append(TEXT_84);
    stringBuffer.append(windowDuration);
    ...
    stringBuffer.append(slideDuration);
