...
public class TExtractRegexFieldsSparkconfigJava
{
  protected static String nl;
  public static synchronized TExtractRegexFieldsSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractRegexFieldsSparkconfigJava result = new TExtractRegexFieldsSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_79 = NL + "        /** Declare the input regex and define it after the context initialization */" + NL + "        java.util.regex.Pattern pattern = null;";
  protected final String TEXT_80 = NL + "        if(pattern == null){" + NL + "            pattern = java.util.regex.Pattern.compile(";
  protected final String TEXT_81 = ");" + NL + "        }";
  protected final String TEXT_82 = NL + "        if (";
  protected final String TEXT_83 = " == null)" + NL + "            return";
  protected final String TEXT_84 = ";" + NL + "" + NL + "        java.util.regex.Matcher matcher = pattern.matcher(";
  protected final String TEXT_85 = NL + "                ";
  protected final String TEXT_86 = ");";
  protected final String TEXT_87 = NL + "            // It's an error condition if the input field is non-null but has no match." + NL + "            if (!matcher.find()) {";
  protected final String TEXT_88 = NL + "            }" + NL + "            matcher.reset();";
  protected final String TEXT_89 = NL + NL + "        // Look for every possible match in the row." + NL + "        while (matcher.find()) {" + NL + "            try {" + NL + "                String valueAsString = null;" + NL + "                int groupCount = matcher.groupCount();";
  protected final String TEXT_90 = NL + "                    // Ensure that there is exactly the right number of matches from" + NL + "                    if (groupCount < ";
  protected final String TEXT_91 = ") {" + NL + "                        throw new RuntimeException(\"Column(s) missing\");" + NL + "                    } else if (groupCount > ";
  protected final String TEXT_92 = ") {" + NL + "                        throw new RuntimeException(\"Too many columns\");" + NL + "                    }";
  protected final String TEXT_93 = NL + "                    valueAsString = groupCount <= ";
  protected final String TEXT_94 = "? \"\" : matcher.group(";
  protected final String TEXT_95 = ");";
  protected final String TEXT_96 = NL + "                    ";
  protected final String TEXT_97 = NL + "                    ";
  protected final String TEXT_98 = NL + "                ";
  protected final String TEXT_99 = NL + "            } catch (RuntimeException ex) {";
  protected final String TEXT_100 = NL + "            }" + NL + "        }";
  protected final String TEXT_101 = NL + "            ";
  protected final String TEXT_102 = NL + "            // Die immediately on errors." + NL + "            throw new IOException(";
  protected final String TEXT_103 = ");";
  protected final String TEXT_104 = NL + "                // Ignore errors processing this row and move to the next.";
  protected final String TEXT_105 = NL + "                // Send error rows to the reject output.";
  protected final String TEXT_106 = NL + "                ";
  protected final String TEXT_107 = NL + "                    ";
  protected final String TEXT_108 = NL + "                ";
  protected final String TEXT_109 = NL + "                ";
  protected final String TEXT_110 = NL + "            ";
  protected final String TEXT_111 = NL + "            if (valueAsString.length() > 0) {";
  protected final String TEXT_112 = NL + "                    ";
  protected final String TEXT_113 = NL + "                    ";
  protected final String TEXT_114 = NL + "                    ";
  protected final String TEXT_115 = NL + "            } else {";
  protected final String TEXT_116 = NL + "                    throw new RuntimeException(\"Value is empty for column : '";
...
sparkTransformUtil.generateSparkConfig(tExtractRegexFieldsUtil, sparkFunction);
