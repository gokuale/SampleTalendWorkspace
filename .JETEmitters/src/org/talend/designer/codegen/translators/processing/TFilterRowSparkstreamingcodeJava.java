...
public class TFilterRowSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TFilterRowSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFilterRowSparkstreamingcodeJava result = new TFilterRowSparkstreamingcodeJava();
    nl = null;
    return result;
  }
