...
public class TDenormalizeSparkconfigJava
{
  protected static String nl;
  public static synchronized TDenormalizeSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDenormalizeSparkconfigJava result = new TDenormalizeSparkconfigJava();
    nl = null;
    return result;
  }
