...
public class TDenormalizeSparkcodeJava
{
  protected static String nl;
  public static synchronized TDenormalizeSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDenormalizeSparkcodeJava result = new TDenormalizeSparkcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_79 = NL + "                java.util.Set<";
  protected final String TEXT_80 = "> previousValueOf";
  protected final String TEXT_81 = " = new java.util.HashSet<";
  protected final String TEXT_82 = ">();";
  protected final String TEXT_83 = NL + "        boolean emptyValue = true;" + NL + "" + NL + "        for (";
  protected final String TEXT_84 = " elem: ";
  protected final String TEXT_85 = ") {" + NL + "            if (emptyValue) {" + NL + "                emptyValue = false;";
  protected final String TEXT_86 = NL + "                                    ";
  protected final String TEXT_87 = ".";
  protected final String TEXT_88 = " = new java.util.ArrayList<>();";
  protected final String TEXT_89 = NL + "                                    ";
  protected final String TEXT_90 = ".";
  protected final String TEXT_91 = ".add(elem.";
  protected final String TEXT_92 = ");";
  protected final String TEXT_93 = NL + "                        ";
  protected final String TEXT_94 = NL + "                        ";
  protected final String TEXT_95 = NL + "                        previousValueOf";
  protected final String TEXT_96 = ".add(elem.";
  protected final String TEXT_97 = ");";
  protected final String TEXT_98 = NL + "            } else {";
  protected final String TEXT_99 = NL + "                                ";
  protected final String TEXT_100 = ".";
  protected final String TEXT_101 = ".add(elem.";
  protected final String TEXT_102 = ");";
  protected final String TEXT_103 = NL + "                        if (!previousValueOf";
  protected final String TEXT_104 = ".contains(elem.";
  protected final String TEXT_105 = ")) {" + NL + "                            previousValueOf";
  protected final String TEXT_106 = ".add(elem.";
...
sparkTransformUtil.generateSparkCode(tDenormalizeUtil, sparkFunction);
