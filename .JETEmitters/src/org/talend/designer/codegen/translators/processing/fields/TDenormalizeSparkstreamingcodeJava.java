...
public class TDenormalizeSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TDenormalizeSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDenormalizeSparkstreamingcodeJava result = new TDenormalizeSparkstreamingcodeJava();
    nl = null;
    return result;
  }
