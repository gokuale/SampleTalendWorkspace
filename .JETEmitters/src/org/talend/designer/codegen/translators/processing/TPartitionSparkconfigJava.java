...
public class TPartitionSparkconfigJava
{
  protected static String nl;
  public static synchronized TPartitionSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPartitionSparkconfigJava result = new TPartitionSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_79 = NL + "            org.apache.spark.api.java.JavaPairRDD<";
  protected final String TEXT_80 = ", ";
  protected final String TEXT_81 = "> rdd_";
  protected final String TEXT_82 = " = rdd_";
  protected final String TEXT_83 = ";";
  protected final String TEXT_84 = NL + "                org.apache.spark.api.java.JavaPairRDD<";
  protected final String TEXT_85 = ", ";
  protected final String TEXT_86 = "> rdd_";
  protected final String TEXT_87 = " = rdd_";
  protected final String TEXT_88 = ".repartitionAndSortWithinPartitions(new ";
  protected final String TEXT_89 = "(";
  protected final String TEXT_90 = "), new ";
  protected final String TEXT_91 = "());";
  protected final String TEXT_92 = NL + "                org.apache.spark.api.java.JavaPairRDD<";
  protected final String TEXT_93 = ", ";
  protected final String TEXT_94 = "> rdd_";
  protected final String TEXT_95 = " = rdd_";
  protected final String TEXT_96 = ".repartitionAndSortWithinPartitions(new org.apache.spark.HashPartitioner(";
  protected final String TEXT_97 = "), new ";
  protected final String TEXT_98 = "());";
  protected final String TEXT_99 = NL + "                org.apache.spark.api.java.JavaPairRDD<";
  protected final String TEXT_100 = ", ";
  protected final String TEXT_101 = "> rdd_";
  protected final String TEXT_102 = " = rdd_";
  protected final String TEXT_103 = ".repartitionAndSortWithinPartitions(new ";
  protected final String TEXT_104 = "(";
  protected final String TEXT_105 = "), new NaturalComparator_";
  protected final String TEXT_106 = "());";
  protected final String TEXT_107 = NL + "                org.apache.spark.api.java.JavaPairRDD<";
  protected final String TEXT_108 = ", ";
  protected final String TEXT_109 = "> rdd_";
  protected final String TEXT_110 = " = rdd_";
  protected final String TEXT_111 = ".repartitionAndSortWithinPartitions(new org.apache.spark.HashPartitioner(";
  protected final String TEXT_112 = "), new NaturalComparator_";
  protected final String TEXT_113 = "());";
  protected final String TEXT_114 = NL + "            org.apache.spark.api.java.JavaPairRDD<";
  protected final String TEXT_115 = ", ";
  protected final String TEXT_116 = "> rdd_";
  protected final String TEXT_117 = " = rdd_";
  protected final String TEXT_118 = ".partitionBy(new ";
  protected final String TEXT_119 = "(";
  protected final String TEXT_120 = "));";
  protected final String TEXT_121 = NL + "            org.apache.spark.api.java.JavaPairRDD<";
  protected final String TEXT_122 = ", ";
  protected final String TEXT_123 = "> rdd_";
  protected final String TEXT_124 = " = rdd_";
  protected final String TEXT_125 = ".partitionBy(new org.apache.spark.HashPartitioner(";
 ...
 */
class TPartitionUtil extends org.talend.designer.common.TransformerBase {
    ...
    public TPartitionUtil(INode node,
...
final String nbPartitions = ElementParameterParser.getValue(node, "__NBPARTITIONS__");
final String customPartitionerFQCN = ElementParameterParser.getValue(node, "__PARTITIONER_FQCN__");
final String useCustomPartitioner = ElementParameterParser.getValue(node, "__CUSTOMPARTITIONER__");
final String sortInPartition = ElementParameterParser.getValue(node, "__SORTINPARTITION__");
final String sortComparator = ElementParameterParser.getValue(node, "__COMPARATOR__");
final String comparatorFQCN = ElementParameterParser.getValue(node, "__COMPARATOR_FQCN__");
...
int keyListSize = keyList.get("BOTH").size();
...
// Output Connections
IConnection mainOutput = null;
List<? extends IConnection> outputCons = node.getOutgoingConnections();
if (outputCons == null || outputCons.size() == 0 ){
    return "";
} else{
    mainOutput = outputCons.get(0);
}
final String mainOutputConnectionName = mainOutput.getName();

final SparkRowTransformUtil sparkTransformUtil = new SparkRowTransformUtil();
final TPartitionUtil tPartitionUtil = new TPartitionUtil(node, codeGenArgument, sparkTransformUtil);
...
functionGenerator = new SOFunctionGenerator(tPartitionUtil, sparkFunction);

functionGenerator.init(node, cid, null, tPartitionUtil.getInConnName(), null, tPartitionUtil.getOutConnMainName() != null? tPartitionUtil.getOutConnMainName(): tPartitionUtil.getOutConnRejectName());
...
if(keyListSize==0){
    ...
    stringBuffer.append(tPartitionUtil.getOutConnMainName());
    stringBuffer.append(TEXT_82);
    stringBuffer.append(tPartitionUtil.getInConnName());
    stringBuffer.append(TEXT_83);
    
}else{
    // Sort in partitions
    if(("true").equals(sortInPartition)){
        // Custom comparator
        if(("CUSTOMCOMPARATOR").equals(sortComparator)){
            // Custom partitioner and custom comparator
            if(("true").equals(useCustomPartitioner)){
    ...
    stringBuffer.append(customPartitionerFQCN);
    stringBuffer.append(TEXT_89);
    stringBuffer.append(nbPartitions);
    stringBuffer.append(TEXT_90);
    stringBuffer.append(comparatorFQCN);
    stringBuffer.append(TEXT_91);
    
            // HashPartitioner and custom comparator
            }else{
    ...
    stringBuffer.append(TEXT_98);
        ...
        // Natural comparator
            ...
            // Custom partitioner and Natural comparator
            if(("true").equals(useCustomPartitioner)){
    ...
    stringBuffer.append(TEXT_106);
            ...
            // HashPartitioner and Natural comparator
            }else{
