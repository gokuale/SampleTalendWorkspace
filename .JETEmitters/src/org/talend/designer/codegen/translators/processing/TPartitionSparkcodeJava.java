...
public class TPartitionSparkcodeJava
{
  protected static String nl;
  public static synchronized TPartitionSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPartitionSparkcodeJava result = new TPartitionSparkcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_79 = NL + "    \tpublic static class NaturalComparator_";
  protected final String TEXT_80 = " implements Serializable, java.util.Comparator<";
  protected final String TEXT_81 = "> {" + NL + "    \t\tpublic int compare(";
  protected final String TEXT_82 = " arg0, ";
  protected final String TEXT_83 = " arg1) {";
  protected final String TEXT_84 = NL + "    \t\t\t\t\tint compResult = 0;";
  protected final String TEXT_85 = NL + "    \t\t\t\t\tcompResult = arg0._";
  protected final String TEXT_86 = "().compareTo(arg1._";
  protected final String TEXT_87 = "());" + NL + "    \t\t\t\t\tif(compResult != 0) return compResult;";
  protected final String TEXT_88 = NL + "    \t\t\t\treturn 0;";
  protected final String TEXT_89 = NL + "    \t\t\t\treturn arg0._1().compareTo(arg1._1());";
...
// Comparator class to use in case of partition and sort
// sorts by natural order of keys (uses compareTo of each column in the Key)
// Do not generate code when keylist size is zero i.e no columns selected in the partition key
if((keyListSize > 0)&&(("true").equals(sortInPartition)&&(("NATURALORDER").equals(sortComparator)))){
    ...
    stringBuffer.append(TEXT_83);
                ...
                // Generate the comparison code block
                // Comparing column paris one by one and returning the result
    			if(keyListSize > 1){
