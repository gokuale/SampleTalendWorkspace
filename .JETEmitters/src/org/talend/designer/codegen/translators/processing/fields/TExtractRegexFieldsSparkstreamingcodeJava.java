...
public class TExtractRegexFieldsSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TExtractRegexFieldsSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractRegexFieldsSparkstreamingcodeJava result = new TExtractRegexFieldsSparkstreamingcodeJava();
    nl = null;
    return result;
  }
