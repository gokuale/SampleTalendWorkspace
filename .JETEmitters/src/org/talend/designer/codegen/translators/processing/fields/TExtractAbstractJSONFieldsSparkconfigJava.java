...
public class TExtractAbstractJSONFieldsSparkconfigJava
{
  protected static String nl;
  public static synchronized TExtractAbstractJSONFieldsSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractAbstractJSONFieldsSparkconfigJava result = new TExtractAbstractJSONFieldsSparkconfigJava();
    nl = null;
    return result;
  }
