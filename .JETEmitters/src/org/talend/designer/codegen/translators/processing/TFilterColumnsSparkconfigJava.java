...
public class TFilterColumnsSparkconfigJava
{
  protected static String nl;
  public static synchronized TFilterColumnsSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFilterColumnsSparkconfigJava result = new TFilterColumnsSparkconfigJava();
    nl = null;
    return result;
  }
