...
public class TSortRowSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TSortRowSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSortRowSparkstreamingcodeJava result = new TSortRowSparkstreamingcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_241 = NL + NL + "public static class ";
  protected final String TEXT_242 = "_Function implements org.apache.spark.api.java.function.Function<";
  protected final String TEXT_243 = ", ";
  protected final String TEXT_244 = "> {" + NL + "" + NL + "\tprivate JobConf job;" + NL + "" + NL + "\tpublic ";
  protected final String TEXT_245 = "_Function(JobConf job) {" + NL + "\t\tthis.job = job;" + NL + "\t}" + NL + "" + NL + "\tpublic ";
  protected final String TEXT_246 = " call(";
  protected final String TEXT_247 = " in) {" + NL + "\t\treturn in.sortByKey(new ";
  protected final String TEXT_248 = "(job));" + NL + "\t}" + NL + "}";
...
if(!org.talend.designer.common.tmap.LookupUtil.isNodeInBatchMode(node)) {
	String rddType = sparkFunction.getConfigReturnedType(tSortRowUtil.getOutConnMainName() != null ? tSortRowUtil.getOutConnMainTypeName() : tSortRowUtil.getOutConnRejectTypeName());
