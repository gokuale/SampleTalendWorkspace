...
public class TExtractJSONFieldsSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TExtractJSONFieldsSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractJSONFieldsSparkstreamingconfigJava result = new TExtractJSONFieldsSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_147 = NL + "                } catch (java.lang.Exception ex) {";
  protected final String TEXT_148 = NL + "                }";
  protected final String TEXT_149 = NL + "                ";
  protected final String TEXT_150 = NL + "            }" + NL + "        }";
  protected final String TEXT_151 = NL + "        try {" + NL + "            cjs_";
  protected final String TEXT_152 = ".generate();" + NL + "            jsonStr_";
  protected final String TEXT_153 = " = cjs_";
  protected final String TEXT_154 = ".getJsonString4XML();" + NL + "            loopQuery_";
  protected final String TEXT_155 = " = cjs_";
  protected final String TEXT_156 = ".getLoopString4XML();" + NL + "            bais_";
  protected final String TEXT_157 = " = new java.io.ByteArrayInputStream(jsonStr_";
  protected final String TEXT_158 = ".getBytes(";
  protected final String TEXT_159 = "));" + NL + "" + NL + "            javax.xml.stream.XMLEventReader xmlEventReader_";
  protected final String TEXT_160 = " = jsonXMLInputFactory_";
  protected final String TEXT_161 = ".createXMLEventReader(bais_";
  protected final String TEXT_162 = ");" + NL + "            javax.xml.stream.XMLEventWriter xmLEventWriter_";
  protected final String TEXT_163 = " = xmlOutputFactory_";
  protected final String TEXT_164 = ".createXMLEventWriter(baos_";
  protected final String TEXT_165 = ");" + NL + "            xmLEventWriter_";
  protected final String TEXT_166 = ".add(xmlEventReader_";
  protected final String TEXT_167 = ");" + NL + "            // Convert JSON string to XML." + NL + "            xmLEventWriter_";
  protected final String TEXT_168 = ".close();" + NL + "            xmlEventReader_";
  protected final String TEXT_169 = ".close();" + NL + "            xmlStr_";
  protected final String TEXT_170 = " = baos_";
  protected final String TEXT_171 = ".toString();" + NL + "            doc_";
  protected final String TEXT_172 = "= reader_";
  protected final String TEXT_173 = ".read(new java.io.StringReader(xmlStr_";
  protected final String TEXT_174 = "));" + NL + "            x_";
  protected final String TEXT_175 = " = doc_";
  protected final String TEXT_176 = ".createXPath(loopQuery_";
  protected final String TEXT_177 = ");" + NL + "            x_";
  protected final String TEXT_178 = ".setNamespaceURIs(xmlNameSpaceMap_";
  protected final String TEXT_179 = ");" + NL + "            nodeList_";
  protected final String TEXT_180 = " = (java.util.List<org.dom4j.tree.AbstractNode>) x_";
  protected final String TEXT_181 = ".selectNodes(doc_";
  protected final String TEXT_182 = ");" + NL + "            isStructError_";
  protected final String TEXT_183 = " = false;" + NL + "        } catch (java.lang.Exception ex) {";
  protected final String TEXT_184 = NL + "        } finally {" + NL + "            try {" + NL + "                baos_";
  protected final String TEXT_185 = ".close();" + NL + "                if (bais_";
  protected final String TEXT_186 = " != null) {" + NL + "                    bais_";
  protected final String TEXT_187 = ".close();" + NL + "                }" + NL + "            } catch (IOException e) {";
  protected final String TEXT_188 = NL + "                    throw new  java.io.IOException(e.getMessage());";
  protected final String TEXT_189 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_190 = NL + "            }" + NL + "        }";
  protected final String TEXT_191 = NL + "        xTmp_";
  protected final String TEXT_192 = " = temp_";
  protected final String TEXT_193 = ".createXPath(";
  protected final String TEXT_194 = ");" + NL + "        xTmp_";
  protected final String TEXT_195 = ".setNamespaceURIs(xmlNameSpaceMap_";
  protected final String TEXT_196 = ");" + NL;
  protected final String TEXT_197 = NL + "            obj_";
  protected final String TEXT_198 = " = xTmp_";
  protected final String TEXT_199 = ".evaluate(temp_";
  protected final String TEXT_200 = ");" + NL + "            if (obj_";
  protected final String TEXT_201 = " instanceof String || obj_";
  protected final String TEXT_202 = " instanceof Number) {" + NL + "                node_";
  protected final String TEXT_203 = " = temp_";
  protected final String TEXT_204 = ";" + NL + "                str_";
  protected final String TEXT_205 = " = String.valueOf(obj_";
  protected final String TEXT_206 = ");" + NL + "            } else {" + NL + "                node_";
  protected final String TEXT_207 = " = xTmp_";
  protected final String TEXT_208 = ".selectSingleNode(temp_";
  protected final String TEXT_209 = ");";
  protected final String TEXT_210 = NL + "                    if (node_";
  protected final String TEXT_211 = " == null) {" + NL + "                        str_";
  protected final String TEXT_212 = " = null;" + NL + "                    } else {" + NL + "                        str_";
  protected final String TEXT_213 = " = originalJSONString_";
  protected final String TEXT_214 = ".getOriginalJSONString(node_";
  protected final String TEXT_215 = ".asXML(), cjs_";
  protected final String TEXT_216 = ".getAdditionRoot(), ";
  protected final String TEXT_217 = ", ";
  protected final String TEXT_218 = ");" + NL + "                    }";
  protected final String TEXT_219 = NL + "                    str_";
  protected final String TEXT_220 = " = xTmp_";
  protected final String TEXT_221 = ".valueOf(temp_";
  protected final String TEXT_222 = ");";
  protected final String TEXT_223 = NL + "            }";
  protected final String TEXT_224 = NL + "                xmlStrTemp_";
  protected final String TEXT_225 = " = \"\";" + NL + "                for (Object tempNode_";
  protected final String TEXT_226 = " : xTmp_";
  protected final String TEXT_227 = ".selectNodes(temp_";
  protected final String TEXT_228 = ")) {" + NL + "                    node_";
  protected final String TEXT_229 = " = (org.dom4j.Node)tempNode_";
  protected final String TEXT_230 = ";" + NL + "                    xmlStrTemp_";
  protected final String TEXT_231 = " += node_";
  protected final String TEXT_232 = ".asXML();" + NL + "                }" + NL + "                if(\"\".equals(xmlStrTemp_";
  protected final String TEXT_233 = ")) {" + NL + "                    str_";
  protected final String TEXT_234 = " = null;" + NL + "                } else {" + NL + "                    str_";
  protected final String TEXT_235 = " = originalJSONString_";
  protected final String TEXT_236 = ".getOriginalJSONString(xmlStrTemp_";
  protected final String TEXT_237 = ",cjs_";
  protected final String TEXT_238 = ".getAdditionRoot(),";
  protected final String TEXT_239 = ",";
  protected final String TEXT_240 = ", true);" + NL + "                }";
  protected final String TEXT_241 = NL + "                xmlListTemp_";
  protected final String TEXT_242 = " = new java.util.ArrayList<String>();" + NL + "                for(Object tempNode_";
  protected final String TEXT_243 = " : xTmp_";
  protected final String TEXT_244 = ".selectNodes(temp_";
  protected final String TEXT_245 = ")) {" + NL + "                    xmlListTemp_";
  protected final String TEXT_246 = ".add(((org.dom4j.Node)tempNode_";
  protected final String TEXT_247 = ").getStringValue());" + NL + "                }";
  protected final String TEXT_248 = NL + "                    ";
  protected final String TEXT_249 = NL + "                            if (xml_api_";
  protected final String TEXT_250 = ".isDefNull(node_";
  protected final String TEXT_251 = ")) {";
  protected final String TEXT_252 = NL + "                                ";
  protected final String TEXT_253 = NL + "                            } else if (xml_api_";
  protected final String TEXT_254 = ".isEmpty(node_";
  protected final String TEXT_255 = ")) {";
  protected final String TEXT_256 = NL + "                                ";
  protected final String TEXT_257 = NL + "                            } else if (xml_api_";
  protected final String TEXT_258 = ".isMissing(node_";
  ...
  protected final String TEXT_266 = NL + "                            } else if(xml_api_";
  protected final String TEXT_267 = ".isMissing(node_";
  protected final String TEXT_268 = ")) {";
  protected final String TEXT_269 = NL + "                                ";
  protected final String TEXT_270 = NL + "                            } else {";
  protected final String TEXT_271 = NL + "                            if(xml_api_";
  protected final String TEXT_272 = ".isDefNull(node_";
  protected final String TEXT_273 = ")) {";
  protected final String TEXT_274 = NL + "                                ";
  protected final String TEXT_275 = NL + "                            } else if (xml_api_";
  ...
  protected final String TEXT_283 = ".isMissing(node_";
  protected final String TEXT_284 = ") || xml_api_";
  protected final String TEXT_285 = ".isEmpty(node_";
  ...
  protected final String TEXT_294 = NL + "                    if (xmlListTemp_";
  protected final String TEXT_295 = ".isEmpty()) {";
  ...
  protected final String TEXT_302 = NL + "            // Die immediately on errors." + NL + "            throw new IOException(";
  protected final String TEXT_303 = ");";
  protected final String TEXT_304 = NL + "                // Ignore errors processing this row and move to the next.";
  protected final String TEXT_305 = NL + "                // Send error rows to the reject output.";
