...
public class TTopMrcodeJava
{
  protected static String nl;
  public static synchronized TTopMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTopMrcodeJava result = new TTopMrcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_902 = NL + "            com.google.common.collect.TreeMultimap<";
  protected final String TEXT_903 = "_Comparator, ";
  protected final String TEXT_904 = "> topK " + NL + "                = com.google.common.collect.TreeMultimap.create();";
  protected final String TEXT_905 = NL + "            // keep the topK" + NL + "            while(values_";
  protected final String TEXT_906 = ".hasNext()){";
  protected final String TEXT_907 = NL + "                ";
  protected final String TEXT_908 = " ";
  protected final String TEXT_909 = "_temp = values_";
  protected final String TEXT_910 = ".next();";
  ...
  protected final String TEXT_917 = "_temp.";
  protected final String TEXT_918 = ";";
  protected final String TEXT_919 = NL + "                topK.put(new ";
  protected final String TEXT_920 = "_Comparator(";
  protected final String TEXT_921 = "_temp), ";
  protected final String TEXT_922 = ");" + NL + "                if (topK.size() > ";
  protected final String TEXT_923 = ") {" + NL + "                    java.util.Map.Entry<";
  protected final String TEXT_924 = "_Comparator, ";
  protected final String TEXT_925 = "> valueToDelete = topK.entries().iterator().next();" + NL + "                    topK.remove(valueToDelete.getKey(), valueToDelete.getValue());" + NL + "                }" + NL + "            }" + NL + "" + NL + "            // Set put the topK into the output" + NL + "            " + NL + "            for(";
  protected final String TEXT_926 = " topElement: topK.values()) {";
  ...
  protected final String TEXT_932 = NL + "                    this.";
  protected final String TEXT_933 = " = input.";
  protected final String TEXT_934 = ";";
  protected final String TEXT_935 = NL + "        // the two objects are the same, but multimap implementation need to see them as different." + NL + "        return -1;";
  protected final String TEXT_936 = NL + "            return -1;";
  protected final String TEXT_937 = NL + "            return 1;";
  protected final String TEXT_938 = NL + "            return 1;";
  protected final String TEXT_939 = NL + "            return -1;";
  protected final String TEXT_940 = NL + "            if(this.";
  protected final String TEXT_941 = " == null && target.";
  protected final String TEXT_942 = " != null){";
  protected final String TEXT_943 = NL + "            }else if(this.";
  protected final String TEXT_944 = " != null && target.";
  protected final String TEXT_945 = " == null){";
  protected final String TEXT_946 = NL + "            }else if(this.";
  protected final String TEXT_947 = " == null && target.";
  protected final String TEXT_948 = " == null){" + NL + "                // ignore and will use the next criteria" + NL + "            }else{";
  protected final String TEXT_949 = NL + "                if(this.";
  protected final String TEXT_950 = " != target.";
  protected final String TEXT_951 = "){" + NL + "                    if (this.";
  protected final String TEXT_952 = "){";
  protected final String TEXT_953 = NL + "                    } else {";
  protected final String TEXT_954 = NL + "                    }" + NL + "                }";
  protected final String TEXT_955 = NL + "                if(this.";
  protected final String TEXT_956 = " > target.";
  protected final String TEXT_957 = "){";
  protected final String TEXT_958 = NL + "                }else if(this.";
  protected final String TEXT_959 = " < target.";
  protected final String TEXT_960 = "){";
  protected final String TEXT_961 = NL + "                }";
  protected final String TEXT_962 = NL + "                String s1_";
  protected final String TEXT_963 = " = new String(this.";
  protected final String TEXT_964 = ");" + NL + "                String s2_";
  protected final String TEXT_965 = " = new String(target.";
  protected final String TEXT_966 = ");" + NL + "                if(!s1_";
  protected final String TEXT_967 = ".equals(s2_";
  protected final String TEXT_968 = ")){" + NL + "                    if(s1_";
  protected final String TEXT_969 = ".compareTo(s2_";
  protected final String TEXT_970 = ") > 0){";
  protected final String TEXT_971 = NL + "                    }else{";
  protected final String TEXT_972 = NL + "                    }" + NL + "                }";
  protected final String TEXT_973 = NL + "                if(this.";
  protected final String TEXT_974 = " - target.";
  protected final String TEXT_975 = " != 0){" + NL + "                    if(this.";
  protected final String TEXT_976 = " - target.";
  protected final String TEXT_977 = " > 0){";
  protected final String TEXT_978 = NL + "                    }else{";
  protected final String TEXT_979 = NL + "                    }" + NL + "                }";
  protected final String TEXT_980 = NL + "                    int cmp_";
  protected final String TEXT_981 = " = FormatterUtils.format_DateInUTC(this.";
  protected final String TEXT_982 = ", ";
  protected final String TEXT_983 = ").compareTo(FormatterUtils.format_DateInUTC(target.";
  protected final String TEXT_984 = ", ";
  protected final String TEXT_985 = "));" + NL + "                    if(cmp_";
  protected final String TEXT_986 = " > 0){";
  protected final String TEXT_987 = NL + "                    }else if(cmp_";
  protected final String TEXT_988 = " < 0){";
  protected final String TEXT_989 = NL + "                    }";
  protected final String TEXT_990 = NL + "                    if(!this.";
  protected final String TEXT_991 = ".equals(target.";
  protected final String TEXT_992 = ")){" + NL + "                        if(this.";
  protected final String TEXT_993 = ".compareTo(target.";
  protected final String TEXT_994 = ") > 0){";
  protected final String TEXT_995 = NL + "                        }else{";
  protected final String TEXT_996 = NL + "                        }" + NL + "                    }";
  protected final String TEXT_997 = NL + "                    int cmp_";
  protected final String TEXT_998 = " = String.valueOf(this.";
  protected final String TEXT_999 = ").compareTo(String.valueOf(target.";
  protected final String TEXT_1000 = "));" + NL + "                    if(cmp_";
  protected final String TEXT_1001 = " > 0){";
  protected final String TEXT_1002 = NL + "                    }else if(cmp_";
  protected final String TEXT_1003 = " < 0){";
  protected final String TEXT_1004 = NL + "                    }";
  protected final String TEXT_1005 = NL + "                    if(this.";
  protected final String TEXT_1006 = " > target.";
  protected final String TEXT_1007 = "){";
  protected final String TEXT_1008 = NL + "                    }else if(this.";
  protected final String TEXT_1009 = " < target.";
  protected final String TEXT_1010 = "){";
  protected final String TEXT_1011 = NL + "                    }";
  protected final String TEXT_1012 = NL + "                    int cmp_";
  protected final String TEXT_1013 = " = String.valueOf(this.";
  protected final String TEXT_1014 = ").compareTo(String.valueOf(target.";
  protected final String TEXT_1015 = "));" + NL + "                    if(cmp_";
  protected final String TEXT_1016 = " > 0){";
  protected final String TEXT_1017 = NL + "                    }else if(cmp_";
  protected final String TEXT_1018 = " < 0){";
  protected final String TEXT_1019 = NL + "                    }";
  protected final String TEXT_1020 = NL + "                    if(this.";
  protected final String TEXT_1021 = " > target.";
  protected final String TEXT_1022 = "){";
  protected final String TEXT_1023 = NL + "                    }else if(this.";
  protected final String TEXT_1024 = " < target.";
  protected final String TEXT_1025 = "){";
  protected final String TEXT_1026 = NL + "                    }";
  protected final String TEXT_1027 = NL + "                    int cmp_";
  protected final String TEXT_1028 = " = String.valueOf(this.";
  protected final String TEXT_1029 = ").compareTo(String.valueOf(target.";
  protected final String TEXT_1030 = "));";
  protected final String TEXT_1031 = NL + "                    int cmp_";
  protected final String TEXT_1032 = " = this.";
  protected final String TEXT_1033 = ".compareTo(target.";
  protected final String TEXT_1034 = ");";
  protected final String TEXT_1035 = NL + "                if(cmp_";
  protected final String TEXT_1036 = " > 0){";
  protected final String TEXT_1037 = NL + "                }else if(cmp_";
  protected final String TEXT_1038 = " < 0){";
  protected final String TEXT_1039 = NL + "                }";
  protected final String TEXT_1040 = NL + "                    int cmp_";
  protected final String TEXT_1041 = " = String.valueOf(this.";
  protected final String TEXT_1042 = ").compareTo(String.valueOf(target.";
  protected final String TEXT_1043 = "));" + NL + "                    if(cmp_";
  protected final String TEXT_1044 = " > 0){";
  protected final String TEXT_1045 = NL + "                    }else if(cmp_";
  protected final String TEXT_1046 = " < 0){";
  protected final String TEXT_1047 = NL + "                    }";
  protected final String TEXT_1048 = NL + "                    if(this.";
  protected final String TEXT_1049 = " > target.";
  protected final String TEXT_1050 = "){";
  protected final String TEXT_1051 = NL + "                    }else if(this.";
  protected final String TEXT_1052 = " < target.";
  protected final String TEXT_1053 = "){";
  protected final String TEXT_1054 = NL + "                    }";
  protected final String TEXT_1055 = NL + "                    int cmp_";
  protected final String TEXT_1056 = " = String.valueOf(this.";
  protected final String TEXT_1057 = ").compareTo(String.valueOf(target.";
  protected final String TEXT_1058 = "));" + NL + "                    if(cmp_";
  protected final String TEXT_1059 = " > 0){";
  protected final String TEXT_1060 = NL + "                    }else if(cmp_";
  protected final String TEXT_1061 = " < 0){";
  protected final String TEXT_1062 = NL + "                }";
  protected final String TEXT_1063 = NL + "                if(this.";
  protected final String TEXT_1064 = " > target.";
  protected final String TEXT_1065 = "){";
  protected final String TEXT_1066 = NL + "                }else if(this.";
  protected final String TEXT_1067 = " < target.";
  protected final String TEXT_1068 = "){";
  protected final String TEXT_1069 = NL + "                }";
  protected final String TEXT_1070 = NL + "            Don't support Object type: column--";
  protected final String TEXT_1071 = NL + "                int cmp_";
  protected final String TEXT_1072 = " = String.valueOf(this.";
  protected final String TEXT_1073 = ").compareTo(String.valueOf(target.";
  protected final String TEXT_1074 = "));" + NL + "                if(cmp_";
  protected final String TEXT_1075 = " > 0){";
  protected final String TEXT_1076 = NL + "                }else if(cmp_";
  protected final String TEXT_1077 = " < 0){";
  protected final String TEXT_1078 = NL + "                }";
  protected final String TEXT_1079 = NL + "                if(this.";
  protected final String TEXT_1080 = " > target.";
  protected final String TEXT_1081 = "){";
  protected final String TEXT_1082 = NL + "                }else if(this.";
  protected final String TEXT_1083 = " < target.";
  protected final String TEXT_1084 = "){";
  protected final String TEXT_1085 = NL + "                }";
  protected final String TEXT_1086 = NL + "            int comp_";
  protected final String TEXT_1087 = " = this.";
  protected final String TEXT_1088 = ".compareTo(target.";
  protected final String TEXT_1089 = ");" + NL + "            if(comp_";
  protected final String TEXT_1090 = " != 0){" + NL + "                if(comp_";
  protected final String TEXT_1091 = " > 0){";
  protected final String TEXT_1092 = NL + "                }else{";
  protected final String TEXT_1093 = NL + "                }" + NL + "" + NL + "            }";
  protected final String TEXT_1094 = NL + "            Don't support List type: column--";
  protected final String TEXT_1095 = NL + "            Don't support Document type: column--";
  protected final String TEXT_1096 = NL + "            Don't support Dynamic type: column--";
  protected final String TEXT_1097 = NL + "            }";
  protected final String TEXT_1098 = NL + "    public static class ";
  protected final String TEXT_1099 = "_Comparator  implements Comparable<";
  protected final String TEXT_1100 = "_Comparator>{";
  protected final String TEXT_1101 = NL + "        public ";
  protected final String TEXT_1102 = "_Comparator (";
  protected final String TEXT_1103 = " input) {";
  protected final String TEXT_1104 = NL + "        }" + NL + "" + NL + "        @Override" + NL + "        public int compareTo(";
  protected final String TEXT_1105 = "_Comparator target) {";
  protected final String TEXT_1106 = NL + "        }" + NL + "    }";
  protected final String TEXT_1107 = NL;
  protected final String TEXT_1108 = NL;
  protected final String TEXT_1109 = "\tstatic class OneReducePartitioner_";
  protected final String TEXT_1110 = " implements org.apache.hadoop.mapred.Partitioner {" + NL + "\t\tpublic int getPartition(Object keyObj, Object valueObj, int splitNum) {" + NL + "\t\t\treturn 0;" + NL + "\t\t}" + NL + "" + NL + "\t\tpublic void configure(JobConf arg0) {" + NL + "" + NL + "\t\t}" + NL + "\t}" + NL;
  ...
  public String generate(Object argument)
  {
    ...
    StructHelper cbnValueStruct = new StructHelper(combinerOutValueClass, outMetadataTable.getListColumns(), false);
    cbnValueStruct.generateCode();

    class Mapper extends MapperHelper{
        final Set<String> inputCols;

        public Mapper(final Set<String> inputCols) {
            this.inputCols = inputCols;
        }

        public void map(){
            for(String columnName : inputCols){
    ...
    Mapper mapper = new Mapper(inputCols);
    ...
    class Reducer extends ReducerHelper{
        ...
        public Reducer(final Set<String> inputCols, String topValue) {
            this.inputCols = inputCols;
            this.topValue = topValue;
        }

        public Reducer(final Set<String> inputCols, String topValue, boolean isCombiner) {
            this.inputCols = inputCols;
    ...
    stringBuffer.append(getOutValueClass());
    ...
    stringBuffer.append(TEXT_913);
                ...
                for (String inputColumn: inputCols) {
    ...
    stringBuffer.append(TEXT_926);
                ...
                this.output(getOutKey(), "topElement");
                
    stringBuffer.append(TEXT_927);
    
        }
    }
    Reducer reducer = new Reducer(inputCols, topValue);
...
class TTopUtil {
    ...
    stringBuffer.append(reducer.getInValueClass());
    ...
    class Combiner extends ReducerHelper {
        ...
        public Combiner(final Set<String> inputCols, String topValue) {
            tmpCombiner = new Reducer(inputCols, topValue, true);
        }
    ...
    Combiner combiner = new Combiner(inputCols, topValue);
