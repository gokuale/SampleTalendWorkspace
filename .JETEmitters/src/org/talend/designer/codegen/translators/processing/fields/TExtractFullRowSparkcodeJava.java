...
public class TExtractFullRowSparkcodeJava
{
  protected static String nl;
  public static synchronized TExtractFullRowSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractFullRowSparkcodeJava result = new TExtractFullRowSparkcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_79 = NL + "        try {";
  protected final String TEXT_80 = NL + "                if (";
  protected final String TEXT_81 = ".length() > 0) {";
  protected final String TEXT_82 = NL + "                    ";
  protected final String TEXT_83 = NL + "                } else {";
  protected final String TEXT_84 = NL + "                        ";
  protected final String TEXT_85 = NL + "                        throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_86 = "' in '";
  protected final String TEXT_87 = "' connection, value is invalid or this column should be nullable or have a default value.\");";
  protected final String TEXT_88 = NL + "                }";
  protected final String TEXT_89 = NL + "                ";
  protected final String TEXT_90 = NL + "        } catch (RuntimeException ex) {";
  protected final String TEXT_91 = NL + "        }";
  protected final String TEXT_92 = NL + "        ";
  protected final String TEXT_93 = NL + "            // Die immediately on errors." + NL + "            throw new IOException(";
  protected final String TEXT_94 = ");";
  protected final String TEXT_95 = NL + "                ";
  protected final String TEXT_96 = NL + "                // Ignore errors processing this row and move to the next.";
  protected final String TEXT_97 = NL + "                // Send error rows to the reject output.";
...
sparkTransformUtil.generateSparkCode(tExtractFullRowUtil, sparkFunction);
