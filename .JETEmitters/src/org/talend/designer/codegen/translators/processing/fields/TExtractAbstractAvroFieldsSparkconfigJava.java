...
public class TExtractAbstractAvroFieldsSparkconfigJava
{
  protected static String nl;
  public static synchronized TExtractAbstractAvroFieldsSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractAbstractAvroFieldsSparkconfigJava result = new TExtractAbstractAvroFieldsSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_79 = NL + "        org.apache.avro.generic.GenericRecord record = (org.apache.avro.generic.GenericRecord) ";
  protected final String TEXT_80 = ".get();" + NL + "        Object columnObject = null;" + NL + "        try {";
  protected final String TEXT_81 = NL + "                columnObject = record.get(\"";
  protected final String TEXT_82 = "\");" + NL + "                if(columnObject != null) {";
  ...
  protected final String TEXT_96 = NL + "        } catch (java.lang.Exception ex) {";
  protected final String TEXT_97 = NL + "        }";
  protected final String TEXT_98 = NL + "        ";
  protected final String TEXT_99 = NL;
  protected final String TEXT_100 = NL + "            ";
  protected final String TEXT_101 = NL + "            // Die immediately on errors." + NL + "            throw new IOException(";
  protected final String TEXT_102 = ");";
  protected final String TEXT_103 = NL + "                // Ignore errors processing this row and move to the next.";
  protected final String TEXT_104 = NL + "                // Send error rows to the reject output.";
  protected final String TEXT_105 = NL + "                ";
  protected final String TEXT_106 = NL + "                    ";
  protected final String TEXT_107 = NL + "                ";
  protected final String TEXT_108 = NL + "    org.apache.spark.api.java.JavaPairRDD<NullWritable, ";
  protected final String TEXT_109 = "> rdd_";
  protected final String TEXT_110 = ";" + NL + "    {" + NL + "        // Set up a Spark DataFlow with all of the necessary inputs to use" + NL + "        // this component." + NL + "        org.talend.bigdata.dataflow.spark.batch.SparkBatchDataFlowContext ";
  protected final String TEXT_111 = "_sdfContext =" + NL + "                new org.talend.bigdata.dataflow.spark.batch.SparkBatchDataFlowContext.Builder().withSparkContext(ctx).build();" + NL + "        org.talend.bigdata.dataflow.spark.batch.SparkBatchDataFlow ";
  protected final String TEXT_112 = "_sdf =" + NL + "                new org.talend.bigdata.dataflow.spark.batch.SparkBatchDataFlow(";
  protected final String TEXT_113 = "_sdfContext);" + NL;
  protected final String TEXT_114 = NL + "        ";
  protected final String TEXT_115 = "_sdf.putPairRDD(\"";
  protected final String TEXT_116 = "\", rdd_";
  protected final String TEXT_117 = ".mapToPair(new ExtractGenericRecord_";
  protected final String TEXT_118 = "()));" + NL + "" + NL + "        org.talend.bigdata.dataflow.hmap.HMap ";
  protected final String TEXT_119 = "_hmap = new org.talend.bigdata.dataflow.hmap.HMap();" + NL + "        org.talend.bigdata.dataflow.hmap.HMapSpecBuilder ";
  protected final String TEXT_120 = "_hsb = ";
  protected final String TEXT_121 = "_hmap.createSpecBuilder();" + NL + "" + NL + "        String avroSchema = rdd_";
  protected final String TEXT_122 = ".filter(new keepOneFilter_";
  protected final String TEXT_123 = "()).map(new MapToString_";
  protected final String TEXT_124 = "()).first();" + NL + "" + NL + "        LOG.info(\"Schema for rdd_";
  protected final String TEXT_125 = ": \"+ avroSchema);" + NL;
  protected final String TEXT_126 = NL + "        ";
  protected final String TEXT_127 = "_hsb.declareInput(\"";
  protected final String TEXT_128 = "\", new org.apache.avro.Schema.Parser().parse(avroSchema));";
  protected final String TEXT_129 = NL + "        ";
  protected final String TEXT_130 = "_hsb.declareOutput(\"";
  protected final String TEXT_131 = "\", ";
  protected final String TEXT_132 = ".getClassSchema()," + NL + "                                org.talend.bigdata.dataflow.hmap.HMapSpec.OutputType.FLATTEN);" + NL + "" + NL + "        // map each field";
  protected final String TEXT_133 = NL + "            ";
  protected final String TEXT_134 = "_hsb.map(\"";
  protected final String TEXT_135 = "\" + \".\" + ";
  protected final String TEXT_136 = ", \"";
  protected final String TEXT_137 = "\" + \".\" + \"";
  protected final String TEXT_138 = "\");";
  protected final String TEXT_139 = NL + NL + "        // Build the tMap spec and use that to build into the dataflow." + NL + "        org.talend.bigdata.dataflow.hmap.HMapSpec ";
  protected final String TEXT_140 = "_hs = ";
  protected final String TEXT_141 = "_hsb.build();";
  protected final String TEXT_142 = NL + "        ";
  protected final String TEXT_143 = "_hmap.createDataFlowBuilder(";
  protected final String TEXT_144 = "_hs).build(";
  protected final String TEXT_145 = "_sdf);" + NL + "" + NL + "        rdd_";
  protected final String TEXT_146 = " = ";
  protected final String TEXT_147 = "_sdf.getPairRDD(\"";
...
class TExtractAvroFieldsUtil extends org.talend.designer.common.TransformerBase {
    ...
    stringBuffer.append(getRowTransform().getCodeToSetOutField(columnName, "((java.nio.ByteBuffer)columnObject).array()"));
