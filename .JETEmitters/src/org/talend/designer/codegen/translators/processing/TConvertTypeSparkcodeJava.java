...
public class TConvertTypeSparkcodeJava
{
  protected static String nl;
  public static synchronized TConvertTypeSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TConvertTypeSparkcodeJava result = new TConvertTypeSparkcodeJava();
    nl = null;
    return result;
  }
