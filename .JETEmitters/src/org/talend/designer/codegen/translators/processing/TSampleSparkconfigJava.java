...
public class TSampleSparkconfigJava
{
  protected static String nl;
  public static synchronized TSampleSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSampleSparkconfigJava result = new TSampleSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_84 = ".sample(";
  protected final String TEXT_85 = ", ";
  protected final String TEXT_86 = "<=1.0?";
  protected final String TEXT_87 = ":1.0);";
  protected final String TEXT_88 = NL + "    ";
  protected final String TEXT_89 = " rdd_";
  protected final String TEXT_90 = " = rdd_";
  protected final String TEXT_91 = ".sample(";
  protected final String TEXT_92 = ", ";
  protected final String TEXT_93 = "<=1.0?";
  protected final String TEXT_94 = ":1.0, ";
 ...
 */
class TSampleUtil extends org.talend.designer.common.TransformerBase {
    ...
    stringBuffer.append(getRowTransform().getCodeToInitOut(false, copiedInColumns));
...
final String  withReplacement = ElementParameterParser.getValue(node, "__WITHREPLACEMENT__");
final String fraction = ElementParameterParser.getValue(node, "__FRACTION__");
final String hasSeed = ElementParameterParser.getValue(node, "__HASSEED__");
final String seed = ElementParameterParser.getValue(node, "__SEED__");

boolean hasReplacementParameter = "true".equals(withReplacement) ? true : false;
boolean hasSeedParameter = "true".equals(hasSeed) ? true : false;

final SparkRowTransformUtil sparkTransformUtil = new SparkRowTransformUtil();
final TSampleUtil tSampleUtil = new TSampleUtil(node, codeGenArgument, sparkTransformUtil);
...
functionGenerator = new SOFunctionGenerator(tSampleUtil, sparkFunction);

functionGenerator.init(node, cid, null, tSampleUtil.getInConnName(), null, tSampleUtil.getOutConnMainName() != null? tSampleUtil.getOutConnMainName(): tSampleUtil.getOutConnRejectName());

// Has a seed for random number generator ?
if(!hasSeedParameter){

    stringBuffer.append(TEXT_81);
    stringBuffer.append(sparkFunction.getConfigReturnedType(functionGenerator.getOutValueClass()));
    stringBuffer.append(TEXT_82);
    stringBuffer.append(tSampleUtil.getOutConnMainName());
    stringBuffer.append(TEXT_83);
    stringBuffer.append(tSampleUtil.getInConnName());
    stringBuffer.append(TEXT_84);
    stringBuffer.append(hasReplacementParameter);
