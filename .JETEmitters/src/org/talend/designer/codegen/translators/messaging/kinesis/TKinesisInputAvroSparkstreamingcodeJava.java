...
public class TKinesisInputAvroSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TKinesisInputAvroSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TKinesisInputAvroSparkstreamingcodeJava result = new TKinesisInputAvroSparkstreamingcodeJava();
    nl = null;
    return result;
  }
