...
public class TKinesisInputAvroSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TKinesisInputAvroSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TKinesisInputAvroSparkstreamingconfigJava result = new TKinesisInputAvroSparkstreamingconfigJava();
    nl = null;
    return result;
  }
