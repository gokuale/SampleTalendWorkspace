...
public class TXMLMapOutBeginJava {
  ...
  protected final String TEXT_153 = " = org.dom4j.DocumentHelper.createElement(\"";
  protected final String TEXT_154 = "\");" + NL + "\t\t\t\tif (";
  protected final String TEXT_155 = ".getNamespaceForPrefix(\"";
  protected final String TEXT_156 = "\") != null) {" + NL + "\t\t        \t";
  protected final String TEXT_157 = ".setQName(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_158 = "\", ";
  protected final String TEXT_159 = ".getNamespaceForPrefix(\"";
  protected final String TEXT_160 = "\")));" + NL + "\t\t        }";
  protected final String TEXT_161 = NL + "\t\t\t\t";
  protected final String TEXT_162 = " = org.dom4j.DocumentHelper.createElement(\"";
  protected final String TEXT_163 = "\");";
  protected final String TEXT_164 = NL + "\t\t\t\t";
  protected final String TEXT_165 = ".add(";
  protected final String TEXT_166 = ");";
  protected final String TEXT_167 = NL + "\t\t\t\t\t";
  protected final String TEXT_168 = ".elements().add(";
  protected final String TEXT_169 = ");";
  protected final String TEXT_170 = NL + "\t\t\t\t\tList allElements_";
  protected final String TEXT_171 = " = ";
  protected final String TEXT_172 = ".elements();" + NL + "\t\t\t\t\tif(allElements_";
  protected final String TEXT_173 = ".isEmpty()) {//when the group or loop element appear first time" + NL + "\t\t\t\t\t\tallElements_";
  protected final String TEXT_174 = ".add(";
  protected final String TEXT_175 = ");" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\torg.dom4j.Namespace namespace_";
  protected final String TEXT_176 = " = null;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_177 = NL + "\t\t\t\t\t\tint size_";
  protected final String TEXT_178 = " = currentElementList_";
  protected final String TEXT_179 = ".size();" + NL + "\t\t\t\t\t\tif(size_";
  protected final String TEXT_180 = " > 0){" + NL + "\t\t\t\t\t\t\tallElements_";
  protected final String TEXT_181 = ".add(allElements_";
  protected final String TEXT_182 = ".indexOf(currentElementList_";
  protected final String TEXT_183 = ".get(size_";
  protected final String TEXT_184 = "-1)) + 1, ";
  protected final String TEXT_185 = ");" + NL + "\t\t\t\t\t\t} else {//when the group or loop element appear first time" + NL + "\t\t\t\t\t\t\tint location_";
  protected final String TEXT_186 = " = allElements_";
  protected final String TEXT_187 = ".size();";
  protected final String TEXT_188 = NL + "\t\t\t\t\t\t\t\tboolean findInsertPosition_";
  protected final String TEXT_189 = " = false;" + NL + "\t\t\t\t\t\t\t\tList siblingList_";
  protected final String TEXT_190 = " = null;";
  protected final String TEXT_191 = NL + "\t\t\t\t\t\t\t\tif(!findInsertPosition_";
  protected final String TEXT_192 = ") {" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_193 = NL + "\t\t\t\t\t\t\t\t\tif(siblingList_";
  protected final String TEXT_194 = ".size() > 0) {" + NL + "\t\t\t\t\t\t\t\t\t\tfindInsertPosition_";
  protected final String TEXT_195 = " = true;" + NL + "\t\t\t\t\t\t\t\t\t\tlocation_";
  protected final String TEXT_196 = " = allElements_";
  protected final String TEXT_197 = ".indexOf(siblingList_";
  protected final String TEXT_198 = ".get(0));" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t}";
  protected final String TEXT_199 = NL + "\t\t\t\t\t\t\tallElements_";
  protected final String TEXT_200 = ".add(location_";
  protected final String TEXT_201 = ",";
  protected final String TEXT_202 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}\t";
  protected final String TEXT_203 = NL + "\t\t\t\t";
  protected final String TEXT_204 = ".elements().add(orderHelper.getInsertLocation(";
  ...
  protected final String TEXT_212 = ".addElement(\"";
  protected final String TEXT_213 = "\");" + NL + "\t\t        } else {" + NL + "\t\t        \t";
  protected final String TEXT_214 = " = ";
  protected final String TEXT_215 = ".addElement(\"";
  protected final String TEXT_216 = "\");" + NL + "\t\t        }";
  protected final String TEXT_217 = NL + "\t\t\t\t";
  protected final String TEXT_218 = " = ";
  protected final String TEXT_219 = ".addElement(\"";
  protected final String TEXT_220 = "\");";
  protected final String TEXT_221 = NL + "\t\tsubTreeRootParent = ";
  protected final String TEXT_222 = ";";
  protected final String TEXT_223 = NL + "//\t\tif(";
  protected final String TEXT_224 = "!=null){" + NL + "\t\t\tvalueMap.put(\"";
  protected final String TEXT_225 = "\",";
  protected final String TEXT_226 = ");" + NL + "\t\t\tif(valueMap.get(\"";
  protected final String TEXT_227 = "\")!=null) {" + NL + "\t\t\t\t";
  protected final String TEXT_228 = ".addAttribute(\"";
  protected final String TEXT_229 = "\",FormatterUtils.format(";
  protected final String TEXT_230 = ",";
  protected final String TEXT_231 = "));" + NL + "\t\t\t}";
  protected final String TEXT_232 = "else {" + NL + "\t\t\t\t";
  protected final String TEXT_233 = ".addAttribute(\"";
  protected final String TEXT_234 = "\",\"\");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_235 = NL + "//\t\t}";
  protected final String TEXT_236 = NL + "\t\t\t";
  protected final String TEXT_237 = ".addAttribute(\"";
  protected final String TEXT_238 = "\",\"\");";
  protected final String TEXT_239 = NL + "\t\tvalueMap.put(\"";
  protected final String TEXT_240 = "\",";
  protected final String TEXT_241 = ");" + NL + "\t\tif(valueMap.get(\"";
  protected final String TEXT_242 = "\")!=null) {" + NL + "\t\t\troutines.system.NestXMLTool.setText(";
  protected final String TEXT_243 = ", FormatterUtils.format(";
  protected final String TEXT_244 = ",";
  protected final String TEXT_245 = "));" + NL + "\t\t}";
  protected final String TEXT_246 = NL + "\t\t\tisNewElement = false;";
  protected final String TEXT_247 = NL + "\t\t\t\t\tif(isNewElement || groupbyList.size()<=";
  protected final String TEXT_248 = " || groupbyList.get(";
  protected final String TEXT_249 = ")==null";
  protected final String TEXT_250 = NL + "\t\t\t\t\t|| ( groupbyList.get(";
  protected final String TEXT_251 = ").get(";
  protected final String TEXT_252 = ")!=null ? !groupbyList.get(";
  protected final String TEXT_253 = ").get(";
  protected final String TEXT_254 = ").equals(FormatterUtils.format(";
  protected final String TEXT_255 = ",";
  protected final String TEXT_256 = ")) : FormatterUtils.format(";
  protected final String TEXT_257 = ",";
  protected final String TEXT_258 = ")!=null )";
  protected final String TEXT_259 = NL + "\t\t\t\t\t){" + NL;
  protected final String TEXT_260 = "\t" + NL + "\t\t\t\t\tif(groupbyList.size()<=";
  protected final String TEXT_261 = "){" + NL + "\t\t\t\t\t\tgroupbyList.add(new java.util.ArrayList<String>());" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tgroupbyList.get(";
  protected final String TEXT_262 = ").clear();" + NL + "\t\t\t\t\t}";
  protected final String TEXT_263 = NL + "\t\t\t\t\t\tgroupbyList.get(";
  protected final String TEXT_264 = ").add(FormatterUtils.format(";
  protected final String TEXT_265 = ",";
  protected final String TEXT_266 = "));";
  protected final String TEXT_267 = NL + "\t\t\t\t\tisNewElement=true;" + NL + "\t\t\t\t\tif(groupElementList.size()<=";
  protected final String TEXT_268 = "){" + NL + "\t\t\t\t\t\tgroupElementList.add(group";
  protected final String TEXT_269 = "_);" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tgroupElementList.set(";
  protected final String TEXT_270 = ",group";
  protected final String TEXT_271 = "_);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\tsubTreeRootParent=groupElementList.get(";
  protected final String TEXT_272 = ");" + NL + "\t\t\t\t}" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_273 = NL + "\t//the map store the previous value of aggregate columns" + NL + "\tjava.util.Map<String,Object> aggregateCacheMap_";
  protected final String TEXT_274 = " = new java.util.HashMap<String,Object>();";
  protected final String TEXT_275 = NL + "\t\t\t\t\t//init the map,the keys is aggregate columns xpath,the values is all null." + NL + "\t\t\t\t\taggregateCacheMap_";
  protected final String TEXT_276 = ".put(\"";
  protected final String TEXT_277 = "\",null);";
  protected final String TEXT_278 = NL + NL + "class GenerateDocument_";
  protected final String TEXT_279 = " {" + NL;
  protected final String TEXT_280 = NL + "\t\tTreeNode_API_";
  protected final String TEXT_281 = " treeNodeAPI = null;";
  protected final String TEXT_282 = NL + "\tjava.util.Map<String,Object> valueMap = null;" + NL + "\t" + NL + "\troutines.system.DocumentGenerateOrderHelper orderHelper = new routines.system.DocumentGenerateOrderHelper(";
  protected final String TEXT_283 = ");" + NL + "\t" + NL + "\torg.dom4j.Document doc = null;" + NL + "\t" + NL + "\torg.dom4j.Element root4Group = null;" + NL + "\t" + NL + "\torg.dom4j.io.OutputFormat format = null;" + NL + "\t" + NL + "\tjava.util.List<java.util.List<String>> groupbyList = null;" + NL + "\tjava.util.List<org.dom4j.Element> groupElementList = null;" + NL + "\tint order = 0;" + NL + "\t" + NL + "\tboolean isFirst = true;" + NL + "\t" + NL + "\tboolean\tneedRoot = true;";
  protected final String TEXT_284 = NL;
  protected final String TEXT_285 = NL + "\t\torg.dom4j.Element ";
  protected final String TEXT_286 = " = null;" + NL + "\t\tpublic boolean  ";
  protected final String TEXT_287 = " = false;";
  protected final String TEXT_288 = NL + "\t" + NL + "    public GenerateDocument_";
  protected final String TEXT_289 = "() {" + NL + "//    \tthis.treeNodeAPI = treeNodeAPI;" + NL + "    \t" + NL + "    \tvalueMap = new java.util.HashMap<String,Object>();" + NL + "    \t" + NL + "    \tgroupbyList =  new java.util.ArrayList<java.util.List<String>>();" + NL + "\t\tgroupElementList = new java.util.ArrayList<org.dom4j.Element>();" + NL + "    \t" + NL + "    \tdoc = org.dom4j.DocumentHelper.createDocument();" + NL + "    \tformat = org.dom4j.io.OutputFormat.createPrettyPrint();" + NL + "    \tformat.setTrimText(false);" + NL + "    }" + NL + "    " + NL + "    public org.dom4j.Document getDocument(){" + NL + "    \treturn this.doc;" + NL + "    }" + NL + "    " + NL + "\t//We generate the TreeNode_API object only if there is a document in the main input table." + NL + "    void generateElements(";
  protected final String TEXT_290 = "TreeNode_API_";
  protected final String TEXT_291 = " treeNodeAPI,";
  protected final String TEXT_292 = "boolean isInnerJoin";
  protected final String TEXT_293 = ", ";
  protected final String TEXT_294 = " ";
  protected final String TEXT_295 = NL + "\t";
  protected final String TEXT_296 = ") {" + NL + "\t" + NL + "\t" + NL + "\t/*if(this.treeNodeAPI==null) {" + NL + "\t\tthis.treeNodeAPI = treeNodeAPI;" + NL + "\t}*/" + NL + "\t" + NL + "\torg.dom4j.Element subTreeRootParent = null;" + NL + "// build root xml tree " + NL + "if (needRoot) {" + NL + "\tneedRoot=false;";
  protected final String TEXT_297 = NL + "\t\troot4Group = subTreeRootParent;" + NL + "\t}else{" + NL + "\t\tsubTreeRootParent=root4Group;" + NL + "\t}" + NL + "\t/* build group xml tree */" + NL + "\tboolean isNewElement = false;";
  protected final String TEXT_298 = NL + "\t\tisNewElement = false;";
  protected final String TEXT_299 = NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_300 = ") {";
  protected final String TEXT_301 = NL + "\t\t\t\t\t\t}";
  protected final String TEXT_302 = NL + "\t\t}" + NL + "    }" + NL + "" + NL + "\tGenerateDocument_";
  protected final String TEXT_303 = " gen_Doc_";
  protected final String TEXT_304 = "_";
  protected final String TEXT_305 = " = new GenerateDocument_";
  protected final String TEXT_306 = "();" + NL + "\tboolean docAlreadyInstanciate_";
  protected final String TEXT_307 = " = false;";
  protected final String TEXT_308 = NL;
  protected final String TEXT_309 = NL + "\t            class SortableRow_";
  protected final String TEXT_310 = " implements Comparable<SortableRow_";
  protected final String TEXT_311 = ">, routines.system.IPersistableRow<SortableRow_";
  protected final String TEXT_312 = "> { // G_TM_B_001 " + NL + "\t" + NL + "\t\t\t\t\tboolean is__rejectedInnerJoin;" + NL + "\t\t\t\t\t";
  protected final String TEXT_313 = " exprKey_";
  protected final String TEXT_314 = "__";
  protected final String TEXT_315 = ";" + NL + "\t\t\t                    \t";
  protected final String TEXT_316 = NL + "\t\t\t\t//";
  protected final String TEXT_317 = NL + "\t\t\t\t";
  protected final String TEXT_318 = " ";
  protected final String TEXT_319 = "__";
  protected final String TEXT_320 = ";" + NL + "\t\t\t                    ";
  protected final String TEXT_321 = NL + "\t\t\t        public void fillFrom(";
  protected final String TEXT_322 = " ";
  protected final String TEXT_323 = "Struct ";
  protected final String TEXT_324 = " ";
  protected final String TEXT_325 = " exprKey_";
  ...
  protected final String TEXT_334 = "this.exprKey_";
  protected final String TEXT_335 = "__";
  protected final String TEXT_336 = " = exprKey_";
  protected final String TEXT_337 = "__";
  protected final String TEXT_338 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_339 = NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        public void copyDataTo(";
  protected final String TEXT_340 = "Struct ";
  protected final String TEXT_341 = ") {" + NL + "\t\t\t\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_342 = ".";
  protected final String TEXT_343 = " = this.";
  protected final String TEXT_344 = "__";
  protected final String TEXT_345 = ";" + NL + "\t\t\t\t            \t";
  protected final String TEXT_346 = NL + "\t\t\t        }" + NL + "\t\t\t\t\tpublic String toString() {" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tStringBuilder sb = new StringBuilder();" + NL + "\t\t\t\t\t\tsb.append(super.toString());" + NL + "\t\t\t\t\t\tsb.append(\"[\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_347 = NL + "\t\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_348 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_349 = NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_350 = "__";
  protected final String TEXT_351 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"=\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(String.valueOf(this.";
  protected final String TEXT_352 = "__";
  protected final String TEXT_353 = "));" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_354 = NL + "\t\t\t\t\t\tsb.append(\"]\");" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\treturn sb.toString();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t        public int compareTo(SortableRow_";
  protected final String TEXT_355 = " other) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            ";
  protected final String TEXT_356 = NL + "\t\t\t            \treturnValue = checkNullsAndCompare(this.exprKey_";
  protected final String TEXT_357 = "__";
  protected final String TEXT_358 = ", other.exprKey_";
  protected final String TEXT_359 = "__";
  protected final String TEXT_360 = ");" + NL + "\t\t\t            \tif (returnValue != 0) {" + NL + "\t\t\t                    return returnValue;" + NL + "\t\t\t            \t}" + NL + "\t\t\t            ";
  protected final String TEXT_361 = NL + "\t\t\t            return returnValue;" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        private int checkNullsAndCompare(Object object1, Object object2) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            if (object1 instanceof Comparable && object2 instanceof Comparable) {" + NL + "\t\t\t                returnValue = ((Comparable) object1).compareTo(object2);" + NL + "\t\t\t            } else if (object1 != null && object2 != null) {" + NL + "\t\t\t                returnValue = compareStrings(object1.toString(), object2" + NL + "\t\t\t                        .toString());" + NL + "\t\t\t            } else if (object1 == null && object2 != null) {" + NL + "\t\t\t                returnValue = 1;" + NL + "\t\t\t            } else if (object1 != null && object2 == null) {" + NL + "\t\t\t                returnValue = -1;" + NL + "\t\t\t            } else {" + NL + "\t\t\t                returnValue = 0;" + NL + "\t\t\t            }" + NL + "\t\t\t            return returnValue;" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        private int compareStrings(String string1, String string2) {" + NL + "\t\t\t            return string1.compareTo(string2);" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t\t\tpublic void readData(ObjectInputStream dis) {" + NL + "\t\t\t\t\t\tsynchronized(";
  protected final String TEXT_362 = "Struct.commonByteArrayLock_";
  protected final String TEXT_363 = "_";
  protected final String TEXT_364 = ") {" + NL + "\t\t\t\t\t\t    try {" + NL + "\t\t\t\t\t\t\t\tint length = 0;" + NL + "\t\t\t\t\t\t\t\tthis.is__rejectedInnerJoin = dis.readBoolean();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_365 = NL + "\t\t\t\t            this.";
  protected final String TEXT_366 = "__";
  protected final String TEXT_367 = " = dis.read";
  protected final String TEXT_368 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_369 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_370 = "__";
  protected final String TEXT_371 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_372 = "Struct.commonByteArray_";
  protected final String TEXT_373 = "_";
  protected final String TEXT_374 = ".length) {" + NL + "\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_375 = "Struct.commonByteArray_";
  protected final String TEXT_376 = "_";
  protected final String TEXT_377 = ".length == 0) {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_378 = "Struct.commonByteArray_";
  protected final String TEXT_379 = "_";
  protected final String TEXT_380 = " = new byte[1024];" + NL + "\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_381 = "Struct.commonByteArray_";
  protected final String TEXT_382 = "_";
  protected final String TEXT_383 = " = new byte[2 * length];" + NL + "\t\t\t           \t\t\t\t}" + NL + "\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_384 = "Struct.commonByteArray_";
  protected final String TEXT_385 = "_";
  protected final String TEXT_386 = ", 0, length);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_387 = "__";
  protected final String TEXT_388 = " = new String(";
  protected final String TEXT_389 = "Struct.commonByteArray_";
  protected final String TEXT_390 = "_";
  protected final String TEXT_391 = ", 0, length);" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_392 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_393 = "__";
  protected final String TEXT_394 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tthis.";
  protected final String TEXT_395 = "__";
  protected final String TEXT_396 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_397 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_398 = "__";
  protected final String TEXT_399 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_400 = "__";
  protected final String TEXT_401 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_402 = NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_403 = "__";
  protected final String TEXT_404 = " = (";
  protected final String TEXT_405 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_406 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_407 = "__";
  protected final String TEXT_408 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tthis.";
  protected final String TEXT_409 = "__";
  protected final String TEXT_410 = " = dis.read";
  protected final String TEXT_411 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_412 = NL + "\t\t\t            ";
  protected final String TEXT_413 = NL + "\t\t\t\t            this.exprKey_";
  protected final String TEXT_414 = "__";
  protected final String TEXT_415 = " = dis.read";
  protected final String TEXT_416 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_418 = "__";
  protected final String TEXT_419 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tthis.exprKey_";
  protected final String TEXT_420 = "__";
  protected final String TEXT_421 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_422 = NL + "\t\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_423 = "__";
  protected final String TEXT_424 = " = null;" + NL + "\t\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_425 = "Struct.commonByteArray_";
  protected final String TEXT_426 = "_";
  protected final String TEXT_427 = ".length) {" + NL + "\t\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_428 = "Struct.commonByteArray_";
  protected final String TEXT_429 = "_";
  protected final String TEXT_430 = ".length == 0) {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_431 = "Struct.commonByteArray_";
  protected final String TEXT_432 = "_";
  protected final String TEXT_433 = " = new byte[1024];" + NL + "\t\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_434 = "Struct.commonByteArray_";
  protected final String TEXT_435 = "_";
  protected final String TEXT_436 = " = new byte[2 * length];" + NL + "\t\t\t\t           \t\t\t\t}" + NL + "\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_437 = "Struct.commonByteArray_";
  protected final String TEXT_438 = "_";
  protected final String TEXT_439 = ", 0, length);" + NL + "\t\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_440 = "__";
  protected final String TEXT_441 = " = new String(";
  protected final String TEXT_442 = "Struct.commonByteArray_";
  protected final String TEXT_443 = "_";
  protected final String TEXT_444 = ", 0, length);" + NL + "\t\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_445 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_446 = "__";
  protected final String TEXT_447 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_448 = "__";
  protected final String TEXT_449 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_450 = NL + "\t\t\t   \t\t\t\tthis.exprKey_";
  protected final String TEXT_451 = "__";
  protected final String TEXT_452 = " = (";
  protected final String TEXT_453 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_454 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_455 = "__";
  protected final String TEXT_456 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tthis.exprKey_";
  protected final String TEXT_457 = "__";
  protected final String TEXT_458 = " = dis.read";
  protected final String TEXT_459 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_460 = NL + "\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t";
  protected final String TEXT_461 = NL + "\t\t\t\t";
  protected final String TEXT_462 = NL + "\t\t\t\t\t} catch(ClassNotFoundException eCNFE) {" + NL + "\t\t\t\t\t\t\t throw new RuntimeException(eCNFE);" + NL + "\t\t\t\t";
  protected final String TEXT_463 = NL + "\t\t\t\t\t    \t}" + NL + "\t\t\t\t\t\t} " + NL + "\t\t\t\t\t}" + NL + "\t\t\t\tpublic void writeData(ObjectOutputStream dos) {" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t   \tdos.writeBoolean(this.is__rejectedInnerJoin);" + NL + "\t\t\t\t\t";
  protected final String TEXT_464 = NL + "\t\t\t            \tdos.write";
  ...
  protected final String TEXT_470 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.";
  protected final String TEXT_471 = "__";
  protected final String TEXT_472 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_473 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_474 = "__";
  protected final String TEXT_475 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.";
  protected final String TEXT_476 = "__";
  protected final String TEXT_477 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_478 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_479 = "__";
  protected final String TEXT_480 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.";
  protected final String TEXT_481 = "__";
  protected final String TEXT_482 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.";
  protected final String TEXT_483 = "__";
  protected final String TEXT_484 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_485 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.";
  protected final String TEXT_486 = "__";
  protected final String TEXT_487 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_488 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_489 = "__";
  protected final String TEXT_490 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  protected final String TEXT_491 = "(this.";
  protected final String TEXT_492 = "__";
  protected final String TEXT_493 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_494 = NL + "\t\t\t            ";
  protected final String TEXT_495 = NL + "\t\t\t\t            dos.write";
  protected final String TEXT_496 = "(this.exprKey_";
  protected final String TEXT_497 = "__";
  protected final String TEXT_498 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_499 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_500 = "__";
  protected final String TEXT_501 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.exprKey_";
  protected final String TEXT_502 = "__";
  protected final String TEXT_503 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_504 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_505 = "__";
  protected final String TEXT_506 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.exprKey_";
  protected final String TEXT_507 = "__";
  protected final String TEXT_508 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_509 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_510 = "__";
  protected final String TEXT_511 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.exprKey_";
  protected final String TEXT_512 = "__";
  protected final String TEXT_513 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.exprKey_";
  protected final String TEXT_514 = "__";
  protected final String TEXT_515 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_516 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.exprKey_";
  protected final String TEXT_517 = "__";
  protected final String TEXT_518 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_519 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_520 = "__";
  protected final String TEXT_521 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  protected final String TEXT_522 = "(this.exprKey_";
  protected final String TEXT_523 = "__";
  protected final String TEXT_524 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_525 = NL + "\t\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_526 = NL + "\t\t\t    }" + NL + "\t\t\t}" + NL + "\t     }" + NL + "\t   ";
