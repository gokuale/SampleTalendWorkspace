...
public class TStandardizeRowBeginJava
{
  ...
  protected final String TEXT_7 = ".getMatcher().setMinimumSimilarity(";
  protected final String TEXT_8 = ");" + NL + "engine_";
  protected final String TEXT_9 = ".getMatcher().setSlopForPartialMatch(";
...
int slop = Integer.valueOf(ElementParameterParser.getValue(node, "__SLOP_FOR_PARTIAL_MATCH__"));
