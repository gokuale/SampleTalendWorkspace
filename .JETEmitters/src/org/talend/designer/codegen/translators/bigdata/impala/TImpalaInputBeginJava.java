...
public class TImpalaInputBeginJava
{
  ...
  protected final String TEXT_184 = " = \"jdbc:hive2://\"+";
  protected final String TEXT_185 = "+\":\"+";
  protected final String TEXT_186 = "+\"/\"+";
  protected final String TEXT_187 = " + ";
  protected final String TEXT_188 = "; ";
  protected final String TEXT_189 = NL + "\t\t\tString dbname_";
  protected final String TEXT_190 = " = (String)globalMap.get(\"";
  protected final String TEXT_191 = "\");" + NL + "\t\t\tif(dbname_";
  protected final String TEXT_192 = "!=null && !\"\".equals(dbname_";
  protected final String TEXT_193 = ".trim()) && !\"default\".equals(dbname_";
  protected final String TEXT_194 = ".trim())) {" + NL + "\t\t\t\tjava.sql.Statement goToDatabase_";
  protected final String TEXT_195 = " = conn_";
  protected final String TEXT_196 = ".createStatement();" + NL + "\t\t\t\tgoToDatabase_";
  protected final String TEXT_197 = ".execute(\"use \" + dbname_";
  protected final String TEXT_198 = ");" + NL + "\t\t\t\tgoToDatabase_";
  protected final String TEXT_199 = ".close();" + NL + "\t\t    }";
  protected final String TEXT_200 = NL + "\t\t\tString dbname_";
  protected final String TEXT_201 = " = ";
  protected final String TEXT_202 = ";" + NL + "\t\t\tif(dbname_";
  protected final String TEXT_203 = "!=null && !\"\".equals(dbname_";
  protected final String TEXT_204 = ".trim()) && !\"default\".equals(dbname_";
  protected final String TEXT_205 = ".trim())) {" + NL + "\t\t\t\tjava.sql.Statement goToDatabase_";
  protected final String TEXT_206 = " = conn_";
  protected final String TEXT_207 = ".createStatement();" + NL + "\t\t\t\tgoToDatabase_";
  protected final String TEXT_208 = ".execute(\"use \" + dbname_";
  protected final String TEXT_209 = ");" + NL + "\t\t\t\tgoToDatabase_";
  ...
  protected final String TEXT_218 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_219 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_220 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_221 = " = dataSources_";
  protected final String TEXT_222 = ".get(";
  protected final String TEXT_223 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_257 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_258 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
