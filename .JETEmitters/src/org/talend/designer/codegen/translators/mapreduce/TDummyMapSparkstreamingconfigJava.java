...
public class TDummyMapSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TDummyMapSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDummyMapSparkstreamingconfigJava result = new TDummyMapSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_84 = NL + "            org.apache.spark.streaming.api.java.JavaDStream <";
  protected final String TEXT_85 = "> rdd_";
  protected final String TEXT_86 = " = rdd_";
  protected final String TEXT_87 = ".transform(new ";
  protected final String TEXT_88 = "_TransformToValue());";
  protected final String TEXT_89 = NL + "          org.apache.spark.api.java.JavaRDD <";
...
boolean isStreaming = "SPARKSTREAMING".equals(node.getComponent().getType()) && !isNodeInBatchMode;
if("KEYVALUE".equals(type)) {
   ...
   sparkTransformUtil.generateSparkConfig(tDummyMapUtil, sparkFunction);
   ...
   if(inputIsPair) {
    ...
    stringBuffer.append(outConn.getUniqueName());
    stringBuffer.append(TEXT_86);
    stringBuffer.append(inConn.getUniqueName());
