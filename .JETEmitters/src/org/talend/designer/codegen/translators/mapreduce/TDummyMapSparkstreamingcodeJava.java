package org.talend.designer.codegen.translators.mapreduce;
...
public class TDummyMapSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TDummyMapSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDummyMapSparkstreamingcodeJava result = new TDummyMapSparkstreamingcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_84 = NL + "            private static class ";
  protected final String TEXT_85 = "_TransformToValue implements org.apache.spark.api.java.function.Function<org.apache.spark.api.java.JavaPairRDD<";
  protected final String TEXT_86 = ", ";
  protected final String TEXT_87 = ">, org.apache.spark.api.java.JavaRDD<";
  protected final String TEXT_88 = ">>{" + NL + "                public org.apache.spark.api.java.JavaRDD<";
  protected final String TEXT_89 = "> call(org.apache.spark.api.java.JavaPairRDD<";
  protected final String TEXT_90 = ", ";
  protected final String TEXT_91 = "> pairRdd){" + NL + "                  return pairRdd.values();" + NL + "                }" + NL + "            }";
...
/**
 * Contains common processing for tDummyMap code generation.  This is
 ...
 */
class TDummyMapUtil extends org.talend.designer.common.TransformerBase {
    ...
    public TDummyMapUtil(INode node,
        ...
        if (null != getInConn() && null != getOutConnMain()) {
            ...
            /**
            * There is no reject in a tDummyMap. But if a tDummyMap is generated in the middle of a Reject row, then
            * the new output row will be a "reject" as weel. Then we will consider a REJECT as a FLOW MAIN for this component.
            */
            copiedInColumns = org.talend.designer.common.TransformerBaseUtil.getColumnsUnion(getInColumns(), getOutColumnsReject());
            columnsSize = getOutConnReject().getMetadataTable().getListColumns().size();
        } else {
...
final TDummyMapUtil tDummyMapUtil = new TDummyMapUtil(
...
boolean isStreaming = "SPARKSTREAMING".equals(node.getComponent().getType());

String type = requiredOutputType == null ? outgoingType : requiredOutputType;
if("KEYVALUE".equals(type)) {
    sparkFunction = new org.talend.designer.spark.generator.MapToPairFunction(inputIsPair, false, keyList);
    sparkTransformUtil.generateSparkCode(tDummyMapUtil, sparkFunction);
}else if("VALUE".equals(type)) {
        if(inputIsPair&&isStreaming){
            IConnection outConn = bigDataNode.getOutgoingConnections().get(0);
            IConnection inConn = bigDataNode.getIncomingConnections().get(0);
            
    stringBuffer.append(TEXT_84);
    stringBuffer.append(cid);
    stringBuffer.append(TEXT_85);
    stringBuffer.append(org.talend.designer.spark.generator.utils.SparkFunctionUtil.getKeyType(keyList, "INPUT"));
    stringBuffer.append(TEXT_86);
    stringBuffer.append(codeGenArgument.getRecordStructName(inConn));
    stringBuffer.append(TEXT_87);
    stringBuffer.append(codeGenArgument.getRecordStructName(outConn));
