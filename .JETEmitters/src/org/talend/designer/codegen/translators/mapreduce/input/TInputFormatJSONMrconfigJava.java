...
public class TInputFormatJSONMrconfigJava
{
  protected static String nl;
  public static synchronized TInputFormatJSONMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInputFormatJSONMrconfigJava result = new TInputFormatJSONMrconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_124 = NL + "            job.set(\"mapreduce.input.fileinputformat.inputdir\", ";
  protected final String TEXT_125 = ");" + NL + "            job.set(\"mapred.input.dir\", ";
