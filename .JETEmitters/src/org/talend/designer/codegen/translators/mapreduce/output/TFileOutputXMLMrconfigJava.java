...
public class TFileOutputXMLMrconfigJava
{
  protected static String nl;
  public static synchronized TFileOutputXMLMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputXMLMrconfigJava result = new TFileOutputXMLMrconfigJava();
    nl = null;
    return result;
  }
