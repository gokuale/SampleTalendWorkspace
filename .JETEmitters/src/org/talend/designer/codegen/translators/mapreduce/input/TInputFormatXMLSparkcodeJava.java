...
public class TInputFormatXMLSparkcodeJava
{
  protected static String nl;
  public static synchronized TInputFormatXMLSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInputFormatXMLSparkcodeJava result = new TInputFormatXMLSparkcodeJava();
    nl = null;
    return result;
  }
