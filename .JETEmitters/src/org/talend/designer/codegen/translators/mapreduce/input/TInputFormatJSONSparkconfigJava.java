...
public class TInputFormatJSONSparkconfigJava
{
  protected static String nl;
  public static synchronized TInputFormatJSONSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInputFormatJSONSparkconfigJava result = new TInputFormatJSONSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_121 = " = ctx" + NL + "                            .hadoopRDD(" + NL + "                                    job,";
  protected final String TEXT_122 = NL + "                                    ";
  protected final String TEXT_123 = "StructInputFormat.class," + NL + "                                    NullWritable.class,";
  protected final String TEXT_124 = NL + "                                    ";
  protected final String TEXT_125 = ".class);";
...
if (metadatas != null && metadatas.size() > 0) {
    ...
    stringBuffer.append(codeGenArgument.getRecordStructName(connection));
