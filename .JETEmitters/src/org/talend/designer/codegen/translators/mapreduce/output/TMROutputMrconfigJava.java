...
public class TMROutputMrconfigJava
{
  protected static String nl;
  public static synchronized TMROutputMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMROutputMrconfigJava result = new TMROutputMrconfigJava();
    nl = null;
    return result;
  }
