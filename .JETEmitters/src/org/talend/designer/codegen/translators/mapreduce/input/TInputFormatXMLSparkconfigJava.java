...
public class TInputFormatXMLSparkconfigJava
{
  protected static String nl;
  public static synchronized TInputFormatXMLSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInputFormatXMLSparkconfigJava result = new TInputFormatXMLSparkconfigJava();
    nl = null;
    return result;
  }
