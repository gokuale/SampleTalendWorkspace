...
public class TDummyMapKeySparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TDummyMapKeySparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDummyMapKeySparkstreamingcodeJava result = new TDummyMapKeySparkstreamingcodeJava();
    nl = null;
    return result;
  }
