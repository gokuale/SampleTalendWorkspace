...
public class TDummyMapKeySparkconfigJava
{
  protected static String nl;
  public static synchronized TDummyMapKeySparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDummyMapKeySparkconfigJava result = new TDummyMapKeySparkconfigJava();
    nl = null;
    return result;
  }
