...
public class TAvroOutputMrconfigJava
{
  protected static String nl;
  public static synchronized TAvroOutputMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAvroOutputMrconfigJava result = new TAvroOutputMrconfigJava();
    nl = null;
    return result;
  }
