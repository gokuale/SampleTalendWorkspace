...
public class THDFSInputFormatSparkconfigJava
{
  protected static String nl;
  public static synchronized THDFSInputFormatSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    THDFSInputFormatSparkconfigJava result = new THDFSInputFormatSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_119 = NL + NL + "\t\t\torg.apache.spark.api.java.JavaPairRDD<NullWritable, ";
  protected final String TEXT_120 = "> rdd_";
  protected final String TEXT_121 = " = ctx" + NL + "\t\t\t                .hadoopRDD(" + NL + "\t\t\t                        job," + NL + "\t\t\t                        ";
  protected final String TEXT_122 = "StructInputFormat.class," + NL + "\t\t\t                        NullWritable.class," + NL + "\t\t\t                        ";
...
if (metadatas != null && metadatas.size() > 0) {
    ...
    if(metadata != null){
        ...
        if ((connections != null) && (connections.size() > 0)) {
            ...
            // The generated variable job comes from the spark_subprocess_header.javajet
