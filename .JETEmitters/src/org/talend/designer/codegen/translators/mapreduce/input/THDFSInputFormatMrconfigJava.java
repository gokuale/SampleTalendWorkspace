...
public class THDFSInputFormatMrconfigJava
{
  protected static String nl;
  public static synchronized THDFSInputFormatMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    THDFSInputFormatMrconfigJava result = new THDFSInputFormatMrconfigJava();
    nl = null;
    return result;
  }
