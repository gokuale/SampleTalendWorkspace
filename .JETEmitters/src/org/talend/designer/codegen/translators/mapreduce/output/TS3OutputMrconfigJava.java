...
public class TS3OutputMrconfigJava
{
  ...
  protected final String TEXT_26 = NL + "        {" + NL + "            org.apache.hadoop.fs.s3.S3FileSystem s3FileSystem = new org.apache.hadoop.fs.s3.S3FileSystem();" + NL + "            s3FileSystem.initialize(new java.net.URI(outputPath_";
  protected final String TEXT_27 = "), getConf());" + NL + "            s3FileSystem.delete(new Path(outputPath_";
  protected final String TEXT_28 = "),true);" + NL + "        }";
  protected final String TEXT_29 = NL + "        {" + NL + "            org.apache.hadoop.fs.s3native.NativeS3FileSystem s3nFileSystem = new org.apache.hadoop.fs.s3native.NativeS3FileSystem();" + NL + "            s3nFileSystem.initialize(new java.net.URI(outputPath_";
  protected final String TEXT_30 = "), getConf());" + NL + "            s3nFileSystem.delete(new Path(outputPath_";
