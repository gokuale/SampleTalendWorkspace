...
public class TInputFormatXMLMrconfigJava
{
  protected static String nl;
  public static synchronized TInputFormatXMLMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInputFormatXMLMrconfigJava result = new TInputFormatXMLMrconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_120 = NL + "            MultipleInputs.addInputPath(job,";
  protected final String TEXT_121 = NL + "                    ";
  protected final String TEXT_122 = "StructInputFormat.class," + NL + "                    ChainMapper.class, \"";
  protected final String TEXT_123 = "\");" + NL + "            chainMapper.setCid(\"";
  protected final String TEXT_124 = "\");" + NL;
  protected final String TEXT_125 = NL + "            job.set(\"mapreduce.input.fileinputformat.inputdir\", ";
  protected final String TEXT_126 = ");" + NL + "            job.set(\"mapred.input.dir\", ";
...
java.util.List< ? extends IConnection> connections = node.getOutgoingConnections();
...
if (connections == null || connections.size() == 0)
    ...
    stringBuffer.append(connections.get(0).getName());
