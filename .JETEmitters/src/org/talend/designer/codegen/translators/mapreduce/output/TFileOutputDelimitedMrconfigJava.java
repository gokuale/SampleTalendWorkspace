...
public class TFileOutputDelimitedMrconfigJava
{
  protected static String nl;
  public static synchronized TFileOutputDelimitedMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputDelimitedMrconfigJava result = new TFileOutputDelimitedMrconfigJava();
    nl = null;
    return result;
  }
