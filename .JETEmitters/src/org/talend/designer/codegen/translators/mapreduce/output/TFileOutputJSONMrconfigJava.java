...
public class TFileOutputJSONMrconfigJava
{
  protected static String nl;
  public static synchronized TFileOutputJSONMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputJSONMrconfigJava result = new TFileOutputJSONMrconfigJava();
    nl = null;
    return result;
  }
