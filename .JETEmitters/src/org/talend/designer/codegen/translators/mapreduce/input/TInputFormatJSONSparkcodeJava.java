...
public class TInputFormatJSONSparkcodeJava
{
  protected static String nl;
  public static synchronized TInputFormatJSONSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInputFormatJSONSparkcodeJava result = new TInputFormatJSONSparkcodeJava();
    nl = null;
    return result;
  }
