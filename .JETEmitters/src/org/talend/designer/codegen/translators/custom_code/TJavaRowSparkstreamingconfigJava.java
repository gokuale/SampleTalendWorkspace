...
public class TJavaRowSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TJavaRowSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJavaRowSparkstreamingconfigJava result = new TJavaRowSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_79 = NL + "            java.util.List<";
  protected final String TEXT_80 = "> outputList = new java.util.ArrayList<";
  protected final String TEXT_81 = ">();";
  protected final String TEXT_82 = NL + "            ";
  protected final String TEXT_83 = " input = ";
  protected final String TEXT_84 = ";" + NL + "            // Inner class that extends that the component's output class" + NL + "            // Makes it easier for the user to create new output records without" + NL + "            // knowing the name of the exact output class" + NL + "            class Output extends ";
  protected final String TEXT_85 = " implements Serializable{" + NL + "            }";
  protected final String TEXT_86 = NL + "            ";
  protected final String TEXT_87 = NL + "            for (";
  protected final String TEXT_88 = " row : outputList){" + NL + "                outputs.add(new scala.Tuple2<NullWritable, ";
  protected final String TEXT_89 = ">(NullWritable.get(), row));" + NL + "            }";
  ...
  protected final String TEXT_99 = " = output;";
...
final String mapType = ElementParameterParser.getValue(node, "__MAPTYPE__");
 ...
 */
class TSparkJavaRowUtil extends org.talend.designer.common.TransformerBase {
    ...
    final String cid = node.getUniqueName();
    // user's input
    final String userCode = ElementParameterParser.getValue(node, "__CODE__");
    final String mapType = ElementParameterParser.getValue(node, "__MAPTYPE__");

    /** TODO: Used in DI, tied to CHECK_NUM */
    private int columnsSize = 0;

    public TSparkJavaRowUtil(INode node,
    ...
    public void generateTransform(boolean hasAReturnedType) {
        ...
        if("FLATMAP".equals(mapType)){

    stringBuffer.append(TEXT_79);
    stringBuffer.append(getRowTransform().getOutValueClass());
...
final TSparkJavaRowUtil tSparkJavaRowUtil = new TSparkJavaRowUtil(node, codeGenArgument, sparkTransformUtil);

sparkTransformUtil.generateSparkConfig(tSparkJavaRowUtil, sparkFunction);
