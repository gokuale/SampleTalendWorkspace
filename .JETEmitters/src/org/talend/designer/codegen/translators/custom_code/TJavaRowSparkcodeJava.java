...
public class TJavaRowSparkcodeJava
{
  protected static String nl;
  public static synchronized TJavaRowSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJavaRowSparkcodeJava result = new TJavaRowSparkcodeJava();
    nl = null;
    return result;
  }
