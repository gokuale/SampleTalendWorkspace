...
public class TJavaSparkcodeJava
{
  protected static String nl;
  public static synchronized TJavaSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJavaSparkcodeJava result = new TJavaSparkcodeJava();
    nl = null;
    return result;
  }
...
sparkTransformUtil.generateSparkCode(tSparkJavaUtil, sparkFunction);
