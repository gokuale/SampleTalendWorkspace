...
public class TJavaSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TJavaSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJavaSparkstreamingconfigJava result = new TJavaSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_79 = NL + "\t org.apache.spark.api.java.JavaRDD<";
 ...
 */
class TSparkJavaUtil extends org.talend.designer.common.TransformerBase {
    ...
    public TSparkJavaUtil(INode node,
...
// Force Spark function to a non null value in order to use it later
// This component doesn't generate any output so we don't care about the type of SparkFunction
org.talend.designer.spark.generator.SparkFunction sparkFunction = new org.talend.designer.spark.generator.MapFunction(false);
...
final TSparkJavaUtil tSparkJavaUtil = new TSparkJavaUtil(node, codeGenArgument, sparkTransformUtil);
final org.talend.designer.common.TransformerBase transformer = tSparkJavaUtil;

org.talend.designer.spark.generator.FunctionGenerator functionGenerator = null;
functionGenerator = new SOFunctionGenerator(tSparkJavaUtil, sparkFunction);

functionGenerator.init(node, cid, null, tSparkJavaUtil.getInConnName(), null, tSparkJavaUtil.getOutConnMainName() != null? tSparkJavaUtil.getOutConnMainName(): tSparkJavaUtil.getOutConnRejectName());

if(org.talend.designer.common.tmap.LookupUtil.isNodeInBatchMode(node)) {

    stringBuffer.append(TEXT_79);
    stringBuffer.append(functionGenerator.getInValueClass());
    stringBuffer.append(TEXT_80);
    stringBuffer.append(cid);
    stringBuffer.append(TEXT_81);
    stringBuffer.append(tSparkJavaUtil.getInConnName());
    ...
    if (node.getIncomingConnections() != null && node.getIncomingConnections().size() > 0
            && node.getIncomingConnections().get(0).getLineStyle().hasConnectionCategory(IConnectionCategory.DATA)) {
