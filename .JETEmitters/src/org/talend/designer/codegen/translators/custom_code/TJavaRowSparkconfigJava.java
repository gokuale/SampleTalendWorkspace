...
public class TJavaRowSparkconfigJava
{
  protected static String nl;
  public static synchronized TJavaRowSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJavaRowSparkconfigJava result = new TJavaRowSparkconfigJava();
    nl = null;
    return result;
  }
