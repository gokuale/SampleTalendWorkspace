...
public class TJavaRowSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TJavaRowSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJavaRowSparkstreamingcodeJava result = new TJavaRowSparkstreamingcodeJava();
    nl = null;
    return result;
  }
...
sparkTransformUtil.generateSparkCode(tSparkJavaRowUtil, sparkFunction);
