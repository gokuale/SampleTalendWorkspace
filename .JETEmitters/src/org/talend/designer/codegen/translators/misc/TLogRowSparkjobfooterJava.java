...
public class TLogRowSparkjobfooterJava
{
  protected static String nl;
  public static synchronized TLogRowSparkjobfooterJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TLogRowSparkjobfooterJava result = new TLogRowSparkjobfooterJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_182 = ".format(\"%1$";
  ...
  protected final String TEXT_264 = NL + "    fs.delete(new Path(outputPath_";
  protected final String TEXT_265 = "), true);";
  protected final String TEXT_266 = NL + "        FileSystem.setDefaultUri(ctx.hadoopConfiguration(), currentURI_";
  protected final String TEXT_267 = "_footer);" + NL + "        fs = FileSystem.get(ctx.hadoopConfiguration());";
