...
public class TFixedFlowInputSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TFixedFlowInputSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFixedFlowInputSparkstreamingcodeJava result = new TFixedFlowInputSparkstreamingcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_194 = NL + NL + "    public java.util.List<";
  protected final String TEXT_195 = "> getList() {" + NL + "        java.util.List<";
  protected final String TEXT_196 = "> list = new java.util.ArrayList<";
  ...
  protected final String TEXT_202 = NL + "                 list.add(row);" + NL + "            }" + NL + "        }" + NL + "        return list;" + NL + "    }" + NL + "}" + NL;
  protected final String TEXT_203 = NL + NL + NL + "public static class CustomReceiver_";
  protected final String TEXT_204 = " extends org.apache.spark.streaming.receiver.Receiver<";
  protected final String TEXT_205 = "> {" + NL + "" + NL + "    private final java.util.List<";
  protected final String TEXT_206 = "> list;" + NL + "    private long repetitionInterval;" + NL + "" + NL + "    public CustomReceiver_";
  protected final String TEXT_207 = "(java.util.List<";
  protected final String TEXT_208 = "> list, long repetitionInterval) {" + NL + "        super(org.apache.spark.storage.StorageLevel.MEMORY_AND_DISK());" + NL + "        this.list = list;" + NL + "        this.repetitionInterval = repetitionInterval < 1 ? 1 : repetitionInterval;" + NL + "    }" + NL + "" + NL + "    @Override" + NL + "    public void onStart() {" + NL + "        new Thread()  {" + NL + "              @Override" + NL + "              public void run() {" + NL + "                try {" + NL + "                    receive();" + NL + "                } catch (InterruptedException e) {" + NL + "                    e.printStackTrace();" + NL + "                }" + NL + "              }" + NL + "            }.start();" + NL + "    }" + NL + "" + NL + "    @Override" + NL + "    public void onStop() {" + NL + "    }" + NL + "" + NL + "    private void receive() throws InterruptedException{" + NL + "        while(true){" + NL + "            Thread.sleep(repetitionInterval);" + NL + "            storeRecords(list);" + NL + "        }" + NL + "    }" + NL + "" + NL + "    private void storeRecords(java.util.List<";
  protected final String TEXT_209 = "> list){" + NL + "        java.util.Iterator<";
  protected final String TEXT_210 = "> iterator = list.iterator();" + NL + "        while(iterator.hasNext()){" + NL + "            store(iterator.next());" + NL + "        }" + NL + "    }" + NL + "" + NL + "}";
  protected final String TEXT_211 = NL + "public static class ";
  protected final String TEXT_212 = "_mapToPair implements org.apache.spark.api.java.function.PairFunction<";
  protected final String TEXT_213 = ", NullWritable, ";
  protected final String TEXT_214 = "> {" + NL + "" + NL + "    private ContextProperties context = null;" + NL + "" + NL + "    public ";
  protected final String TEXT_215 = "_mapToPair(JobConf job) {" + NL + "                this.context = new ContextProperties(job);" + NL + "            }" + NL + "" + NL + "    public scala.Tuple2<NullWritable, ";
  protected final String TEXT_216 = "> call(";
  protected final String TEXT_217 = " data){" + NL + "        return new scala.Tuple2<NullWritable, ";
  protected final String TEXT_218 = ">(NullWritable.get(), data);" + NL + "    }" + NL + "}";
...
// Using a custom streaming receiver to simualte a configurable streaming source that uses the fixedFlowInput input
