...
public class TFixedFlowInputMrcodeJava
{
  protected static String nl;
  public static synchronized TFixedFlowInputMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFixedFlowInputMrcodeJava result = new TFixedFlowInputMrcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_193 = NL + NL + "public static class ";
  protected final String TEXT_194 = "_InputFormat implements InputFormat<NullWritable, ";
  protected final String TEXT_195 = ">, org.apache.hadoop.conf.Configurable {" + NL + "" + NL + "    private ContextProperties context;" + NL + "    private java.util.List<java.util.List<Object>> stuff;" + NL + "" + NL + "    //init" + NL + "    public void setConf(Configuration conf){" + NL + "        context = new ContextProperties(conf); ";
  protected final String TEXT_196 = NL + "    }" + NL + "" + NL + "    // never called" + NL + "    public Configuration getConf(){" + NL + "        return null;" + NL + "    }" + NL;
  protected final String TEXT_197 = NL + NL + "    public InputSplit[] getSplits(JobConf job, int numSplits) throws IOException {" + NL + "        NullInputSplit[] splits = new NullInputSplit[";
  protected final String TEXT_198 = "];" + NL + "        for (int i = 0; i < splits.length; i++)" + NL + "            splits[i] = new NullInputSplit();" + NL + "        return splits;" + NL + "    }" + NL + "" + NL + "" + NL + "    public RecordReader<NullWritable, ";
  protected final String TEXT_199 = "> getRecordReader(InputSplit split, JobConf jobConf," + NL + "              Reporter reporter) throws IOException {" + NL + "        return new RecordReader<NullWritable, ";
  protected final String TEXT_200 = ">() {" + NL + "            private int mCount = 0;" + NL + "" + NL + "            public boolean next(NullWritable key, ";
  protected final String TEXT_201 = " ";
  protected final String TEXT_202 = ") throws IOException {" + NL + "                if (mCount >= stuff.size())" + NL + "                    return false;";
  protected final String TEXT_203 = NL + "                mCount++;" + NL + "                return true;" + NL + "            }" + NL + "" + NL + "            public NullWritable createKey() {" + NL + "                return NullWritable.get();" + NL + "            }" + NL + "" + NL + "            public ";
  protected final String TEXT_204 = " createValue() {" + NL + "                return new ";
  protected final String TEXT_205 = "();" + NL + "            }" + NL + "" + NL + "            public long getPos() {" + NL + "                return 0;" + NL + "            }" + NL + "" + NL + "            public void close() {" + NL + "            }" + NL + "" + NL + "            public float getProgress() throws IOException {" + NL + "                if (mCount >= stuff.size())" + NL + "                    return 1.0f;" + NL + "                return 1.0f * mCount / stuff.size();" + NL + "            }" + NL + "        };" + NL + "    }" + NL + "" + NL + "    public static class NullInputSplit implements InputSplit, Writable {" + NL + "" + NL + "        public long getLength() throws IOException {" + NL + "            // Since the input split is fixed, there's no choices to be made based on the size." + NL + "            return 0;" + NL + "        }" + NL + "" + NL + "        public String[] getLocations() throws IOException {" + NL + "            // It looks like if the locations are empty, then any task can process the split." + NL + "            return new String[] {};" + NL + "        }" + NL + "" + NL + "        public void write(DataOutput out) throws IOException {" + NL + "            out.writeInt(0);" + NL + "        }" + NL + "" + NL + "        public void readFields(DataInput in) throws IOException {" + NL + "            int size = in.readInt();" + NL + "        }" + NL + "    }" + NL + "}";
...
String outStruct = connName + "Struct";
    ...
    stringBuffer.append(TEXT_195);
     tFixedFlowInputUtil.generateFixedDataMember("stuff"); 
    ...
    tFixedFlowInputUtil.generateCopyFromFixedToOut("stuff", connName, "mCount"); 
