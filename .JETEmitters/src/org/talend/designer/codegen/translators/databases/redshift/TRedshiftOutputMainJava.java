...
public class TRedshiftOutputMainJava {
  ...
  protected final String TEXT_384 = NL + "\t                StringBuilder extendInsertValueStmt_";
  protected final String TEXT_385 = " = new StringBuilder();" + NL + "\t                for(int i_";
  protected final String TEXT_386 = "=0;i_";
  protected final String TEXT_387 = " < ";
  protected final String TEXT_388 = ";i_";
  protected final String TEXT_389 = "++){";
  protected final String TEXT_390 = NL + "                \t\textendInsertValueStmt_";
  ...
  protected final String TEXT_395 = NL + "                \t\textendInsertValueStmt_";
  protected final String TEXT_396 = ".append(\"(\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_397 = ".";
  protected final String TEXT_398 = ")+\")\");";
  protected final String TEXT_399 = NL + "                \t\tif (i_";
  ...
  protected final String TEXT_422 = NL + "                \trowCount";
  protected final String TEXT_423 = " = 0;";
  protected final String TEXT_424 = NL + "\t\t\t\t\tString update_";
  protected final String TEXT_425 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_426 = " + \"\\\" SET ";
  protected final String TEXT_427 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_441 = ".prepareStatement(update_";
  ...
  protected final String TEXT_478 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_479 = " + \"\\\" WHERE ";
  protected final String TEXT_480 = "\");" + NL + "\t\t\t    pstmtInsert_";
  ...
  protected final String TEXT_523 = ");" + NL + "\t\t\t    pstmtInsert_";
  ...
  protected final String TEXT_544 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_545 = ".";
  protected final String TEXT_546 = ", pstmt_";
  protected final String TEXT_547 = ", ";
  protected final String TEXT_548 = ", \"";
  protected final String TEXT_549 = "\");";
  protected final String TEXT_550 = NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tinsertedCount_";
  protected final String TEXT_551 = " = insertedCount_";
  protected final String TEXT_552 = " + pstmt_";
  protected final String TEXT_553 = ".executeUpdate();" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_554 = "++;";
  protected final String TEXT_555 = NL + "\t\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\t\twhetherReject_";
  ...
  protected final String TEXT_568 = " + 1;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_569 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_578 = ".setNull(counter";
  protected final String TEXT_579 = ",java.sql.Types.CHAR);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_580 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_581 = ".";
  protected final String TEXT_582 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_583 = ".setNull(counter";
  protected final String TEXT_584 = ",java.sql.Types.DATE);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_585 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_586 = ".";
  protected final String TEXT_587 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_588 = ".setNull(counter";
  protected final String TEXT_589 = ",java.sql.Types.ARRAY);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_590 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_591 = ".";
  protected final String TEXT_592 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_593 = ".setNull(counter";
  protected final String TEXT_594 = ",java.sql.Types.INTEGER);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_595 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_596 = ".";
  protected final String TEXT_597 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_598 = ".setNull(counter";
  protected final String TEXT_599 = ",java.sql.Types.VARCHAR);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_600 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_601 = ".";
  protected final String TEXT_602 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_603 = ".setNull(counter";
  protected final String TEXT_604 = ",java.sql.Types.OTHER);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_605 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_606 = ".";
  protected final String TEXT_607 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_608 = ".setNull(counter";
  protected final String TEXT_609 = ",java.sql.Types.BOOLEAN);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_610 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_611 = ".";
  protected final String TEXT_612 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_613 = ".setNull(counter";
  protected final String TEXT_614 = ",java.sql.Types.DOUBLE);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_615 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_616 = ".";
  protected final String TEXT_617 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_618 = ".setNull(counter";
  protected final String TEXT_619 = ",java.sql.Types.FLOAT);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_620 = NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_621 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_622 = NL + "\t\t\t\t\t\t\t\tif(";
  protected final String TEXT_623 = ".";
  protected final String TEXT_624 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_625 = NL + "\t\t\t\t\t\t\t\tif((\"null\").equals(String.valueOf(";
  protected final String TEXT_626 = ".";
  protected final String TEXT_627 = ").toLowerCase())){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_628 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_629 = ".setNull(counter";
  protected final String TEXT_630 = ",java.sql.Types.CHAR);" + NL + "" + NL + "\t\t\t\t\t\t\t}else if(";
  protected final String TEXT_631 = ".";
  protected final String TEXT_632 = " == '\\0'){" + NL + "" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_633 = ".setString(counter";
  protected final String TEXT_634 = ",\"\");" + NL + "" + NL + "\t\t\t\t\t\t\t}else{" + NL + "" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_635 = ".setString(counter";
  protected final String TEXT_636 = ",String.valueOf(";
  protected final String TEXT_637 = ".";
  protected final String TEXT_638 = "));" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_639 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_640 = ".";
  protected final String TEXT_641 = "!=null){" + NL + "\t\t\t\t\t\t\t\t// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t\t\t\t\t\t\tdate_";
  protected final String TEXT_642 = " = ";
  protected final String TEXT_643 = ".";
  protected final String TEXT_644 = ".getTime();" + NL + "\t\t\t\t\t\t\t\tif (date_";
  protected final String TEXT_645 = " < year1_";
  protected final String TEXT_646 = " || date_";
  protected final String TEXT_647 = " >= year10000_";
  protected final String TEXT_648 = ") {" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_649 = ".setString(counter";
  protected final String TEXT_650 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_651 = ".setTimestamp(counter";
  protected final String TEXT_652 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_653 = "));" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}else{" + NL + "" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_654 = ".setNull(counter";
  protected final String TEXT_655 = ",java.sql.Types.DATE);" + NL + "" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_656 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_657 = ".set";
  protected final String TEXT_658 = "(counter";
  protected final String TEXT_659 = ",";
  protected final String TEXT_660 = ".";
  protected final String TEXT_661 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_662 = NL + NL + "\t\t\t\t\t\t\t}" + NL + "" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_663 = NL + "\t\t\t\tint counter";
  protected final String TEXT_664 = " = rowCount";
  protected final String TEXT_665 = " * " + NL + "\t\t\t\t\t(";
  protected final String TEXT_666 = NL + "\t\t\t\t\t\t+ ";
  protected final String TEXT_667 = ".";
  protected final String TEXT_668 = ".getColumnCount()";
  protected final String TEXT_669 = " " + NL + "\t\t\t\t\t)" + NL + "\t\t\t\t+ 1;";
  protected final String TEXT_670 = NL + "\t\t\t\t\t\tcounter";
  ...
  protected final String TEXT_675 = ", counter";
  protected final String TEXT_676 = "-1, \"";
  protected final String TEXT_677 = "\");";
  protected final String TEXT_678 = NL + "\t\t\t\texInsertColValue";
  protected final String TEXT_679 = " = new BufferLine_";
  ...
  protected final String TEXT_688 = ".clone()" + NL + "\t                \t";
  protected final String TEXT_689 = NL + "\t\t\t\t);" + NL + "" + NL + "\t\t\t\texInsertColValueList";
  protected final String TEXT_690 = ".add(exInsertColValue";
  protected final String TEXT_691 = ");" + NL + "\t\t\t\trowCount";
  protected final String TEXT_692 = "++;" + NL + "\t\t\t\t" + NL + "                nb_line_";
  protected final String TEXT_693 = "++;" + NL + "                " + NL + "\t\t\t\tif(rowCount";
  protected final String TEXT_694 = " == ";
  protected final String TEXT_695 = "){" + NL + "\t                insertedCount_";
  protected final String TEXT_696 = " = insertedCount_";
  protected final String TEXT_697 = " + pstmt_";
  protected final String TEXT_698 = ".executeUpdate();" + NL + "\t                exInsertColValueList";
  protected final String TEXT_699 = ".clear();" + NL + "\t                rowCount";
  protected final String TEXT_700 = " = 0;" + NL + "\t\t\t\t\tcounter";
  protected final String TEXT_701 = "=1;" + NL + "\t\t\t\t}";
  protected final String TEXT_702 = NL + "                    ";
  protected final String TEXT_703 = NL + "                    int count_";
  protected final String TEXT_704 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_715 = NL + "                       pstmt_";
  protected final String TEXT_716 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_717 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_718 = "++;";
  protected final String TEXT_719 = NL + "                           try {" + NL + "                               updatedCount_";
  protected final String TEXT_720 = " = updatedCount_";
  protected final String TEXT_721 = " + pstmt_";
  protected final String TEXT_722 = ".executeUpdate();" + NL + "                               nb_line_";
  protected final String TEXT_723 = "++;";
  protected final String TEXT_724 = NL + "                           } catch(java.lang.Exception e) {" + NL + "                               whetherReject_";
  protected final String TEXT_725 = " = true;";
  protected final String TEXT_726 = NL + "                                   throw(e);";
  ...
  protected final String TEXT_739 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_740 = NL + "                                       ";
  protected final String TEXT_741 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_742 = ";";
  protected final String TEXT_743 = NL + "                                       System.err.print(e.getMessage());";
  ...
  protected final String TEXT_749 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_750 = " = pstmt_";
  protected final String TEXT_751 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_752 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_753 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_754 = " = rs_";
  protected final String TEXT_755 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_770 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_771 = " = updatedCount_";
  protected final String TEXT_772 = " + pstmtUpdate_";
  protected final String TEXT_773 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_774 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_775 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_776 = " = true;";
  protected final String TEXT_777 = NL + "                        throw(e);";
  protected final String TEXT_778 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_792 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_797 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_798 = NL + "                        ";
  protected final String TEXT_799 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_800 = ".";
  protected final String TEXT_801 = ", pstmtInsert_";
  ...
  protected final String TEXT_810 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_831 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_836 = NL + "                    int count_";
  ...
  protected final String TEXT_849 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_850 = "=pstmtUpdate_";
  protected final String TEXT_851 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_852 = " = updatedCount_";
  protected final String TEXT_853 = "+updateFlag_";
  protected final String TEXT_854 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_855 = " == 0) {";
  protected final String TEXT_856 = NL + "                        ";
  protected final String TEXT_857 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_858 = ".";
  protected final String TEXT_859 = ", pstmtInsert_";
  protected final String TEXT_860 = ", ";
  protected final String TEXT_861 = ", \"";
  protected final String TEXT_862 = "\");";
  protected final String TEXT_863 = NL + "                    insertedCount_";
  protected final String TEXT_864 = " = insertedCount_";
  protected final String TEXT_865 = " + pstmtInsert_";
  protected final String TEXT_866 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_867 = "++;";
  protected final String TEXT_868 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_869 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_870 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_871 = " = true;";
  protected final String TEXT_872 = NL + "                        throw(e);";
  protected final String TEXT_873 = NL + "                    \tnb_line_";
  protected final String TEXT_874 = "++;" + NL + "                    \t";
  protected final String TEXT_875 = NL + "                            ";
  protected final String TEXT_876 = " = new ";
  protected final String TEXT_877 = "Struct();";
  protected final String TEXT_878 = NL + "                                ";
  protected final String TEXT_879 = ".";
  protected final String TEXT_880 = " = ";
  protected final String TEXT_881 = ".";
  protected final String TEXT_882 = ";";
  protected final String TEXT_883 = NL + "                            rejectedCount_";
  protected final String TEXT_884 = " = rejectedCount_";
  protected final String TEXT_885 = " + 1;";
  protected final String TEXT_886 = NL + "                            ";
  protected final String TEXT_887 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_888 = NL + "                            ";
  protected final String TEXT_889 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_890 = ";";
  protected final String TEXT_891 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_900 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_901 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_902 = "++;";
  protected final String TEXT_903 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_904 = " = deletedCount_";
  protected final String TEXT_905 = " + pstmt_";
  protected final String TEXT_906 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_907 = "++;";
  protected final String TEXT_908 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  ...
  protected final String TEXT_925 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_926 = NL + "                                   ";
  protected final String TEXT_927 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_928 = ";";
  protected final String TEXT_929 = NL + "                                   System.err.print(e.getMessage());";
  protected final String TEXT_930 = NL + "                       }";
  protected final String TEXT_931 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_942 = NL + "                if ((batchSize_";
  protected final String TEXT_943 = " > 0) && (batchSize_";
  protected final String TEXT_944 = " <= batchSizeCounter_";
  protected final String TEXT_945 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_946 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_947 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_948 = " = 0;";
  protected final String TEXT_949 = NL + "                        status_";
  protected final String TEXT_950 = " = pstmt_";
  protected final String TEXT_951 = ".executeBatch();";
  protected final String TEXT_952 = NL + "                        for(int countEach_";
  protected final String TEXT_953 = ": status_";
  protected final String TEXT_954 = ") {" + NL + "                            countSum_";
  protected final String TEXT_955 = " += (countEach_";
  protected final String TEXT_956 = " < 0 ? 0 : countEach_";
  protected final String TEXT_957 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_958 = NL + "                            throw(e);";
  protected final String TEXT_959 = NL + "                        for(int countEach_";
  protected final String TEXT_960 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_964 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_965 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_966 = " = pstmt_";
  protected final String TEXT_967 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_968 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_969 = " = tmp_batchUpdateCount_";
  protected final String TEXT_970 = " > countSum_";
  protected final String TEXT_971 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_972 = " : countSum_";
  protected final String TEXT_973 = ";";
  protected final String TEXT_974 = NL + "                        insertedCount_";
  protected final String TEXT_975 = " += tmp_batchUpdateCount_";
  protected final String TEXT_976 = ";";
  protected final String TEXT_977 = NL + "                        updatedCount_";
  protected final String TEXT_978 = " += tmp_batchUpdateCount_";
  protected final String TEXT_979 = ";";
  protected final String TEXT_980 = NL + "                        deletedCount_";
  protected final String TEXT_981 = " += tmp_batchUpdateCount_";
  protected final String TEXT_982 = ";";
  protected final String TEXT_983 = NL + "               }";
  protected final String TEXT_984 = NL + "                commitCounter_";
  protected final String TEXT_985 = "++;" + NL + "" + NL + "                if(commitEvery_";
  ...
  protected final String TEXT_989 = " > 0){";
  protected final String TEXT_990 = NL + "                                      conn_";
  protected final String TEXT_991 = ".commit();";
  protected final String TEXT_992 = NL + "                                      commitCounter_";
  protected final String TEXT_993 = "=0;" + NL + "                                }";
  protected final String TEXT_994 = NL + "                                   conn_";
  protected final String TEXT_995 = ".commit();";
