...
public class TTeradataOutputBeginJava {
  ...
  protected final String TEXT_396 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_397 = " = conn_";
  protected final String TEXT_398 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_399 = " = dbMetaData_";
  protected final String TEXT_400 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_401 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_402 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_403 = " = rsTable_";
  protected final String TEXT_404 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_405 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_409 = NL + "                                if(!whetherExist_";
  protected final String TEXT_410 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_431 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_442 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_450 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_460 = NL + "                                stmtCreate_";
  protected final String TEXT_461 = ".close();";
  protected final String TEXT_462 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_463 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_464 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_468 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_478 = NL + "                              stmtTruncCount_";
  protected final String TEXT_479 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_480 = "));";
  protected final String TEXT_481 = NL + "            java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_485 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_486 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_490 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_515 = ".createStatement();";
  protected final String TEXT_516 = NL + "                conn_";
  protected final String TEXT_517 = ".commit();";
  protected final String TEXT_518 = NL + "            stmtTrunc_";
  protected final String TEXT_519 = ".executeUpdate(\"";
  protected final String TEXT_520 = "\");";
  protected final String TEXT_521 = NL + "            while(rsTruncCount_";
  protected final String TEXT_522 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_523 = " += rsTruncCount_";
  protected final String TEXT_524 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_525 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_526 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_527 = ".close();";
  ...
  protected final String TEXT_542 = ".prepareStatement(update_";
  ...
  protected final String TEXT_546 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_547 = " + \"\\\" WHERE ";
  protected final String TEXT_548 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_549 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_550 = " + \"\\\" (";
  protected final String TEXT_551 = ") VALUES (";
  protected final String TEXT_552 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_559 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_571 = " = \"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_583 = ".prepareStatement(delete_";
  protected final String TEXT_584 = ");" + NL + "\t    ";
  protected final String TEXT_585 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_590 = NL + "\t\t\tupdate_";
  protected final String TEXT_591 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_592 = " = update_";
  ...
  protected final String TEXT_596 = " = update_";
  protected final String TEXT_597 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_598 = " = insert_";
  protected final String TEXT_599 = ".split(\"\\\\?\");";
  protected final String TEXT_600 = NL + "\t\t\tdelete_";
  protected final String TEXT_601 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_602 = " = delete_";
  protected final String TEXT_603 = ".split(\"\\\\?\");";
  protected final String TEXT_604 = NL + "\t\t\treplace_";
  protected final String TEXT_605 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_606 = " = replace_";
  protected final String TEXT_607 = ".split(\"\\\\?\");";
  protected final String TEXT_608 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_609 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_610 = " = insertIgnore_";
  ...
  protected final String TEXT_615 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_616 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_617 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_618 = " =null;" + NL + "\t";
  protected final String TEXT_619 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_623 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_624 = " =  null;";
  protected final String TEXT_625 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_626 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_627 = " = null;";
  protected final String TEXT_628 = NL + "\t\t   \tString[] deleteSQLSplits_";
  ...
  protected final String TEXT_632 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
