...
public class TOracleInvalidRowsEndJava
{
  protected static String nl;
  public static synchronized TOracleInvalidRowsEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleInvalidRowsEndJava result = new TOracleInvalidRowsEndJava();
    nl = null;
    return result;
  }
