...
public class TInformixOutputMainJava {
  ...
  protected final String TEXT_438 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_497 = ".prepareStatement(delete_";
  protected final String TEXT_498 = ");" + NL + "\t    ";
  protected final String TEXT_499 = NL + "       \t";
  protected final String TEXT_500 = NL + "\t\t \tinsertSQLSplits_";
  ...
  protected final String TEXT_522 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_523 = " = insertIgnore_";
  protected final String TEXT_524 = ".split(\"\\\\?\");";
  protected final String TEXT_525 = NL + "\t\t \tinsertSQLSplits_";
  ...
  protected final String TEXT_542 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_543 = ",";
  protected final String TEXT_544 = ".";
  protected final String TEXT_545 = ", ";
  protected final String TEXT_546 = ",insertSQLSplits_";
  ...
  protected final String TEXT_559 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_560 = "++;" + NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_561 = "++;";
  protected final String TEXT_562 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_563 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_564 = " = insertedCount_";
  protected final String TEXT_565 = " + pstmt_";
  protected final String TEXT_566 = ".executeUpdate();";
  protected final String TEXT_567 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_568 = " = true;";
  protected final String TEXT_569 = NL + "                    throw(e);";
  protected final String TEXT_570 = NL + "                        ";
  protected final String TEXT_571 = " = new ";
  protected final String TEXT_572 = "Struct();";
  protected final String TEXT_573 = NL + "                            ";
  protected final String TEXT_574 = ".";
  protected final String TEXT_575 = " = ";
  protected final String TEXT_576 = ".";
  protected final String TEXT_577 = ";";
  protected final String TEXT_578 = NL + "                        rejectedCount_";
  protected final String TEXT_579 = " = rejectedCount_";
  protected final String TEXT_580 = " + 1;";
  protected final String TEXT_581 = NL + "                        ";
  protected final String TEXT_582 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_596 = ",updateSQLSplits_";
  protected final String TEXT_597 = ");";
  protected final String TEXT_598 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_599 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_600 = ".";
  protected final String TEXT_601 = ", pstmt_";
  ...
  protected final String TEXT_624 = "_QUERY\", query_";
  protected final String TEXT_625 = ".toString().trim());";
  protected final String TEXT_626 = NL;
  protected final String TEXT_627 = NL + "    \t\tpstmt_";
  protected final String TEXT_628 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_629 = "++;" + NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_630 = "++;";
  protected final String TEXT_631 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_632 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_633 = " = updatedCount_";
  protected final String TEXT_634 = " + pstmt_";
  protected final String TEXT_635 = ".executeUpdate();" + NL + "        \t    ";
  protected final String TEXT_636 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_637 = " = true;";
  protected final String TEXT_638 = NL + "                    throw(e);";
  protected final String TEXT_639 = NL + "                        ";
  protected final String TEXT_640 = " = new ";
  protected final String TEXT_641 = "Struct();";
  ...
  protected final String TEXT_660 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_661 = " = pstmt_";
  protected final String TEXT_662 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_663 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_664 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_665 = " = rs_";
  protected final String TEXT_666 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_667 = " > 0) {";
  protected final String TEXT_668 = NL + "                        ";
  protected final String TEXT_669 = NL + "                            query_";
  protected final String TEXT_670 = " = ";
  protected final String TEXT_671 = ";";
  protected final String TEXT_672 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_673 = ",";
  protected final String TEXT_674 = ".";
  protected final String TEXT_675 = ", ";
  protected final String TEXT_676 = ",updateSQLSplits_";
  protected final String TEXT_677 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_678 = NL + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_679 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_680 = ".";
  protected final String TEXT_681 = ", pstmtUpdate_";
  ...
  protected final String TEXT_689 = NL + "\t\t\t\t\t\t\t\tquery_";
  ...
  protected final String TEXT_702 = NL + "                    globalMap.put(\"";
  protected final String TEXT_703 = "_QUERY\", query_";
  protected final String TEXT_704 = ".toString().trim());";
  protected final String TEXT_705 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_706 = " = updatedCount_";
  protected final String TEXT_707 = " + pstmtUpdate_";
  protected final String TEXT_708 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_709 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_710 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_711 = " = true;";
  protected final String TEXT_712 = NL + "                        throw(e);";
  ...
  protected final String TEXT_757 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_781 = "=0;";
  ...
  protected final String TEXT_820 = NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_821 = "=pstmtUpdate_";
  protected final String TEXT_822 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_823 = " = updatedCount_";
  protected final String TEXT_824 = " + updateFlag_";
  protected final String TEXT_825 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_826 = " == 0) {" + NL + "            \t";
  protected final String TEXT_827 = NL + "\t\t\t\tquery_";
  protected final String TEXT_828 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_829 = NL + "                        ";
  protected final String TEXT_830 = NL + "                            query_";
  protected final String TEXT_831 = " = ";
  protected final String TEXT_832 = ";";
  protected final String TEXT_833 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_834 = ",";
  protected final String TEXT_835 = ".";
  protected final String TEXT_836 = ", ";
  protected final String TEXT_837 = ",insertSQLSplits_";
  protected final String TEXT_838 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_839 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_840 = ".";
  protected final String TEXT_841 = ", pstmtInsert_";
  ...
  protected final String TEXT_848 = NL + "                    insertedCount_";
  ...
  protected final String TEXT_853 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_854 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_855 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_856 = " = true;";
  protected final String TEXT_857 = NL + "                        throw(e);";
  protected final String TEXT_858 = NL + "                    \tnb_line_";
  protected final String TEXT_859 = "++;" + NL + "                    \t";
  protected final String TEXT_860 = NL + "                            ";
  protected final String TEXT_861 = " = new ";
  protected final String TEXT_862 = "Struct();";
  protected final String TEXT_863 = NL + "                                ";
  protected final String TEXT_864 = ".";
  protected final String TEXT_865 = " = ";
  protected final String TEXT_866 = ".";
  protected final String TEXT_867 = ";";
  protected final String TEXT_868 = NL + "                            rejectedCount_";
  protected final String TEXT_869 = " = rejectedCount_";
  protected final String TEXT_870 = " + 1;";
  protected final String TEXT_871 = NL + "                            ";
  protected final String TEXT_872 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_873 = NL + "                            ";
  protected final String TEXT_874 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_875 = ";";
  protected final String TEXT_876 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_887 = NL + "                globalMap.put(\"";
  protected final String TEXT_888 = "_QUERY\", query_";
  protected final String TEXT_889 = ".toString().trim());";
  protected final String TEXT_890 = NL;
  protected final String TEXT_891 = NL + "\t\t    \t\tpstmt_";
  protected final String TEXT_892 = ".addBatch();" + NL + "\t\t    \t\tbatchSizeCounter_";
  protected final String TEXT_893 = "++;" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_894 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_895 = NL + "            try {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_900 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_901 = " = true;";
  protected final String TEXT_902 = NL + "                    throw(e);";
  protected final String TEXT_903 = NL + "                \tnb_line_";
  protected final String TEXT_904 = "++;" + NL + "                \t";
  protected final String TEXT_905 = NL + "                        ";
  protected final String TEXT_906 = " = new ";
  protected final String TEXT_907 = "Struct();";
  protected final String TEXT_908 = NL + "                            ";
  protected final String TEXT_909 = ".";
  protected final String TEXT_910 = " = ";
  protected final String TEXT_911 = ".";
  protected final String TEXT_912 = ";";
  protected final String TEXT_913 = NL + "                        rejectedCount_";
  protected final String TEXT_914 = " = rejectedCount_";
  protected final String TEXT_915 = " + 1;";
  protected final String TEXT_916 = NL + "                        ";
  protected final String TEXT_917 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_918 = NL + "                        ";
  protected final String TEXT_919 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_920 = ";";
  protected final String TEXT_921 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_922 = NL + "            }" + NL + "\t\t";
  protected final String TEXT_923 = NL + "            if(!whetherReject_";
  protected final String TEXT_924 = ") {";
  protected final String TEXT_925 = NL + "                            ";
  protected final String TEXT_926 = " = new ";
  protected final String TEXT_927 = "Struct();";
  ...
  protected final String TEXT_934 = NL + "\t\t\t\tif ((batchSize_";
  protected final String TEXT_935 = " > 0) && (batchSize_";
  protected final String TEXT_936 = " <= batchSizeCounter_";
  protected final String TEXT_937 = ")) {" + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_938 = " = 0;" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_939 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_940 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_941 = ": pstmt_";
  protected final String TEXT_942 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_943 = " += (countEach_";
  protected final String TEXT_944 = " < 0 ? 0 : countEach_";
  protected final String TEXT_945 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_946 = NL + "            \t    \t";
  protected final String TEXT_947 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_948 = " += countSum_";
  protected final String TEXT_949 = ";" + NL + "            \t    \t";
  protected final String TEXT_950 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_951 = " += countSum_";
  protected final String TEXT_952 = ";" + NL + "            \t    \t";
  protected final String TEXT_953 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_954 = " += countSum_";
  protected final String TEXT_955 = ";" + NL + "            \t    \t";
  protected final String TEXT_956 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_957 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_958 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_959 = NL + "                \t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_960 = NL + "            commitCounter_";
  protected final String TEXT_961 = "++;" + NL + "" + NL + "            if(commitEvery_";
  protected final String TEXT_962 = "<=commitCounter_";
  protected final String TEXT_963 = ") {" + NL + "            \t";
  protected final String TEXT_964 = NL + "                conn_";
  protected final String TEXT_965 = ".commit();";
  protected final String TEXT_966 = NL + "                commitCounter_";
  protected final String TEXT_967 = " = 0;" + NL + "" + NL + "            }" + NL;
