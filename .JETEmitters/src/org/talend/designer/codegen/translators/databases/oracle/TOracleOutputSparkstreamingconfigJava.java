...
public class TOracleOutputSparkstreamingconfigJava {
  protected static String nl;
  public static synchronized TOracleOutputSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleOutputSparkstreamingconfigJava result = new TOracleOutputSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_46 = " = 0;" + NL + "String dbschema_";
  protected final String TEXT_47 = " = ";
  protected final String TEXT_48 = ";" + NL + "String tableName_";
  protected final String TEXT_49 = " = ";
  protected final String TEXT_50 = ";" + NL + "Class.forName(";
  protected final String TEXT_51 = ");" + NL + "java.sql.Connection conn_";
  protected final String TEXT_52 = " = java.sql.DriverManager.getConnection(";
  ...
  protected final String TEXT_253 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_270 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_274 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_281 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_301 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_302 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  ...
  protected final String TEXT_317 = NL + "                              stmtTruncCount_";
  protected final String TEXT_318 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_319 = "));";
  protected final String TEXT_320 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_321 = " = stmtTruncCount_";
  protected final String TEXT_322 = ".executeQuery(\"";
  protected final String TEXT_323 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_324 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_325 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_329 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_336 = ".commit();";
  ...
  protected final String TEXT_345 = ";" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_349 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_350 = " = stmtTruncCount_";
  protected final String TEXT_351 = ".executeQuery(\"";
  ...
  protected final String TEXT_356 = ".commit();";
  protected final String TEXT_357 = NL + "            stmtTrunc_";
  protected final String TEXT_358 = ".executeUpdate(\"";
  protected final String TEXT_359 = "\");";
  protected final String TEXT_360 = NL + "            while(rsTruncCount_";
  protected final String TEXT_361 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_362 = " += rsTruncCount_";
  protected final String TEXT_363 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_364 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_365 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_366 = ".close();";
  protected final String TEXT_367 = NL + NL + "conn_";
  protected final String TEXT_368 = ".close();" + NL;
  protected final String TEXT_369 = NL + "rdd_";
  protected final String TEXT_370 = ".foreachRDD(new org.apache.spark.api.java.function.Function<org.apache.spark.api.java.JavaRDD<";
  protected final String TEXT_371 = ">, Void>() {" + NL + "\t@Override" + NL + "    public Void call(org.apache.spark.api.java.JavaRDD<";
  protected final String TEXT_372 = "> current_rdd) throws Exception {" + NL + "    \tcurrent_rdd.foreachPartition(new ";
  protected final String TEXT_373 = "_OutputFunction(job));" + NL + "        return null;" + NL + "\t}" + NL + "});";
