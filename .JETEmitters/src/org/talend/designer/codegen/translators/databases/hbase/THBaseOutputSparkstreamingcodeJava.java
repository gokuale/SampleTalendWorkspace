...
public class THBaseOutputSparkstreamingcodeJava
{
  ...
  protected final String TEXT_27 = "> getRecordWriter(" + NL + "\t\t\t\t\t\tFileSystem ignored, JobConf job, String name, Progressable progress) throws IOException{" + NL + "\t\t\t\t\tcontext = new ContextProperties(job);" + NL + "\t\t\t\t\tJobConf hbaseJob = new JobConf(job);" + NL + "\t\t\t\t\thbaseJob.set(\"hbase.zookeeper.quorum\", ";
  ...
  protected final String TEXT_36 = ");" + NL + "\t\t\t\t\thTable.setAutoFlush(false);" + NL + "\t\t\t\t\treturn new HBaseTableRecordWriter(hTable, job);" + NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t\t\t\tpublic void checkOutputSpecs(FileSystem ignored, JobConf job)" + NL + "\t\t\t\t  throws FileAlreadyExistsException, InvalidJobConfException, IOException {" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tpublic static class ";
  protected final String TEXT_37 = "_ForeachRDD implements org.apache.spark.api.java.function.Function<org.apache.spark.api.java.JavaPairRDD<NullWritable, ";
  protected final String TEXT_38 = ">, Void>{" + NL + "" + NL + "\t\t\t\tprivate JobConf job;" + NL + "" + NL + "\t\t\t\tpublic ";
  protected final String TEXT_39 = "_ForeachRDD(JobConf job){" + NL + "\t\t\t\t\tthis.job = job;" + NL + "\t\t\t\t}" + NL + "" + NL + "\t\t\t\tpublic Void call(org.apache.spark.api.java.JavaPairRDD<NullWritable, ";
  protected final String TEXT_40 = "> rdd) throws Exception {" + NL + "\t\t\t\t\trdd.saveAsHadoopDataset(job);" + NL + "\t\t\t\t\treturn null;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t";
