...
public class TMySQLInvalidRowsEndJava
{
  protected static String nl;
  public static synchronized TMySQLInvalidRowsEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMySQLInvalidRowsEndJava result = new TMySQLInvalidRowsEndJava();
    nl = null;
    return result;
  }
