...
public class TPostgresqlInvalidRowsBeginJava
{
  protected static String nl;
  public static synchronized TPostgresqlInvalidRowsBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresqlInvalidRowsBeginJava result = new TPostgresqlInvalidRowsBeginJava();
    nl = null;
    return result;
  }
