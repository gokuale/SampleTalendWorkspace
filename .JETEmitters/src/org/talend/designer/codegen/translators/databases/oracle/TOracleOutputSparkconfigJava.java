...
public class TOracleOutputSparkconfigJava {
  protected static String nl;
  public static synchronized TOracleOutputSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleOutputSparkconfigJava result = new TOracleOutputSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_368 = ".close();" + NL + "" + NL + "rdd_";
  protected final String TEXT_369 = ".foreachPartition(new ";
  protected final String TEXT_370 = "_OutputFunction(job));";
