...
public class TSybaseOutputMainJava {
  ...
  protected final String TEXT_522 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_523 = " = conn_";
  protected final String TEXT_524 = ".createStatement();" + NL + "        stmt_";
  protected final String TEXT_525 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_526 = " +\" ON\");";
  protected final String TEXT_527 = NL + "        }";
  protected final String TEXT_528 = NL + "                commitEvery_";
  protected final String TEXT_529 = " = buffersSize_";
  protected final String TEXT_530 = ";";
  protected final String TEXT_531 = NL + "                batchSize_";
  protected final String TEXT_532 = " = buffersSize_";
  protected final String TEXT_533 = ";";
  protected final String TEXT_534 = NL + "        whetherReject_";
  protected final String TEXT_535 = " = false;";
  protected final String TEXT_536 = NL + "                    ";
  protected final String TEXT_537 = NL + "                        query_";
  protected final String TEXT_538 = " = ";
  protected final String TEXT_539 = ";";
  protected final String TEXT_540 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_541 = ",";
  protected final String TEXT_542 = ".";
  protected final String TEXT_543 = ", ";
  protected final String TEXT_544 = ",insertSQLSplits_";
  protected final String TEXT_545 = ");";
  protected final String TEXT_546 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_553 = "_QUERY\", query_";
  protected final String TEXT_554 = ".toString().trim());";
  protected final String TEXT_555 = NL + "                pstmt_";
  protected final String TEXT_556 = ".addBatch();" + NL + "                nb_line_";
  protected final String TEXT_557 = "++;";
  protected final String TEXT_558 = NL + "              batchSizeCounter_";
  protected final String TEXT_559 = "++;";
  protected final String TEXT_560 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_561 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_562 = " = insertedCount_";
  protected final String TEXT_563 = " + pstmt_";
  protected final String TEXT_564 = ".executeUpdate();";
  protected final String TEXT_565 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_580 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_581 = NL + "                        ";
  protected final String TEXT_582 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_583 = ";";
  protected final String TEXT_584 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_590 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_591 = ",";
  protected final String TEXT_592 = ".";
  protected final String TEXT_593 = ", ";
  protected final String TEXT_594 = ",updateSQLSplits_";
  protected final String TEXT_595 = ");";
  protected final String TEXT_596 = NL + "                    int count_";
  ...
  protected final String TEXT_622 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_623 = "++;";
  protected final String TEXT_624 = NL + "              batchSizeCounter_";
  protected final String TEXT_625 = "++;";
  protected final String TEXT_626 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_627 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_628 = " = updatedCount_";
  protected final String TEXT_629 = " + pstmt_";
  protected final String TEXT_630 = ".executeUpdate();";
  protected final String TEXT_631 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_632 = " = true;";
  protected final String TEXT_633 = NL + "                    throw(e);";
  ...
  protected final String TEXT_646 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_647 = NL + "                        ";
  protected final String TEXT_648 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_649 = ";";
  protected final String TEXT_650 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_697 = NL + "                try {" + NL + "                    updatedCount_";
  ...
  protected final String TEXT_702 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_703 = " = true;";
  protected final String TEXT_704 = NL + "                        throw(e);";
  protected final String TEXT_705 = NL + "                        nb_line_";
  ...
  protected final String TEXT_719 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_724 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_733 = ",insertSQLSplits_";
  protected final String TEXT_734 = ");";
  protected final String TEXT_735 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_736 = ".";
  protected final String TEXT_737 = ", pstmtInsert_";
  protected final String TEXT_738 = ", ";
  protected final String TEXT_739 = ", \"";
  protected final String TEXT_740 = "\");";
  protected final String TEXT_741 = NL + "                    globalMap.put(\"";
  protected final String TEXT_742 = "_QUERY\", query_";
  protected final String TEXT_743 = ".toString().trim());";
  protected final String TEXT_744 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_745 = " = insertedCount_";
  protected final String TEXT_746 = " + pstmtInsert_";
  protected final String TEXT_747 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_748 = "++;";
  protected final String TEXT_749 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_750 = " = true;";
  protected final String TEXT_751 = NL + "                        throw(e);";
  protected final String TEXT_752 = NL + "                        nb_line_";
  ...
  protected final String TEXT_844 = NL + "                }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_845 = " = true;";
  protected final String TEXT_846 = NL + "                        throw(e);";
  protected final String TEXT_847 = NL + "                        nb_line_";
  ...
  protected final String TEXT_865 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_879 = ".addBatch();" + NL + "                    nb_line_";
  protected final String TEXT_880 = "++;";
  protected final String TEXT_881 = NL + "                    batchSizeCounter_";
  protected final String TEXT_882 = "++;";
  protected final String TEXT_883 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_884 = " = deletedCount_";
  protected final String TEXT_885 = " + pstmt_";
  protected final String TEXT_886 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_887 = "++;";
  protected final String TEXT_888 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_909 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_910 = NL + "            }";
  protected final String TEXT_911 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_922 = NL + "                if ((batchSize_";
  protected final String TEXT_923 = " > 0) && (batchSize_";
  protected final String TEXT_924 = " <= batchSizeCounter_";
  protected final String TEXT_925 = ")) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_926 = " = 0;" + NL + "                        int countSum_";
  protected final String TEXT_927 = " = 0;";
  protected final String TEXT_928 = NL + "                        for(int countEach_";
  protected final String TEXT_929 = ": pstmt_";
  protected final String TEXT_930 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_931 = " += (countEach_";
  protected final String TEXT_932 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_943 = NL + "                batchSizeCounter_";
  protected final String TEXT_944 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_945 = NL + "                        throw(e);";
  protected final String TEXT_946 = NL + "                    int countSum_";
  protected final String TEXT_947 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_948 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_949 = " += (countEach_";
  protected final String TEXT_950 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_955 = NL + "                        updatedCount_";
  protected final String TEXT_956 = " += countSum_";
  protected final String TEXT_957 = ";";
  protected final String TEXT_958 = NL + "                        deletedCount_";
  ...
  protected final String TEXT_963 = NL + "                commitCounter_";
  protected final String TEXT_964 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_965 = " <= commitCounter_";
  protected final String TEXT_966 = ") {";
  protected final String TEXT_967 = NL + "                try {" + NL + "                        if ( batchSizeCounter_";
  protected final String TEXT_968 = " > 0 ) {" + NL + "                        int countSum_";
  protected final String TEXT_969 = " = 0;";
  protected final String TEXT_970 = NL + "                        for(int countEach_";
  protected final String TEXT_971 = ": pstmt_";
  protected final String TEXT_972 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_973 = " += (countEach_";
  protected final String TEXT_974 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_979 = NL + "                            updatedCount_";
  protected final String TEXT_980 = " += countSum_";
  protected final String TEXT_981 = ";";
  protected final String TEXT_982 = NL + "                            deletedCount_";
  protected final String TEXT_983 = " += countSum_";
  protected final String TEXT_984 = ";";
  protected final String TEXT_985 = NL + "                        batchSizeCounter_";
  protected final String TEXT_986 = " = 0;" + NL + "                        }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_987 = NL + "                        throw(e);";
  protected final String TEXT_988 = NL + "                        int countSum_";
  protected final String TEXT_989 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_990 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_1003 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_1004 = NL + "                }";
  protected final String TEXT_1005 = NL + "                    conn_";
  protected final String TEXT_1006 = ".commit();";
  protected final String TEXT_1007 = NL + "                    commitCounter_";
