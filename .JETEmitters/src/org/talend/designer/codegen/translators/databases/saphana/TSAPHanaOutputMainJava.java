...
public class TSAPHanaOutputMainJava {
  ...
  protected final String TEXT_239 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  ...
  protected final String TEXT_245 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_249 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_257 = ".toUpperCase()";
  ...
  protected final String TEXT_266 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_272 = NL + "                                    stmtDrop_";
  ...
  protected final String TEXT_281 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_296 = ".close();";
  protected final String TEXT_297 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_298 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_299 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_300 = " = conn_";
  protected final String TEXT_301 = ".createStatement();";
  protected final String TEXT_302 = NL + "                              stmtClear_";
  protected final String TEXT_303 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_314 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_315 = "));";
  protected final String TEXT_316 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_317 = " = stmtTruncCount_";
  protected final String TEXT_318 = ".executeQuery(\"";
  protected final String TEXT_319 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_320 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_321 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_322 = " = rsTruncCount_";
  protected final String TEXT_323 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_324 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_325 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_326 = " = conn_";
  protected final String TEXT_327 = ".createStatement();";
  protected final String TEXT_328 = NL + "                              stmtTrunc_";
  protected final String TEXT_329 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_330 = "));";
  protected final String TEXT_331 = NL + "                conn_";
  protected final String TEXT_332 = ".commit();";
  protected final String TEXT_333 = NL + "            stmtTrunc_";
  protected final String TEXT_334 = ".executeUpdate(\"";
  protected final String TEXT_335 = "\");";
  protected final String TEXT_336 = NL + "                if(!conn_";
  ...
  protected final String TEXT_340 = " += rsTruncCountNumber_";
  protected final String TEXT_341 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_342 = ".close();";
  protected final String TEXT_343 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_344 = " = conn_";
  protected final String TEXT_345 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_346 = " = stmtTruncCount_";
  protected final String TEXT_347 = ".executeQuery(\"";
  ...
  protected final String TEXT_356 = NL + "            while(rsTruncCount_";
  protected final String TEXT_357 = ".next()) {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_361 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_388 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_389 = ".";
  protected final String TEXT_390 = ", \"";
  protected final String TEXT_391 = "\")+\" WHERE ";
  protected final String TEXT_392 = "\";";
  protected final String TEXT_393 = NL + "\t\t\t\tString update_";
  protected final String TEXT_394 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_395 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_396 = ".";
  protected final String TEXT_397 = ", \"";
  protected final String TEXT_398 = "\")+\" WHERE ";
  protected final String TEXT_399 = "\";";
  protected final String TEXT_400 = NL + "\t\tpstmt_";
  protected final String TEXT_401 = " = conn_";
  protected final String TEXT_402 = ".prepareStatement(update_";
  ...
  protected final String TEXT_439 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_440 = " + \" WHERE ";
  protected final String TEXT_441 = "\");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_442 = " = conn_";
  protected final String TEXT_443 = ".prepareStatement(insert_";
  protected final String TEXT_444 = ");" + NL + "\t    pstmtUpdate_";
  ...
  protected final String TEXT_463 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_484 = ");" + NL + "\t    pstmtInsert_";
  ...
  protected final String TEXT_488 = NL + "\t    String delete_";
  protected final String TEXT_489 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_490 = " + \" WHERE ";
  protected final String TEXT_491 = "\";" + NL + "\t    pstmt_";
  protected final String TEXT_492 = " = conn_";
  protected final String TEXT_493 = ".prepareStatement(delete_";
  protected final String TEXT_494 = ");" + NL + "\t    ";
  protected final String TEXT_495 = NL + "       \t";
  protected final String TEXT_496 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_497 = " = insert_";
  protected final String TEXT_498 = ".split(\"\\\\?\");";
  protected final String TEXT_499 = NL + "\t\t\tupdate_";
  protected final String TEXT_500 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_501 = " = update_";
  protected final String TEXT_502 = ".split(\"\\\\?\");";
  protected final String TEXT_503 = NL + "\t\t\tupdate_";
  protected final String TEXT_504 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_505 = " = update_";
  protected final String TEXT_506 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_507 = " = insert_";
  protected final String TEXT_508 = ".split(\"\\\\?\");";
  protected final String TEXT_509 = NL + "\t\t\tdelete_";
  protected final String TEXT_510 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_511 = " = delete_";
  protected final String TEXT_512 = ".split(\"\\\\?\");";
  protected final String TEXT_513 = NL + "\t\t\treplace_";
  protected final String TEXT_514 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_515 = " = replace_";
  protected final String TEXT_516 = ".split(\"\\\\?\");";
  protected final String TEXT_517 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_518 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_519 = " = insertIgnore_";
  ...
  protected final String TEXT_525 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_526 = " = buffersSize_";
  protected final String TEXT_527 = ";";
  protected final String TEXT_528 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_529 = " = buffersSize_";
  protected final String TEXT_530 = ";";
  protected final String TEXT_531 = NL + "        whetherReject_";
  protected final String TEXT_532 = " = false;";
  protected final String TEXT_533 = NL + "                    ";
  protected final String TEXT_534 = NL + "                        query_";
  protected final String TEXT_535 = " = ";
  protected final String TEXT_536 = ";";
  protected final String TEXT_537 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_538 = ",";
  protected final String TEXT_539 = ".";
  protected final String TEXT_540 = ", ";
  protected final String TEXT_541 = ",insertSQLSplits_";
  protected final String TEXT_542 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_543 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_544 = ".";
  protected final String TEXT_545 = ", pstmt_";
  ...
  protected final String TEXT_554 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_555 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_556 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_557 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_558 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_559 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_560 = "++;" + NL + "                insertedCount_";
  ...
  protected final String TEXT_564 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_565 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_566 = " = true;";
  protected final String TEXT_567 = NL + "                    throw(e_";
  protected final String TEXT_568 = ");";
  protected final String TEXT_569 = NL + "                        ";
  protected final String TEXT_570 = " = new ";
  protected final String TEXT_571 = "Struct();";
  protected final String TEXT_572 = NL + "                            ";
  protected final String TEXT_573 = ".";
  protected final String TEXT_574 = " = ";
  protected final String TEXT_575 = ".";
  protected final String TEXT_576 = ";";
  protected final String TEXT_577 = NL + "                        rejectedCount_";
  protected final String TEXT_578 = " = rejectedCount_";
  protected final String TEXT_579 = " + 1;";
  protected final String TEXT_580 = NL + "                        ";
  protected final String TEXT_581 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_582 = ").getSQLState();";
  protected final String TEXT_583 = NL + "                        ";
  protected final String TEXT_584 = ".errorMessage = e_";
  protected final String TEXT_585 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_586 = ";";
  protected final String TEXT_587 = NL + "                        System.err.print(e_";
  protected final String TEXT_588 = ".getMessage());";
  protected final String TEXT_589 = NL + "            }    ";
  protected final String TEXT_590 = NL + "                    ";
  protected final String TEXT_591 = NL + "                        query_";
  protected final String TEXT_592 = " = ";
  protected final String TEXT_593 = ";";
  protected final String TEXT_594 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_595 = ",";
  protected final String TEXT_596 = ".";
  protected final String TEXT_597 = ", ";
  protected final String TEXT_598 = ",updateSQLSplits_";
  protected final String TEXT_599 = ");";
  protected final String TEXT_600 = NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_622 = NL + "\t\t\t\t   query_";
  protected final String TEXT_623 = " = ";
  protected final String TEXT_624 = ";" + NL + "\t\t\t    ";
  protected final String TEXT_625 = NL + "                globalMap.put(\"";
  protected final String TEXT_626 = "_QUERY\", query_";
  protected final String TEXT_627 = ".toString().trim());";
  protected final String TEXT_628 = NL + "    \t\t";
  protected final String TEXT_629 = NL + "    \t\tpstmt_";
  protected final String TEXT_630 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_631 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_632 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_633 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_634 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_635 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_636 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_637 = " = updatedCount_";
  protected final String TEXT_638 = " + pstmt_";
  protected final String TEXT_639 = ".executeUpdate();" + NL + "        \t    ";
  protected final String TEXT_640 = "                " + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_641 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_642 = " = true;";
  protected final String TEXT_643 = NL + "                    throw(e_";
  ...
  protected final String TEXT_657 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_658 = ").getSQLState();";
  protected final String TEXT_659 = NL + "                        ";
  protected final String TEXT_660 = ".errorMessage = e_";
  protected final String TEXT_661 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_662 = ";";
  protected final String TEXT_663 = NL + "                        System.err.print(e_";
  ...
  protected final String TEXT_669 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_670 = " = pstmt_";
  protected final String TEXT_671 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_672 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_673 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_674 = " = rs_";
  protected final String TEXT_675 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_676 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_677 = NL + "                        ";
  protected final String TEXT_678 = NL + "                            query_";
  protected final String TEXT_679 = " = ";
  protected final String TEXT_680 = ";";
  protected final String TEXT_681 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_682 = ",";
  protected final String TEXT_683 = ".";
  protected final String TEXT_684 = ", ";
  protected final String TEXT_685 = ",updateSQLSplits_";
  protected final String TEXT_686 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_687 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_688 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_719 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_720 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_721 = " = true;";
  protected final String TEXT_722 = NL + "                        throw(e_";
  protected final String TEXT_723 = ");";
  protected final String TEXT_724 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_738 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_739 = ").getSQLState();";
  protected final String TEXT_740 = NL + "                            ";
  protected final String TEXT_741 = ".errorMessage = e_";
  protected final String TEXT_742 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_743 = ";";
  protected final String TEXT_744 = NL + "                            System.err.print(e_";
  protected final String TEXT_745 = ".getMessage());";
  protected final String TEXT_746 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_747 = NL + "                        ";
  protected final String TEXT_748 = NL + "                            query_";
  protected final String TEXT_749 = " = ";
  protected final String TEXT_750 = ";";
  protected final String TEXT_751 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_752 = ",";
  protected final String TEXT_753 = ".";
  protected final String TEXT_754 = ", ";
  protected final String TEXT_755 = ",insertSQLSplits_";
  protected final String TEXT_756 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_757 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_758 = ".";
  protected final String TEXT_759 = ", pstmtInsert_";
  protected final String TEXT_760 = ", ";
  protected final String TEXT_761 = ", \"";
  protected final String TEXT_762 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_763 = NL + "                    globalMap.put(\"";
  protected final String TEXT_764 = "_QUERY\", query_";
  protected final String TEXT_765 = ".toString().trim());";
  protected final String TEXT_766 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_767 = " = insertedCount_";
  protected final String TEXT_768 = " + pstmtInsert_";
  protected final String TEXT_769 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_770 = "++;";
  protected final String TEXT_771 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_772 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_773 = " = true;";
  protected final String TEXT_774 = NL + "                        throw(e_";
  protected final String TEXT_775 = ");";
  protected final String TEXT_776 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_790 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_791 = ").getSQLState();";
  protected final String TEXT_792 = NL + "                            ";
  protected final String TEXT_793 = ".errorMessage = e_";
  protected final String TEXT_794 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_795 = ";";
  protected final String TEXT_796 = NL + "                            System.err.print(e_";
  protected final String TEXT_797 = ".getMessage());";
  protected final String TEXT_798 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_799 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_811 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_839 = NL + "    \t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_840 = "=pstmtUpdate_";
  protected final String TEXT_841 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_842 = " = updatedCount_";
  protected final String TEXT_843 = " + updateFlag_";
  protected final String TEXT_844 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_845 = " == 0) {" + NL + "            \t";
  protected final String TEXT_846 = NL + "\t\t\t\tquery_";
  protected final String TEXT_847 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_848 = NL + "                        ";
  protected final String TEXT_849 = NL + "                            query_";
  protected final String TEXT_850 = " = ";
  protected final String TEXT_851 = ";";
  protected final String TEXT_852 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_853 = ",";
  protected final String TEXT_854 = ".";
  protected final String TEXT_855 = ", ";
  protected final String TEXT_856 = ",insertSQLSplits_";
  protected final String TEXT_857 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_858 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_859 = ".";
  protected final String TEXT_860 = ", pstmtInsert_";
  protected final String TEXT_861 = ", ";
  protected final String TEXT_862 = ", \"";
  protected final String TEXT_863 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_864 = NL + "                    globalMap.put(\"";
  protected final String TEXT_865 = "_QUERY\", query_";
  protected final String TEXT_866 = ".toString().trim());";
  protected final String TEXT_867 = NL + "                    insertedCount_";
  protected final String TEXT_868 = " = insertedCount_";
  protected final String TEXT_869 = " + pstmtInsert_";
  protected final String TEXT_870 = ".executeUpdate();" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_871 = "++;";
  protected final String TEXT_872 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_873 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_874 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_875 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_876 = " = true;";
  protected final String TEXT_877 = NL + "                        throw(e_";
  ...
  protected final String TEXT_893 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_894 = ").getSQLState();";
  protected final String TEXT_895 = NL + "                            ";
  protected final String TEXT_896 = ".errorMessage = e_";
  protected final String TEXT_897 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_898 = ";";
  protected final String TEXT_899 = NL + "                            System.err.print(e_";
  protected final String TEXT_900 = ".getMessage());";
  ...
  protected final String TEXT_922 = NL + "            try {" + NL + "            \tdeletedCount_";
  protected final String TEXT_923 = " = deletedCount_";
  protected final String TEXT_924 = " + pstmt_";
  protected final String TEXT_925 = ".executeUpdate();" + NL + "            \tnb_line_";
  protected final String TEXT_926 = "++;";
  protected final String TEXT_927 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_928 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_929 = " = true;";
  protected final String TEXT_930 = NL + "                    throw(e_";
  ...
  protected final String TEXT_942 = NL + "                        rejectedCount_";
  protected final String TEXT_943 = " = rejectedCount_";
  protected final String TEXT_944 = " + 1;";
  protected final String TEXT_945 = NL + "                        ";
  protected final String TEXT_946 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_947 = ").getSQLState();";
  protected final String TEXT_948 = NL + "                        ";
  protected final String TEXT_949 = ".errorMessage = e_";
  protected final String TEXT_950 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_951 = ";";
  protected final String TEXT_952 = NL + "                        System.err.print(e_";
  protected final String TEXT_953 = ".getMessage());";
  ...
  protected final String TEXT_968 = " <= batchSizeCounter_";
  protected final String TEXT_969 = ") {                ";
  protected final String TEXT_970 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_971 = " = 0;" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_976 = " < 0 ? 0 : countEach_";
  protected final String TEXT_977 = ");" + NL + "\t\t\t\t\t\t}                \t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_978 = NL + "            \t    \t";
  protected final String TEXT_979 = NL + "            \t    \t\tinsertedCount_";
  ...
  protected final String TEXT_988 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_989 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_990 = "){" + NL + "                \t";
  protected final String TEXT_991 = NL + "                \t\tthrow(e_";
  protected final String TEXT_992 = ");" + NL + "                \t";
  protected final String TEXT_993 = NL + "                \tint countSum_";
  protected final String TEXT_994 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_995 = ": e_";
  protected final String TEXT_996 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1010 = ".getMessage());" + NL + "                \t";
  protected final String TEXT_1011 = NL + "                }";
  protected final String TEXT_1012 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1013 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1014 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_1015 = " <= commitCounter_";
  ...
  protected final String TEXT_1035 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1036 = "){" + NL + "                \t";
  protected final String TEXT_1037 = NL + "\t\t\t\t\t\tthrow(e_";
  protected final String TEXT_1038 = ");" + NL + "                \t";
  protected final String TEXT_1039 = NL + "                \t\tint countSum_";
  protected final String TEXT_1040 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1041 = ": e_";
  protected final String TEXT_1042 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1055 = NL + "                        System.err.println(e_";
  protected final String TEXT_1056 = ".getMessage());" + NL + "                \t";
  protected final String TEXT_1057 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_1058 = NL + "                \t";
  protected final String TEXT_1059 = NL + "                \tconn_";
  protected final String TEXT_1060 = ".commit();                " + NL + "                \t";
