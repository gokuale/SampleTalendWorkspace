...
public class TOracleOutputSparkcodeJava
{
  protected static String nl;
  public static synchronized TOracleOutputSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleOutputSparkcodeJava result = new TOracleOutputSparkcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_8 = "_OutputFunction(JobConf conf) throws ClassNotFoundException, java.sql.SQLException {" + NL + "                    Class.forName(";
  protected final String TEXT_9 = ");" + NL + "                    context = new ContextProperties(conf);" + NL + "                }" + NL + "" + NL + "                public void call(java.util.Iterator<";
