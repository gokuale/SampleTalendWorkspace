...
public class TTeradataOutputSparkcodeJava
{
  protected static String nl;
  public static synchronized TTeradataOutputSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataOutputSparkcodeJava result = new TTeradataOutputSparkcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_8 = "_OutputFunction(JobConf conf) throws ClassNotFoundException, java.sql.SQLException {" + NL + "                    Class.forName(\"com.teradata.jdbc.TeraDriver\");" + NL + "                    context = new ContextProperties(conf);" + NL + "                }" + NL + "" + NL + "                public void call(java.util.Iterator<";
  ...
  protected final String TEXT_10 = ");" + NL + "" + NL + "" + NL + "                    java.sql.PreparedStatement statement = connection.prepareStatement(\"INSERT INTO \\\"\" + ";
