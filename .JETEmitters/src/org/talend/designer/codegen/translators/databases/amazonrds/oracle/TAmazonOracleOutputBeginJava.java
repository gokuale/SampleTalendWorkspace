...
public class TAmazonOracleOutputBeginJava {
  ...
  protected final String TEXT_364 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_373 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_374 = "));";
  protected final String TEXT_375 = NL + "                                            stmtCreate_";
  protected final String TEXT_376 = ".execute(((\"";
  protected final String TEXT_377 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_401 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_405 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_406 = "));";
  protected final String TEXT_407 = NL + "                                        stmtCreate_";
  protected final String TEXT_408 = ".execute(((\"";
  protected final String TEXT_409 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_420 = ".close();";
  protected final String TEXT_421 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_422 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  ...
  protected final String TEXT_437 = NL + "                              stmtTruncCount_";
  protected final String TEXT_438 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_439 = "));";
  protected final String TEXT_440 = NL + "            java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_444 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_445 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_449 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_469 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_470 = " = stmtTruncCount_";
  protected final String TEXT_471 = ".executeQuery(\"";
  protected final String TEXT_472 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_473 = " = conn_";
  protected final String TEXT_474 = ".createStatement();";
  protected final String TEXT_475 = NL + "                conn_";
  protected final String TEXT_476 = ".commit();";
  protected final String TEXT_477 = NL + "            stmtTrunc_";
  protected final String TEXT_478 = ".executeUpdate(\"";
  protected final String TEXT_479 = "\");";
  protected final String TEXT_480 = NL + "            while(rsTruncCount_";
  protected final String TEXT_481 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_482 = " += rsTruncCount_";
  protected final String TEXT_483 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_484 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_485 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_492 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_493 = " = new StringBuffer(insert_";
  protected final String TEXT_494 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_495 = ".insert(insert_";
  protected final String TEXT_496 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_497 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_498 = " =insertStringBuffer_";
  protected final String TEXT_499 = ".toString(); ";
  protected final String TEXT_500 = "    " + NL + "" + NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_509 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_510 = " = new StringBuffer(update_";
  protected final String TEXT_511 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_512 = ".insert(update_";
  protected final String TEXT_513 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_514 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_515 = " =updateStringBuffer_";
  ...
  protected final String TEXT_523 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_591 = NL + "\t    String delete_";
  protected final String TEXT_592 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_593 = " + \" WHERE ";
  protected final String TEXT_594 = "\";" + NL + "\t    ";
  protected final String TEXT_595 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_596 = " = new StringBuffer(delete_";
  protected final String TEXT_597 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_598 = ".insert(delete_";
  protected final String TEXT_599 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_600 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_601 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_605 = ".prepareStatement(delete_";
  protected final String TEXT_606 = ");" + NL + "\t    ";
  protected final String TEXT_607 = NL + "        StringBuffer query_";
  protected final String TEXT_608 = " = null;" + NL + "\t   ";
  protected final String TEXT_609 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_610 = " = insert_";
  protected final String TEXT_611 = ".split(\"\\\\?\");";
  protected final String TEXT_612 = NL + "\t\t\tupdate_";
  protected final String TEXT_613 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_614 = " = update_";
  protected final String TEXT_615 = ".split(\"\\\\?\");";
  protected final String TEXT_616 = NL + "\t\t\tupdate_";
  protected final String TEXT_617 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_618 = " = update_";
  protected final String TEXT_619 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_620 = " = insert_";
  protected final String TEXT_621 = ".split(\"\\\\?\");";
  protected final String TEXT_622 = NL + "\t\t\tdelete_";
  protected final String TEXT_623 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_624 = " = delete_";
  protected final String TEXT_625 = ".split(\"\\\\?\");";
  protected final String TEXT_626 = NL + "\t\t\treplace_";
  protected final String TEXT_627 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_628 = " = replace_";
  protected final String TEXT_629 = ".split(\"\\\\?\");";
  protected final String TEXT_630 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_631 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_632 = " = insertIgnore_";
  protected final String TEXT_633 = ".split(\"\\\\?\");";
  protected final String TEXT_634 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_635 = " = insert_";
  protected final String TEXT_636 = ".split(\"\\\\?\");";
  protected final String TEXT_637 = NL + "\t   ";
  protected final String TEXT_638 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_639 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_640 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_641 = " = true;" + NL + "    \t";
  protected final String TEXT_642 = NL + NL + "\tclass ClobTypeUtil_";
  protected final String TEXT_643 = " {" + NL + "\t\tpublic Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "\t\t\toracle.sql.CLOB tempClob = null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\t// If the temporary CLOB has not yet been created, create one" + NL + "\t\t\t\ttempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "\t\t\t\t// Open the temporary CLOB in readwrite mode, to enable writing" + NL + "\t\t\t\ttempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "\t\t\t\t// Get the output stream to write" + NL + "\t\t\t\tjava.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "\t\t\t\tif(data instanceof oracle.sql.CLOB) {" + NL + "\t\t\t\t\toracle.sql.CLOB inClob = (oracle.sql.CLOB) data;" + NL + "\t\t\t        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "\t\t\t        char[] chs = new char[128];" + NL + "\t\t\t       \tint len = 0;" + NL + "\t\t\t\t\twhile ((len = inReader.read(chs)) != -1) {" + NL + "\t\t\t        \ttempClobWriter.write(chs, 0, len);" + NL + "\t\t\t        }" + NL + "\t\t\t    }else if(data instanceof String) {" + NL + "\t\t\t       // Write the data into the temporary CLOB" + NL + "\t\t\t\t\ttempClobWriter.write((String)data);" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\treturn data;" + NL + "\t\t\t\t}" + NL + "\t\t\t\t// Flush and close the stream" + NL + "\t\t\t\ttempClobWriter.flush();" + NL + "\t\t\t\ttempClobWriter.close();" + NL + "\t\t\t\t// Close the temporary CLOB" + NL + "\t\t\t\ttempClob.close();" + NL + "\t\t\t} catch( java.sql.SQLException sqlexp){" + NL + "\t  \t\t\t";
  protected final String TEXT_644 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\tsqlexp.printStackTrace();" + NL + "\t\t\t} catch(java.lang.Exception exp){" + NL + "\t  \t\t\t";
  protected final String TEXT_645 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\texp.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t\treturn tempClob;" + NL + "\t\t}" + NL + "\t}" + NL + "\tClobTypeUtil_";
  protected final String TEXT_646 = " clobTypeUtil_";
  protected final String TEXT_647 = "=new ClobTypeUtil_";
  protected final String TEXT_648 = "();";
  protected final String TEXT_649 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_650 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_651 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_652 = " =null;" + NL + "\t";
  protected final String TEXT_653 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_657 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_658 = " =  null;";
  protected final String TEXT_659 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_660 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_661 = " = null;";
  protected final String TEXT_662 = NL + "\t\t   \tString[] deleteSQLSplits_";
  ...
  protected final String TEXT_666 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
