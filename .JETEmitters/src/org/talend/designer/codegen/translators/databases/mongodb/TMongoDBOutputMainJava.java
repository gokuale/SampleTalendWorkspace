...
public class TMongoDBOutputMainJava
{
  ...
  protected final String TEXT_109 = NL + "                                if(bulkWriteOperationCounter_";
  protected final String TEXT_110 = " < bulkWriteOperationSize_";
  protected final String TEXT_111 = "){" + NL + "                                    com.mongodb.BulkWriteRequestBuilder bulkWriteRequestBuilder_";
  protected final String TEXT_112 = " = bulkWriteOperation_";
  protected final String TEXT_113 = ".find(queryObj_";
  protected final String TEXT_114 = ");" + NL + "                                    com.mongodb.BulkUpdateRequestBuilder bulkUpdateRequestBuilder_";
  protected final String TEXT_115 = " = bulkWriteRequestBuilder_";
  protected final String TEXT_116 = ".upsert();" + NL + "                                    bulkUpdateRequestBuilder_";
  protected final String TEXT_117 = ".replaceOne(updateObj_";
  protected final String TEXT_118 = ");" + NL + "                                    bulkWriteOperationCounter_";
  protected final String TEXT_119 = "++;" + NL + "                                }else{" + NL + "                                    com.mongodb.BulkWriteRequestBuilder bulkWriteRequestBuilder_";
  protected final String TEXT_120 = " = bulkWriteOperation_";
  protected final String TEXT_121 = ".find(queryObj_";
  protected final String TEXT_122 = ");" + NL + "                                    com.mongodb.BulkUpdateRequestBuilder bulkUpdateRequestBuilder_";
  protected final String TEXT_123 = " = bulkWriteRequestBuilder_";
  protected final String TEXT_124 = ".upsert();" + NL + "                                    bulkUpdateRequestBuilder_";
  protected final String TEXT_125 = ".replaceOne(updateObj_";
  protected final String TEXT_126 = ");" + NL + "                                    bulkWriteOperation_";
  protected final String TEXT_127 = ".execute();" + NL + "                                    bulkWriteOperationCounter_";
  protected final String TEXT_128 = "=1;" + NL + "                                    bulkWriteOperation_";
  protected final String TEXT_129 = " = coll_";
  protected final String TEXT_130 = ".initialize";
  protected final String TEXT_131 = "BulkOperation();" + NL + "                                }";
  protected final String TEXT_132 = NL + "                                resultMessage_";
  protected final String TEXT_133 = "=coll_";
  protected final String TEXT_134 = ".update(queryObj_";
  protected final String TEXT_135 = ",updateObj_";
  protected final String TEXT_136 = ",true,false);";
  protected final String TEXT_137 = NL + "                                if(bulkWriteOperationCounter_";
  protected final String TEXT_138 = " < bulkWriteOperationSize_";
  protected final String TEXT_139 = "){" + NL + "                                    com.mongodb.BulkWriteRequestBuilder bulkWriteRequestBuilder_";
  protected final String TEXT_140 = " = bulkWriteOperation_";
  protected final String TEXT_141 = ".find(queryObj_";
  protected final String TEXT_142 = ");" + NL + "                                    com.mongodb.BulkUpdateRequestBuilder bulkUpdateRequestBuilder_";
  protected final String TEXT_143 = " = bulkWriteRequestBuilder_";
  protected final String TEXT_144 = ".upsert();" + NL + "                                    bulkUpdateRequestBuilder_";
  protected final String TEXT_145 = ".update(new com.mongodb.BasicDBObject(\"$set\", updateObj_";
  protected final String TEXT_146 = "));" + NL + "                                    bulkWriteOperationCounter_";
  protected final String TEXT_147 = "++;" + NL + "                                }else{" + NL + "                                    com.mongodb.BulkWriteRequestBuilder bulkWriteRequestBuilder_";
  protected final String TEXT_148 = " = bulkWriteOperation_";
  protected final String TEXT_149 = ".find(queryObj_";
  protected final String TEXT_150 = ");" + NL + "                                    com.mongodb.BulkUpdateRequestBuilder bulkUpdateRequestBuilder_";
  protected final String TEXT_151 = " = bulkWriteRequestBuilder_";
  protected final String TEXT_152 = ".upsert();" + NL + "                                    bulkUpdateRequestBuilder_";
  protected final String TEXT_153 = ".update(new com.mongodb.BasicDBObject(\"$set\", updateObj_";
  protected final String TEXT_154 = "));" + NL + "                                    bulkWriteOperation_";
  protected final String TEXT_155 = ".execute();" + NL + "                                    bulkWriteOperationCounter_";
  protected final String TEXT_156 = "=1;" + NL + "                                    bulkWriteOperation_";
  protected final String TEXT_157 = " = coll_";
  protected final String TEXT_158 = ".initialize";
  protected final String TEXT_159 = "BulkOperation();" + NL + "                                }";
  protected final String TEXT_160 = NL + "                                resultMessage_";
  protected final String TEXT_161 = "=coll_";
  protected final String TEXT_162 = ".update(queryObj_";
  protected final String TEXT_163 = ",new com.mongodb.BasicDBObject(\"$set\", updateObj_";
  protected final String TEXT_164 = "),true,false);";
  protected final String TEXT_165 = NL + "\t\t\t\t\t\t\t\tif(bulkWriteOperationCounter_";
  protected final String TEXT_166 = " < bulkWriteOperationSize_";
  protected final String TEXT_167 = "){" + NL + "\t\t\t\t\t\t\t\t\tbulkWriteOperation_";
  protected final String TEXT_168 = ".find(queryObj_";
  protected final String TEXT_169 = ").remove();" + NL + "\t\t\t\t\t\t\t\t\tbulkWriteOperationCounter_";
  protected final String TEXT_170 = "++;" + NL + "\t\t\t\t\t\t\t\t}else{" + NL + "                                    bulkWriteOperation_";
  protected final String TEXT_171 = ".find(queryObj_";
  protected final String TEXT_172 = ").remove();" + NL + "\t\t\t\t\t\t\t\t\tbulkWriteOperation_";
  protected final String TEXT_173 = ".execute();" + NL + "\t\t\t\t\t\t\t\t\tbulkWriteOperationCounter_";
  protected final String TEXT_174 = "=1;" + NL + "\t\t\t\t\t\t\t\t\tbulkWriteOperation_";
  protected final String TEXT_175 = " = coll_";
  protected final String TEXT_176 = ".initialize";
  protected final String TEXT_177 = "BulkOperation();" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_178 = NL + "\t\t\t\t\t\t\t\tresultMessage_";
  protected final String TEXT_179 = "=coll_";
  protected final String TEXT_180 = ".remove(queryObj_";
  protected final String TEXT_181 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_182 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_183 = NL + "    \t\t\t\tif(resultMessage_";
  protected final String TEXT_184 = "!=null && resultMessage_";
  protected final String TEXT_185 = ".getError()!=null){" + NL + "    \t\t\t\t\t";
  protected final String TEXT_186 = NL + "    \t\t\t\t\t\tthrow new Exception(resultMessage_";
  protected final String TEXT_187 = ".getError());" + NL + "    \t\t\t\t\t";
  protected final String TEXT_188 = NL + "    \t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_189 = " - \" + resultMessage_";
  protected final String TEXT_190 = ".getError());" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_191 = NL + "    \t\t\t\t\t\tSystem.err.println(resultMessage_";
  ...
  protected final String TEXT_198 = "] - Writing the record \" + nb_line_";
  protected final String TEXT_199 = " + \" into database.\");" + NL + "\t\t\t\t";
