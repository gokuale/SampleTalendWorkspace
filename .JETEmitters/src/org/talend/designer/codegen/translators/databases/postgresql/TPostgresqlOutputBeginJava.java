...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_336 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_337 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_350 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_351 = ".";
  protected final String TEXT_352 = ", \"";
  protected final String TEXT_353 = "\")";
  protected final String TEXT_354 = ".toUpperCase()";
  ...
  protected final String TEXT_363 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_395 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  ...
  protected final String TEXT_410 = NL + "                              stmtTruncCount_";
  protected final String TEXT_411 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_412 = "));";
  protected final String TEXT_413 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_414 = " = stmtTruncCount_";
  protected final String TEXT_415 = ".executeQuery(\"";
  protected final String TEXT_416 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_417 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_418 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_422 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_428 = NL + "                conn_";
  protected final String TEXT_429 = ".commit();";
  protected final String TEXT_430 = NL + "            stmtTrunc_";
  protected final String TEXT_431 = ".executeUpdate(\"";
  protected final String TEXT_432 = "\");";
  protected final String TEXT_433 = NL + "                if(!conn_";
  protected final String TEXT_434 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_435 = ".commit();" + NL + "                }";
  protected final String TEXT_436 = NL + "            deletedCount_";
  protected final String TEXT_437 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_442 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_443 = " = stmtTruncCount_";
  protected final String TEXT_444 = ".executeQuery(\"";
  protected final String TEXT_445 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_472 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_473 = " = conn_";
  protected final String TEXT_474 = ".prepareStatement(update_";
  ...
  protected final String TEXT_499 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_510 = NL + "\t    String delete_";
  protected final String TEXT_511 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_512 = " + \"\\\" WHERE ";
  ...
  protected final String TEXT_517 = NL + "        StringBuffer query_";
  protected final String TEXT_518 = " = null;" + NL + "       \t";
  protected final String TEXT_519 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_520 = " = insert_";
  protected final String TEXT_521 = ".split(\"\\\\?\");";
  protected final String TEXT_522 = NL + "\t\t\tupdate_";
  protected final String TEXT_523 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  ...
  protected final String TEXT_541 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_542 = " = insertIgnore_";
  protected final String TEXT_543 = ".split(\"\\\\?\");";
  protected final String TEXT_544 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_545 = " = insert_";
  protected final String TEXT_546 = ".split(\"\\\\?\");";
  protected final String TEXT_547 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_548 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_549 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_550 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_551 = " = true;" + NL + "    \t";
  protected final String TEXT_552 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_553 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_554 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_555 = " =null;" + NL + "\t";
  protected final String TEXT_556 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_563 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_567 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_568 = " = null;";
  protected final String TEXT_569 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
