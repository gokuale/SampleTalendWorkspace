...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_483 = " = null;" + NL + "\t\tString keyPsmt_";
  protected final String TEXT_484 = " = conn_";
  protected final String TEXT_485 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_486 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_487 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_488 = ",insert_";
  protected final String TEXT_489 = ",keyPsmt_";
  ...
  protected final String TEXT_501 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_507 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_529 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_542 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_552 = NL + NL + "    class BufferLine_";
  protected final String TEXT_553 = " {";
  protected final String TEXT_554 = NL + "                ";
  protected final String TEXT_555 = " ";
  protected final String TEXT_556 = ";";
  protected final String TEXT_557 = NL + NL + "        public BufferLine_";
  protected final String TEXT_558 = "(";
  protected final String TEXT_559 = NL + "                    ,";
  protected final String TEXT_560 = NL + "                ";
  protected final String TEXT_561 = " ";
  protected final String TEXT_562 = NL + "        ){";
  protected final String TEXT_563 = NL + "                    this.";
  protected final String TEXT_564 = " = ";
  protected final String TEXT_565 = ";";
  protected final String TEXT_566 = NL + "        }" + NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_567 = "> sInsertColValueList";
  protected final String TEXT_568 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_569 = " sInsertColValue";
  protected final String TEXT_570 = " = null;" + NL + "" + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_571 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_572 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_573 = ".append(\"(";
  protected final String TEXT_574 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_575 = "-1) extendInsertValueStmt_";
  protected final String TEXT_576 = ".append(\",\");" + NL + "    }" + NL + "" + NL + "\tString insert_";
  protected final String TEXT_577 = " = \"INSERT INTO \"+";
  protected final String TEXT_578 = "+\" (";
  protected final String TEXT_579 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_580 = ".toString();" + NL + "" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_581 = " =  conn_";
  protected final String TEXT_582 = ".prepareStatement(insert_";
  protected final String TEXT_583 = ");" + NL + "" + NL + "    String insertColName";
  protected final String TEXT_584 = " = \"";
  protected final String TEXT_585 = "\";" + NL + "    String insertColValue";
  protected final String TEXT_586 = " =  \"";
  protected final String TEXT_587 = "\";" + NL + "    int rowCount";
  protected final String TEXT_588 = " = 0;";
  protected final String TEXT_589 = NL + "        StringBuffer query_";
  protected final String TEXT_590 = " = null;" + NL + "       \t";
  protected final String TEXT_591 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_601 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_602 = " = insert_";
  protected final String TEXT_603 = ".split(\"\\\\?\");";
  protected final String TEXT_604 = NL + "\t\t\tdelete_";
  protected final String TEXT_605 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_606 = " = delete_";
  protected final String TEXT_607 = ".split(\"\\\\?\");";
  protected final String TEXT_608 = NL + "\t\t\treplace_";
  protected final String TEXT_609 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_610 = " = replace_";
  protected final String TEXT_611 = ".split(\"\\\\?\");";
  protected final String TEXT_612 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_613 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_614 = " = insertIgnore_";
  ...
  protected final String TEXT_619 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_620 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_621 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_622 = "\") == true;";
  protected final String TEXT_623 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_624 = " = conn_";
  protected final String TEXT_625 = ".createStatement();";
  protected final String TEXT_626 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_627 = " ) {" + NL + "\t        \tstmt_";
  protected final String TEXT_628 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_629 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_630 = NL + "     \t\tstmt_";
  protected final String TEXT_631 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_632 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_633 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_634 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_635 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_641 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_642 = " =  null;";
  protected final String TEXT_643 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_644 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_645 = " = null;";
  protected final String TEXT_646 = NL + "\t\t   \tString[] deleteSQLSplits_";
  ...
  protected final String TEXT_650 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_651 = " = null;";
  protected final String TEXT_652 = NL + "\t\t \tString[] insertSQLSplits_";
