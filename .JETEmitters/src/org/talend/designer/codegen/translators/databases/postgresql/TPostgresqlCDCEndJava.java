...
public class TPostgresqlCDCEndJava
{
  protected static String nl;
  public static synchronized TPostgresqlCDCEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresqlCDCEndJava result = new TPostgresqlCDCEndJava();
    nl = null;
    return result;
  }
