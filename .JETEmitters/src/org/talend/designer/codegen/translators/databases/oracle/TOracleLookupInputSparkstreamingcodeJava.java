...
public class TOracleLookupInputSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TOracleLookupInputSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleLookupInputSparkstreamingcodeJava result = new TOracleLookupInputSparkstreamingcodeJava();
    nl = null;
    return result;
  }
...
final class TOracleLookupInputUtil extends AbstractJDBCLookupInputUtil {

	public TOracleLookupInputUtil(INode node) {
		super(node);
	}

} // end class tOracleLookupInputUtil
...
TOracleLookupInputUtil tOracleLookupInputUtil = new TOracleLookupInputUtil(node);
OracleSparkStorage storage = new OracleSparkStorage(node);
TMapJDBCFlatMapperUtil tMapFlatMapperUtil = new TMapJDBCFlatMapperUtil(tOracleLookupInputUtil, storage);
