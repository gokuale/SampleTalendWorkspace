...
public class TTeradataCDCEndJava
{
  protected static String nl;
  public static synchronized TTeradataCDCEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataCDCEndJava result = new TTeradataCDCEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_73 = NL + NL + "\tqueryUpdatePrefix_";
  protected final String TEXT_74 = "=\"UPDATE \"+dataTableName_";
  protected final String TEXT_75 = "+\" SET TALEND_CDC_STATE='x' WHERE TALEND_CDC_STATE='1' AND TALEND_CDC_SUBSCRIBERS_NAME='\"+";
  protected final String TEXT_76 = "+\"'\";" + NL + "\t";
  protected final String TEXT_77 = NL + "    stmt_";
  protected final String TEXT_78 = ".executeUpdate(queryUpdatePrefix_";
  protected final String TEXT_79 = ");" + NL + "    ";
  protected final String TEXT_80 = NL + NL + "\tString queryResetLocks_";
  protected final String TEXT_81 = " = \"DELETE FROM \"+dataTableName_";
  protected final String TEXT_82 = " +\" WHERE TALEND_CDC_SUBSCRIBERS_NAME='\"+";
  protected final String TEXT_83 = "+\"' AND TALEND_CDC_STATE='1'\";" + NL + "\t" + NL + "\t";
  protected final String TEXT_84 = NL + "\t" + NL + "\tstmt_";
  protected final String TEXT_85 = ".executeUpdate(queryResetLocks_";
  protected final String TEXT_86 = ");" + NL + "\t" + NL + "\t";
  protected final String TEXT_87 = NL;
  protected final String TEXT_88 = NL + NL + "stmt_";
