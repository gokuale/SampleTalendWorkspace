...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_315 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_339 = ".close();" + NL + "                                }";
  protected final String TEXT_340 = NL + "                                if(whetherExist_";
  protected final String TEXT_341 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_360 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_361 = ".";
  protected final String TEXT_362 = ", \"";
  protected final String TEXT_363 = "\")";
  protected final String TEXT_364 = ".toUpperCase()";
  ...
  protected final String TEXT_372 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_373 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  ...
  protected final String TEXT_383 = NL + "            stmtClear_";
  protected final String TEXT_384 = ".close();";
  protected final String TEXT_385 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_386 = " = conn_";
  protected final String TEXT_387 = ".createStatement();";
  protected final String TEXT_388 = NL + "                              stmtTruncCount_";
  protected final String TEXT_389 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_390 = "));";
  protected final String TEXT_391 = NL + "            java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_403 = NL + "                              stmtTrunc_";
  protected final String TEXT_404 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_405 = "));";
  protected final String TEXT_406 = NL + "                conn_";
  protected final String TEXT_407 = ".commit();";
  protected final String TEXT_408 = NL + "            stmtTrunc_";
  protected final String TEXT_409 = ".executeUpdate(\"";
  protected final String TEXT_410 = "\");";
  protected final String TEXT_411 = NL + "                if(!conn_";
  protected final String TEXT_412 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_413 = ".commit();" + NL + "                }";
  protected final String TEXT_414 = NL + "            deletedCount_";
  protected final String TEXT_415 = " += rsTruncCountNumber_";
  protected final String TEXT_416 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_417 = ".close();";
  protected final String TEXT_418 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_419 = " = conn_";
  protected final String TEXT_420 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_421 = " = stmtTruncCount_";
  protected final String TEXT_422 = ".executeQuery(\"";
  protected final String TEXT_423 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_427 = ".commit();";
  ...
  protected final String TEXT_438 = NL + "\t    String insert_";
  protected final String TEXT_439 = " = \"INSERT INTO \" + tableName_";
  ...
  protected final String TEXT_450 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_462 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_477 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_478 = " = conn_";
  protected final String TEXT_479 = ".prepareStatement(update_";
  ...
  protected final String TEXT_484 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_495 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_500 = NL + "\t\t\tupdate_";
  protected final String TEXT_501 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_502 = " = update_";
  protected final String TEXT_503 = ".split(\"\\\\?\");";
  protected final String TEXT_504 = NL + "\t\t\tupdate_";
  protected final String TEXT_505 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_506 = " = update_";
  protected final String TEXT_507 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_508 = " = insert_";
  protected final String TEXT_509 = ".split(\"\\\\?\");";
  protected final String TEXT_510 = NL + "\t\t\tdelete_";
  protected final String TEXT_511 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_512 = " = delete_";
  protected final String TEXT_513 = ".split(\"\\\\?\");";
  protected final String TEXT_514 = NL + "\t\t\treplace_";
  protected final String TEXT_515 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_516 = " = replace_";
  protected final String TEXT_517 = ".split(\"\\\\?\");";
  protected final String TEXT_518 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_519 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_520 = " = insertIgnore_";
  protected final String TEXT_521 = ".split(\"\\\\?\");";
  protected final String TEXT_522 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_523 = " = insert_";
  protected final String TEXT_524 = ".split(\"\\\\?\");";
  protected final String TEXT_525 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_526 = " = conn_";
  protected final String TEXT_527 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_528 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_529 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_530 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_531 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_532 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_541 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_542 = " = null;";
  protected final String TEXT_543 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_544 = " = null;";
  protected final String TEXT_545 = NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_549 = NL + "\t\t \tString[] insertSQLSplits_";
