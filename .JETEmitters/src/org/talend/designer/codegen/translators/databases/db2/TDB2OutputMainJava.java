...
public class TDB2OutputMainJava {
  ...
  protected final String TEXT_370 = "+\") VALUES (";
  protected final String TEXT_371 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_405 = "+\" WHERE ";
  ...
  protected final String TEXT_454 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_455 = " + \"\\\" WHERE ";
  protected final String TEXT_456 = "\");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_457 = " = conn_";
  protected final String TEXT_458 = ".prepareStatement(insert_";
  protected final String TEXT_459 = ");" + NL + "\t    pstmtUpdate_";
  ...
  protected final String TEXT_481 = ".toUpperCase()";
  protected final String TEXT_482 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_488 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_489 = ".";
  protected final String TEXT_490 = ", \"";
  protected final String TEXT_491 = "\")";
  protected final String TEXT_492 = ".toUpperCase()";
  ...
  protected final String TEXT_507 = ");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_508 = " = conn_";
  protected final String TEXT_509 = ".prepareStatement(insert_";
  protected final String TEXT_510 = ");" + NL + "\t    ";
  protected final String TEXT_511 = NL + "\t    String delete_";
  protected final String TEXT_512 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_513 = " + \"\\\" WHERE ";
  protected final String TEXT_514 = "\";" + NL + "\t    pstmt_";
  protected final String TEXT_515 = " = conn_";
  protected final String TEXT_516 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_527 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_528 = " = update_";
  protected final String TEXT_529 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_530 = " = insert_";
  protected final String TEXT_531 = ".split(\"\\\\?\");";
  protected final String TEXT_532 = NL + "\t\t\tdelete_";
  protected final String TEXT_533 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_534 = " = delete_";
  protected final String TEXT_535 = ".split(\"\\\\?\");";
  protected final String TEXT_536 = NL + "\t\t\treplace_";
  protected final String TEXT_537 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_538 = " = replace_";
  protected final String TEXT_539 = ".split(\"\\\\?\");";
  protected final String TEXT_540 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_541 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_542 = " = insertIgnore_";
  ...
  protected final String TEXT_548 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_549 = " = buffersSize_";
  protected final String TEXT_550 = ";";
  protected final String TEXT_551 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_552 = " = buffersSize_";
  protected final String TEXT_553 = ";";
  protected final String TEXT_554 = NL + "        whetherReject_";
  protected final String TEXT_555 = " = false;";
  protected final String TEXT_556 = NL + "\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_557 = ".setInsert_";
  protected final String TEXT_558 = "(";
  protected final String TEXT_559 = ",pstmt_";
  protected final String TEXT_560 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_561 = ",query_";
  ...
  protected final String TEXT_592 = ".executeUpdate();";
  protected final String TEXT_593 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_599 = NL + "                        \t\tdataPropagateUtil_";
  protected final String TEXT_600 = ".assign_";
  ...
  protected final String TEXT_618 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_619 = NL + "            }";
  protected final String TEXT_620 = NL + "\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_621 = ".setUpdate_";
  protected final String TEXT_622 = "(";
  protected final String TEXT_623 = ",pstmt_";
  protected final String TEXT_624 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_625 = ",query_";
  ...
  protected final String TEXT_632 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_633 = ",";
  protected final String TEXT_634 = ".";
  protected final String TEXT_635 = ", ";
  protected final String TEXT_636 = ",updateSQLSplits_";
  protected final String TEXT_637 = ");";
  protected final String TEXT_638 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_639 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_640 = ".";
  protected final String TEXT_641 = ", pstmt_";
  ...
  protected final String TEXT_658 = NL + "                globalMap.put(\"";
  protected final String TEXT_659 = "_QUERY\", query_";
  protected final String TEXT_660 = ".toString().trim());";
  protected final String TEXT_661 = NL + "    \t\t";
  protected final String TEXT_662 = NL + "        \t\tpstmt_";
  protected final String TEXT_663 = ".addBatch();" + NL + "        \t\tnb_line_";
  protected final String TEXT_664 = "++;" + NL + "    \t\t  \t";
  protected final String TEXT_665 = NL + "    \t\t  \t\tbatchSizeCounter_";
  protected final String TEXT_666 = "++;" + NL + "    \t\t";
  protected final String TEXT_667 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_668 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_669 = " = updatedCount_";
  protected final String TEXT_670 = " + pstmt_";
  protected final String TEXT_671 = ".executeUpdate();";
  protected final String TEXT_672 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_673 = " = true;";
  protected final String TEXT_674 = NL + "                    throw(e);";
  protected final String TEXT_675 = NL + "                        ";
  protected final String TEXT_676 = " = new ";
  protected final String TEXT_677 = "Struct();";
  protected final String TEXT_678 = NL + "                        \t\tdataPropagateUtil_";
  protected final String TEXT_679 = ".assign_";
  protected final String TEXT_680 = "_";
  ...
  protected final String TEXT_702 = NL + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_703 = " = pstmt_";
  protected final String TEXT_704 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_705 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_706 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_707 = " = rs_";
  protected final String TEXT_708 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_709 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_710 = NL + "\t\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_711 = ".setUpdate_";
  protected final String TEXT_712 = "(";
  protected final String TEXT_713 = ",pstmtUpdate_";
  protected final String TEXT_714 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_715 = ",query_";
  protected final String TEXT_716 = ",updateSQLSplits_";
  ...
  protected final String TEXT_750 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_751 = " = updatedCount_";
  protected final String TEXT_752 = " + pstmtUpdate_";
  protected final String TEXT_753 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_763 = NL + "                            \t\tdataPropagateUtil_";
  protected final String TEXT_764 = ".assign_";
  ...
  protected final String TEXT_778 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_779 = NL + "                            ";
  protected final String TEXT_780 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_781 = ";";
  protected final String TEXT_782 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_783 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_784 = NL + "\t\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_785 = ".setInsert_";
  protected final String TEXT_786 = "(";
  protected final String TEXT_787 = ",pstmtInsert_";
  protected final String TEXT_788 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_789 = ",query_";
  protected final String TEXT_790 = ",insertSQLSplits_";
  ...
  protected final String TEXT_799 = ",insertSQLSplits_";
  protected final String TEXT_800 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_801 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_802 = ".";
  protected final String TEXT_803 = ", pstmtInsert_";
  protected final String TEXT_804 = ", ";
  protected final String TEXT_805 = ", \"";
  protected final String TEXT_806 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_807 = NL + "                    globalMap.put(\"";
  protected final String TEXT_808 = "_QUERY\", query_";
  protected final String TEXT_809 = ".toString().trim());";
  protected final String TEXT_810 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_811 = " = insertedCount_";
  protected final String TEXT_812 = " + pstmtInsert_";
  protected final String TEXT_813 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_822 = "Struct();";
  protected final String TEXT_823 = NL + "                            \t\tdataPropagateUtil_";
  protected final String TEXT_824 = ".assign_";
  ...
  protected final String TEXT_838 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_839 = NL + "                            ";
  protected final String TEXT_840 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_841 = ";";
  protected final String TEXT_842 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_843 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_844 = NL + "    \t    int updateFlag_";
  protected final String TEXT_845 = "=0;" + NL + "    \t    ";
  protected final String TEXT_846 = NL + "\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_847 = ".setUpdate_";
  protected final String TEXT_848 = "(";
  protected final String TEXT_849 = ",pstmtUpdate_";
  protected final String TEXT_850 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_851 = ",query_";
  protected final String TEXT_852 = ",updateSQLSplits_";
  ...
  protected final String TEXT_896 = NL + "\t\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_897 = ".setInsert_";
  protected final String TEXT_898 = "(";
  protected final String TEXT_899 = ",pstmtInsert_";
  protected final String TEXT_900 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_901 = ",query_";
  protected final String TEXT_902 = ",insertSQLSplits_";
  ...
  protected final String TEXT_927 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_928 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_929 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_930 = " = true;";
  protected final String TEXT_931 = NL + "                        throw(e);";
  ...
  protected final String TEXT_937 = NL + "                            \t\tdataPropagateUtil_";
  protected final String TEXT_938 = ".assign_";
  ...
  protected final String TEXT_975 = NL + "            try {" + NL + "            \tdeletedCount_";
  protected final String TEXT_976 = " = deletedCount_";
  protected final String TEXT_977 = " + pstmt_";
  protected final String TEXT_978 = ".executeUpdate();" + NL + "            \tnb_line_";
  protected final String TEXT_979 = "++;";
  protected final String TEXT_980 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_981 = " = true;";
  protected final String TEXT_982 = NL + "                    throw(e);";
  protected final String TEXT_983 = NL + "                \tnb_line_";
  ...
  protected final String TEXT_988 = NL + "                            \tdataPropagateUtil_";
  protected final String TEXT_989 = ".assign_";
  ...
  protected final String TEXT_999 = NL + "                        rejectedCount_";
  protected final String TEXT_1000 = " = rejectedCount_";
  protected final String TEXT_1001 = " + 1;";
  protected final String TEXT_1002 = NL + "                        ";
  protected final String TEXT_1003 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1004 = NL + "                        ";
  protected final String TEXT_1005 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1006 = ";";
  protected final String TEXT_1007 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1008 = NL + "            }";
  protected final String TEXT_1009 = NL + "    \t";
  protected final String TEXT_1010 = NL + "            if(!whetherReject_";
  protected final String TEXT_1011 = ") {";
  protected final String TEXT_1012 = NL + "                            ";
  protected final String TEXT_1013 = " = new ";
  protected final String TEXT_1014 = "Struct();";
  protected final String TEXT_1015 = NL + "                                \tdataPropagateUtil_";
  protected final String TEXT_1016 = ".assign_";
  protected final String TEXT_1017 = "_";
  ...
  protected final String TEXT_1027 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_1028 = " > 0) && (batchSize_";
  protected final String TEXT_1029 = " <= batchSizeCounter_";
  protected final String TEXT_1030 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1031 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1032 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1033 = ": pstmt_";
  protected final String TEXT_1034 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1042 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1043 = " += countSum_";
  protected final String TEXT_1044 = ";" + NL + "            \t    \t";
  protected final String TEXT_1045 = NL + "            \t    \t    deletedCount_";
  ...
  protected final String TEXT_1049 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1050 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1051 = NL + "                \tint countSum_";
  protected final String TEXT_1052 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1053 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1054 = " += (countEach_";
  protected final String TEXT_1055 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1066 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1067 = NL + "                }" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1068 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1069 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1070 = " <= commitCounter_";
  protected final String TEXT_1071 = ") {";
  protected final String TEXT_1072 = NL + "                if ((batchSize_";
  protected final String TEXT_1073 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1074 = " > 0)) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_1075 = " = 0;" + NL + "                \t\tint countSum_";
  protected final String TEXT_1076 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_1077 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1078 = ": pstmt_";
  protected final String TEXT_1079 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1084 = NL + "            \t    \t\tinsertedCount_";
  ...
  protected final String TEXT_1088 = " += countSum_";
  protected final String TEXT_1089 = ";" + NL + "            \t    \t";
  protected final String TEXT_1090 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1091 = " += countSum_";
  protected final String TEXT_1092 = ";" + NL + "            \t    \t";
  protected final String TEXT_1093 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1094 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1095 = NL + "                \t\tint countSum_";
  protected final String TEXT_1096 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1097 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1098 = " += (countEach_";
  protected final String TEXT_1099 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1100 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1101 = NL + "            \t    \t\tinsertedCount_";
  ...
  protected final String TEXT_1105 = " += countSum_";
  protected final String TEXT_1106 = ";" + NL + "            \t    \t";
  protected final String TEXT_1107 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1108 = " += countSum_";
  protected final String TEXT_1109 = ";" + NL + "            \t    \t";
  protected final String TEXT_1110 = NL + "                        System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1111 = NL + "                }" + NL + "                }";
  protected final String TEXT_1112 = NL + "                \t";
  protected final String TEXT_1113 = NL + "                \tconn_";
  protected final String TEXT_1114 = ".commit();" + NL + "                \t";
  protected final String TEXT_1115 = NL + "                \tcommitCounter_";
