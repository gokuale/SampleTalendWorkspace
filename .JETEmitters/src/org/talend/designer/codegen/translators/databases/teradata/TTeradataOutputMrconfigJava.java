...
public class TTeradataOutputMrconfigJava
{
  protected static String nl;
  public static synchronized TTeradataOutputMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataOutputMrconfigJava result = new TTeradataOutputMrconfigJava();
    nl = null;
    return result;
  }
