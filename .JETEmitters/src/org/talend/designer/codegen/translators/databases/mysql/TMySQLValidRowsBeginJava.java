...
public class TMySQLValidRowsBeginJava
{
  ...
  protected final String TEXT_186 = NL + "\t\t\tjava.util.Calendar calendar_";
  protected final String TEXT_187 = " = java.util.Calendar.getInstance();" + NL + "\t\t\tcalendar_";
  protected final String TEXT_188 = ".set(0, 0, 0, 0, 0, 0);" + NL + "\t\t\tjava.util.Date year0_";
  protected final String TEXT_189 = " = calendar_";
  protected final String TEXT_190 = ".getTime();";
  ...
  protected final String TEXT_204 = NL + "\t\t\t\t((com.mysql.jdbc.Statement)stmt_";
  protected final String TEXT_205 = ").enableStreamingResults();";
  protected final String TEXT_206 = NL + "\t\t\tif(rs_";
  protected final String TEXT_207 = ".getString(";
  protected final String TEXT_208 = ") != null) {" + NL + "\t\t\t\tString dateString_";
  protected final String TEXT_209 = " = rs_";
  protected final String TEXT_210 = ".getString(";
  protected final String TEXT_211 = ");" + NL + "\t\t\t\tif (!(\"0000-00-00\").equals(dateString_";
  protected final String TEXT_212 = ") && !(\"0000-00-00 00:00:00\").equals(dateString_";
