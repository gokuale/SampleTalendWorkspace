...
public class TOracleValidRowsEndJava
{
  protected static String nl;
  public static synchronized TOracleValidRowsEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleValidRowsEndJava result = new TOracleValidRowsEndJava();
    nl = null;
    return result;
  }
