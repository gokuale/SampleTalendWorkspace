...
public class TOracleCDCOutputEndJava
{
  protected static String nl;
  public static synchronized TOracleCDCOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleCDCOutputEndJava result = new TOracleCDCOutputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_73 = NL + "\t\txStreamIn_";
  protected final String TEXT_74 = ".detach(oracle.streams.XStreamIn.DEFAULT_MODE);" + NL + "\t\t";
  protected final String TEXT_75 = NL + "\t} catch (oracle.streams.StreamsException e_";
  protected final String TEXT_76 = ") {" + NL + "\t\tSystem.err.println(\"Cannot detach from the inbound server: \"+ ";
  ...
  public String generate(Object argument)
  {
    ...
    stringBuffer.append(TEXT_72);
    	...
    	log4jCodeGenerateUtil.logInfo(node,"info",cid+" - Try to detach from inbound server:\"+"+ inBoundServer+"+\"");
    ...
    stringBuffer.append(TEXT_77);
		...
		log4jCodeGenerateUtil.logInfo(node,"error",cid+" - Cannot detach from the inbound server: \"+"+ inBoundServer+"+\"");
