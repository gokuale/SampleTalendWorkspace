...
public class TAS400CDCEndJava
{
  protected static String nl;
  public static synchronized TAS400CDCEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAS400CDCEndJava result = new TAS400CDCEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_71 = NL + NL + "\tString truncateAction_";
  protected final String TEXT_72 = " = \"CLRPFM FILE(\"+";
  protected final String TEXT_73 = "+\"/\"+";
  protected final String TEXT_74 = "+\")\";" + NL + "\t";
  protected final String TEXT_75 = NL + "\tcom.ibm.as400.access.CommandCall command_";
  protected final String TEXT_76 = " = new com.ibm.as400.access.CommandCall(as400_";
  protected final String TEXT_77 = ", truncateAction_";
  protected final String TEXT_78 = ");" + NL + "\tif (!command_";
  protected final String TEXT_79 = ".run()) {" + NL + "\t\tSystem.err.println(\"fail when execute command : \" + truncateAction_";
  protected final String TEXT_80 = ");" + NL + "\t\t";
  protected final String TEXT_81 = NL + "\t}else{" + NL + "\t\t";
  protected final String TEXT_82 = NL + "\t}" + NL + "\t" + NL + "\tfor (com.ibm.as400.access.AS400Message msg_";
  protected final String TEXT_83 = " : command_";
  protected final String TEXT_84 = ".getMessageList()) {" + NL + "\t\tSystem.out.println(\" msg: \" + msg_";
  protected final String TEXT_85 = ".getID() + \": \" + msg_";
  protected final String TEXT_86 = ".getText());" + NL + "\t\t";
  protected final String TEXT_87 = NL + "\t}";
  protected final String TEXT_88 = NL + "\tqueryUpdatePrefix_";
  protected final String TEXT_89 = "= \"UPDATE \"+dataTableName_";
  protected final String TEXT_90 = "+\" SET TALEND_CDC_STATE='x' WHERE TALEND_CDC_STATE='1' AND TALEND_CDC_SUBSCRIBERS_NAME='\"+";
  protected final String TEXT_91 = "+\"'\";" + NL + "\t";
  protected final String TEXT_92 = NL + "\tstmt_";
  protected final String TEXT_93 = ".executeUpdate(queryUpdatePrefix_";
  protected final String TEXT_94 = "+queryLockUpdate_";
  protected final String TEXT_95 = ");";
  protected final String TEXT_96 = NL + "\tString queryResetLocks_";
  protected final String TEXT_97 = " = \"DELETE FROM \"+dataTableName_";
  protected final String TEXT_98 = " +\" WHERE TALEND_CDC_SUBSCRIBERS_NAME='\"+";
  protected final String TEXT_99 = "+\"' AND TALEND_CDC_STATE='1'\";" + NL + "\t";
  protected final String TEXT_100 = NL + "\tstmt_";
  protected final String TEXT_101 = ".executeUpdate(queryResetLocks_";
  protected final String TEXT_102 = ");" + NL + "\t";
  protected final String TEXT_103 = NL;
  protected final String TEXT_104 = NL + "as400_";
  protected final String TEXT_105 = ".disconnectAllServices();";
  protected final String TEXT_106 = NL + NL + "stmt_";
  ...
  public String generate(Object argument)
  {
    ...
    log4jCodeGenerateUtil.logInfo(node,"info",cid+" - Executing Command:\"+truncateAction_"+cid+"+\"");
