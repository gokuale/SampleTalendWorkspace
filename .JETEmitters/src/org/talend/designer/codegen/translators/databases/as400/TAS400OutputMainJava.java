...
public class TAS400OutputMainJava {
  ...
  protected final String TEXT_383 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  ...
  protected final String TEXT_438 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_488 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_536 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_537 = ",";
  protected final String TEXT_538 = ".";
  protected final String TEXT_539 = ", ";
  protected final String TEXT_540 = ",insertSQLSplits_";
  ...
  protected final String TEXT_549 = "_QUERY\", query_";
  protected final String TEXT_550 = ".toString().trim());";
  protected final String TEXT_551 = NL + "    \t\t";
  protected final String TEXT_552 = NL + "    \t\tpstmt_";
  protected final String TEXT_553 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_554 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_555 = NL + "    \t\t  \tbatchSizeCounter_";
  ...
  protected final String TEXT_562 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_577 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_578 = NL + "                        ";
  protected final String TEXT_579 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_580 = ";";
  protected final String TEXT_581 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  ...
  protected final String TEXT_587 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_588 = ",";
  protected final String TEXT_589 = ".";
  protected final String TEXT_590 = ", ";
  protected final String TEXT_591 = ",updateSQLSplits_";
  protected final String TEXT_592 = ");";
  protected final String TEXT_593 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_594 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_623 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_624 = "++;" + NL + "\t\t\t";
  protected final String TEXT_625 = NL + "\t\t\tbatchSizeCounter_";
  protected final String TEXT_626 = "++;" + NL + "    \t\t";
  protected final String TEXT_627 = NL + "             try {" + NL + "                nb_line_";
  protected final String TEXT_628 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_629 = " = updatedCount_";
  protected final String TEXT_630 = " + pstmt_";
  protected final String TEXT_631 = ".executeUpdate();";
  protected final String TEXT_632 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  protected final String TEXT_633 = " = true;";
  protected final String TEXT_634 = NL + "                    throw(e);";
  protected final String TEXT_635 = NL + "                        ";
  protected final String TEXT_636 = " = new ";
  protected final String TEXT_637 = "Struct();";
  protected final String TEXT_638 = NL + "                            ";
  protected final String TEXT_639 = ".";
  protected final String TEXT_640 = " = ";
  protected final String TEXT_641 = ".";
  protected final String TEXT_642 = ";";
  protected final String TEXT_643 = NL + "                        rejectedCount_";
  protected final String TEXT_644 = " = rejectedCount_";
  protected final String TEXT_645 = " + 1;";
  protected final String TEXT_646 = NL + "                        ";
  protected final String TEXT_647 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_648 = NL + "                        ";
  protected final String TEXT_649 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_650 = ";";
  protected final String TEXT_651 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_652 = NL + "            }";
  protected final String TEXT_653 = NL + "                    \t";
  protected final String TEXT_654 = NL + "                    ";
  protected final String TEXT_655 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_656 = " = pstmt_";
  protected final String TEXT_657 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_658 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_659 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_660 = " = rs_";
  protected final String TEXT_661 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_662 = " > 0) {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_673 = NL + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_674 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_675 = ".";
  protected final String TEXT_676 = ", pstmtUpdate_";
  ...
  protected final String TEXT_701 = NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_702 = " = updatedCount_";
  protected final String TEXT_703 = " + pstmtUpdate_";
  protected final String TEXT_704 = ".executeUpdate();" + NL + "        \t\t\tnb_line_";
  protected final String TEXT_705 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_706 = NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_723 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_724 = NL + "                            ";
  protected final String TEXT_725 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_726 = ";";
  protected final String TEXT_727 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_728 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  protected final String TEXT_729 = NL + "                        ";
  protected final String TEXT_730 = NL + "                            query_";
  protected final String TEXT_731 = " = ";
  protected final String TEXT_732 = ";";
  protected final String TEXT_733 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_734 = ",";
  protected final String TEXT_735 = ".";
  protected final String TEXT_736 = ", ";
  protected final String TEXT_737 = ",insertSQLSplits_";
  protected final String TEXT_738 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_739 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_750 = " + pstmtInsert_";
  protected final String TEXT_751 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_752 = "++;";
  protected final String TEXT_753 = NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  protected final String TEXT_754 = " = true;";
  protected final String TEXT_755 = NL + "                        throw(e);";
  protected final String TEXT_756 = NL + "                \t\tnb_line_";
  ...
  protected final String TEXT_774 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_775 = NL + "                }" + NL + "    \t\t}" + NL + "" + NL + "    \t\t";
  protected final String TEXT_776 = NL + "    \t    int updateFlag_";
  protected final String TEXT_777 = "=0;" + NL + "            try {" + NL + "    \t    ";
  ...
  protected final String TEXT_788 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_789 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_790 = ".";
  protected final String TEXT_791 = ", pstmtUpdate_";
  ...
  protected final String TEXT_807 = NL + "\t\t\t\t\t\tquery_";
  ...
  protected final String TEXT_813 = NL + "                globalMap.put(\"";
  protected final String TEXT_814 = "_QUERY\", query_";
  protected final String TEXT_815 = ".toString().trim());";
  protected final String TEXT_816 = NL + "                updateFlag_";
  protected final String TEXT_817 = "=pstmtUpdate_";
  protected final String TEXT_818 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_819 = " = updatedCount_";
  protected final String TEXT_820 = "+updateFlag_";
  protected final String TEXT_821 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_822 = " == 0) {" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_823 = NL + "\t\t\t\tquery_";
  protected final String TEXT_824 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_825 = NL + "                        ";
  protected final String TEXT_826 = NL + "                            query_";
  protected final String TEXT_827 = " = ";
  protected final String TEXT_828 = ";";
  protected final String TEXT_829 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_830 = ",";
  protected final String TEXT_831 = ".";
  protected final String TEXT_832 = ", ";
  protected final String TEXT_833 = ",insertSQLSplits_";
  protected final String TEXT_834 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_835 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_836 = ".";
  protected final String TEXT_837 = ", pstmtInsert_";
  protected final String TEXT_838 = ", ";
  protected final String TEXT_839 = ", \"";
  protected final String TEXT_840 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_841 = NL + "                    globalMap.put(\"";
  protected final String TEXT_842 = "_QUERY\", query_";
  protected final String TEXT_843 = ".toString().trim());";
  protected final String TEXT_844 = NL + "                    insertedCount_";
  protected final String TEXT_845 = " = insertedCount_";
  protected final String TEXT_846 = " + pstmtInsert_";
  protected final String TEXT_847 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_848 = "++;";
  protected final String TEXT_849 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_850 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_851 = NL + "    \t\t\t}" + NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_872 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  ...
  protected final String TEXT_887 = NL + "    \t\tpstmt_";
  protected final String TEXT_888 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_889 = "++;" + NL + "\t\t\t";
  protected final String TEXT_890 = NL + "   \t\t\tbatchSizeCounter_";
  protected final String TEXT_891 = "++;" + NL + "   \t\t   ";
  protected final String TEXT_892 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_893 = " = deletedCount_";
  ...
  protected final String TEXT_897 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_918 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  ...
  protected final String TEXT_934 = ")) {" + NL + "    \t\t\t    try {" + NL + "    \t\t\t    \t";
  protected final String TEXT_935 = NL + "                            pstmt_";
  protected final String TEXT_936 = ".executeBatch();";
  ...
  protected final String TEXT_940 = ".executeBatch()) {" + NL + "                                countSum_";
  ...
  protected final String TEXT_950 = NL + "                    }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_951 = "){";
  protected final String TEXT_952 = NL + "                            throw(e_";
  protected final String TEXT_953 = ");";
  protected final String TEXT_954 = NL + "                                int countSum_";
  protected final String TEXT_955 = " = 0;" + NL + "                                for(int countEach_";
  protected final String TEXT_956 = ": e_";
  protected final String TEXT_957 = ".getUpdateCounts()) {" + NL + "                                    countSum_";
  protected final String TEXT_958 = " += (countEach_";
  protected final String TEXT_959 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_967 = NL + "                            System.err.println(e_";
  protected final String TEXT_968 = ".getMessage());";
  protected final String TEXT_969 = NL + "                    }";
  protected final String TEXT_970 = NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_971 = " = pstmt_";
  protected final String TEXT_972 = ".getUpdateCount();" + NL + "                        insertedCount_";
  protected final String TEXT_973 = "+= (tmp_batchUpdateCount_";
  protected final String TEXT_974 = " >0 ? tmp_batchUpdateCount_";
  ...
  protected final String TEXT_978 = NL + "                    commitCounter_";
  protected final String TEXT_979 = "++;" + NL + "                    if(commitEvery_";
  protected final String TEXT_980 = " <= commitCounter_";
  protected final String TEXT_981 = ") {" + NL + "\t                ";
  protected final String TEXT_982 = NL + "\t                if(batchSizeCounter_";
  protected final String TEXT_983 = " > 0){" + NL + "    \t                try {" + NL + "    \t                \t";
  protected final String TEXT_984 = NL + "                                pstmt_";
  protected final String TEXT_985 = ".executeBatch();";
  protected final String TEXT_986 = NL + "                                int countSum_";
  protected final String TEXT_987 = " = 0;" + NL + "                                for(int countEach_";
  ...
  protected final String TEXT_999 = NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1000 = "){";
  protected final String TEXT_1001 = NL + "                                throw(e_";
  protected final String TEXT_1002 = ");";
  protected final String TEXT_1003 = NL + "                                    int countSum_";
  protected final String TEXT_1004 = " = 0;" + NL + "                                    for(int countEach_";
  protected final String TEXT_1005 = ": e_";
  protected final String TEXT_1006 = ".getUpdateCounts()) {" + NL + "                                        countSum_";
  ...
  protected final String TEXT_1010 = NL + "                                    updatedCount_";
  ...
  protected final String TEXT_1016 = NL + "                                System.err.println(e_";
  protected final String TEXT_1017 = ".getMessage());";
  protected final String TEXT_1018 = NL + "                        }";
  protected final String TEXT_1019 = NL + "                            tmp_batchUpdateCount_";
  protected final String TEXT_1020 = " = pstmt_";
  protected final String TEXT_1021 = ".getUpdateCount();" + NL + "                            insertedCount_";
  protected final String TEXT_1022 = "+= (tmp_batchUpdateCount_";
  protected final String TEXT_1023 = " >0 ? tmp_batchUpdateCount_";
  protected final String TEXT_1024 = ":0);";
  protected final String TEXT_1025 = NL + "                        batchSizeCounter_";
  protected final String TEXT_1026 = " = 0;" + NL + "                    }" + NL + "\t                ";
  protected final String TEXT_1027 = NL + "\t                \t";
  protected final String TEXT_1028 = NL + "                        conn_";
  protected final String TEXT_1029 = ".commit();";
  protected final String TEXT_1030 = NL + "                        commitCounter_";
