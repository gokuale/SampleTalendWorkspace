...
public class TSAPBapiEndJava
{
  protected static String nl;
  public static synchronized TSAPBapiEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPBapiEndJava result = new TSAPBapiEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_42 = NL + "\t" + NL + "\t} finally {" + NL + "\t\t";
  protected final String TEXT_43 = NL + "\t\tif(connection_";
  protected final String TEXT_44 = "!=null && connection_";
  protected final String TEXT_45 = ".isAlive()) {" + NL + "\t\t\t";
