...
public class TMysqlOutputSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TMysqlOutputSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMysqlOutputSparkstreamingcodeJava result = new TMysqlOutputSparkstreamingcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_9 = "_OutputFunction(JobConf conf) throws ClassNotFoundException, java.sql.SQLException {" + NL + "                    Class.forName(\"org.gjt.mm.mysql.Driver\");" + NL + "                    context = new ContextProperties(conf);" + NL + "                }" + NL + "" + NL + "                public void call(java.util.Iterator<";
  ...
  protected final String TEXT_11 = ");" + NL + "                    java.sql.PreparedStatement statement = connection.prepareStatement(\"INSERT INTO \" + ";
