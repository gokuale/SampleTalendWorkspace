...
public class TAS400OutputBeginJava {
  ...
  protected final String TEXT_330 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_341 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_363 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_377 = NL + "                              stmtTruncCount_";
  protected final String TEXT_378 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_379 = "));";
  protected final String TEXT_380 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_381 = " = stmtTruncCount_";
  protected final String TEXT_382 = ".executeQuery(\"";
  protected final String TEXT_383 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_384 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_385 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_389 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_400 = NL + "                if(!conn_";
  protected final String TEXT_401 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_402 = ".commit();" + NL + "                }";
  protected final String TEXT_403 = NL + "            deletedCount_";
  protected final String TEXT_404 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_417 = NL + "            stmtTrunc_";
  protected final String TEXT_418 = ".executeUpdate(\"";
  protected final String TEXT_419 = "\");";
  protected final String TEXT_420 = NL + "            while(rsTruncCount_";
  protected final String TEXT_421 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_422 = " += rsTruncCount_";
  protected final String TEXT_423 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_424 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_425 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_426 = ".close();";
  protected final String TEXT_427 = NL + "\t    String insert_";
  protected final String TEXT_428 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_433 = ".prepareStatement(insert_";
  protected final String TEXT_434 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  protected final String TEXT_435 = NL + "\t    String update_";
  protected final String TEXT_436 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_445 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_446 = " + \" WHERE ";
  protected final String TEXT_447 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_448 = " = \"INSERT INTO \" + ";
  protected final String TEXT_449 = " + \" (";
  protected final String TEXT_450 = ") VALUES (";
  protected final String TEXT_451 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_455 = " = \"UPDATE \" + ";
  protected final String TEXT_456 = " + \" SET ";
  protected final String TEXT_457 = " WHERE ";
  protected final String TEXT_458 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_462 = NL + "\t    String update_";
  protected final String TEXT_463 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_470 = " = \"INSERT INTO \" + ";
  protected final String TEXT_471 = " + \" (";
  protected final String TEXT_472 = ") VALUES (";
  protected final String TEXT_473 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_477 = NL + "\t    String delete_";
  protected final String TEXT_478 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_482 = ".prepareStatement(delete_";
  protected final String TEXT_483 = ");" + NL + "\t    ";
  protected final String TEXT_484 = NL + "        StringBuffer query_";
  protected final String TEXT_485 = " = null;" + NL + "       \t";
  protected final String TEXT_486 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_487 = " = insert_";
  protected final String TEXT_488 = ".split(\"\\\\?\");";
  protected final String TEXT_489 = NL + "\t\t\tupdate_";
  protected final String TEXT_490 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_491 = " = update_";
  protected final String TEXT_492 = ".split(\"\\\\?\");";
  protected final String TEXT_493 = NL + "\t\t\tupdate_";
  protected final String TEXT_494 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_495 = " = update_";
  protected final String TEXT_496 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_497 = " = insert_";
  protected final String TEXT_498 = ".split(\"\\\\?\");";
  protected final String TEXT_499 = NL + "\t\t\tdelete_";
  protected final String TEXT_500 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_501 = " = delete_";
  protected final String TEXT_502 = ".split(\"\\\\?\");";
  protected final String TEXT_503 = NL + "\t\t\treplace_";
  protected final String TEXT_504 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_505 = " = replace_";
  protected final String TEXT_506 = ".split(\"\\\\?\");";
  protected final String TEXT_507 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_508 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_509 = " = insertIgnore_";
  protected final String TEXT_510 = ".split(\"\\\\?\");";
  protected final String TEXT_511 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_512 = " = insert_";
  protected final String TEXT_513 = ".split(\"\\\\?\");";
  protected final String TEXT_514 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_515 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_516 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_525 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_526 = " = null;";
  protected final String TEXT_527 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_528 = " = null;";
  protected final String TEXT_529 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_530 = " = null;";
  protected final String TEXT_531 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_532 = " = null;";
  protected final String TEXT_533 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_534 = " = null;";
  protected final String TEXT_535 = NL + NL + NL;
