...
public class TVerticaOutputBeginJava {
  ...
  protected final String TEXT_451 = NL + "\t\t\t\tjava.sql.Statement stmtCreateProjection_";
  protected final String TEXT_452 = " = conn_";
  protected final String TEXT_453 = ".createStatement();" + NL + "\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_454 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_455 = " + \"_proj (";
  protected final String TEXT_456 = ") AS SELECT ";
  protected final String TEXT_457 = " FROM \" + tableName_";
  protected final String TEXT_458 = ");" + NL + "\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_459 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_460 = NL + "\t\t\t\tif(!whetherExist_";
  ...
  protected final String TEXT_471 = NL + "        int batchCount_";
  ...
  protected final String TEXT_483 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_484 = " + \" WHERE ";
  ...
  protected final String TEXT_511 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_512 = " = conn_";
  protected final String TEXT_513 = ".prepareStatement(insert_";
  protected final String TEXT_514 = ");";
  protected final String TEXT_515 = NL + "        String delete_";
  protected final String TEXT_516 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_520 = ".prepareStatement(delete_";
  protected final String TEXT_521 = ");";
  protected final String TEXT_522 = NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_523 = " = new StringBuilder();" + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_524 = " = conn_";
  protected final String TEXT_525 = ".createStatement();" + NL + "        String template_";
  protected final String TEXT_526 = " = \"COPY \" + tableName_";
  protected final String TEXT_527 = " +\" (";
  protected final String TEXT_528 = ")\"" + NL + "\t\t\t\t\t\t          + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
  protected final String TEXT_529 = "DIRECT";
  protected final String TEXT_530 = "\";" + NL + "\t\t";
  protected final String TEXT_531 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_537 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  ...
  protected final String TEXT_543 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_551 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_555 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_562 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_563 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_572 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_576 = NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_582 = NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_583 = " = null;" + NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_584 = " = null;" + NL + "\t\tString template_";
