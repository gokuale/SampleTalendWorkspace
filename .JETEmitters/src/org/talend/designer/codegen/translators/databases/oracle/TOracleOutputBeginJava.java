...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_381 = ".equalsIgnoreCase(";
  protected final String TEXT_382 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_383 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_418 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_438 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_439 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_440 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_449 = NL + "            stmtClear_";
  ...
  protected final String TEXT_454 = NL + "                              stmtTruncCount_";
  protected final String TEXT_455 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_456 = "));";
  protected final String TEXT_457 = NL + "            java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_461 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_462 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_463 = " = rsTruncCount_";
  protected final String TEXT_464 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_465 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_466 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_472 = NL + "                conn_";
  protected final String TEXT_473 = ".commit();";
  protected final String TEXT_474 = NL + "            stmtTrunc_";
  protected final String TEXT_475 = ".executeUpdate(\"";
  protected final String TEXT_476 = "\");";
  protected final String TEXT_477 = NL + "                if(!conn_";
  protected final String TEXT_478 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_479 = ".commit();" + NL + "                }";
  protected final String TEXT_480 = NL + "            deletedCount_";
  protected final String TEXT_481 = " += rsTruncCountNumber_";
  protected final String TEXT_482 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_483 = ".close();";
  protected final String TEXT_484 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_485 = " = conn_";
  protected final String TEXT_486 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_487 = " = stmtTruncCount_";
  protected final String TEXT_488 = ".executeQuery(\"";
  protected final String TEXT_489 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_490 = " = conn_";
  protected final String TEXT_491 = ".createStatement();";
  ...
  protected final String TEXT_497 = NL + "            while(rsTruncCount_";
  protected final String TEXT_498 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_499 = " += rsTruncCount_";
  protected final String TEXT_500 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_501 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_502 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_536 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_537 = " = new StringBuffer(update_";
  protected final String TEXT_538 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_539 = ".insert(update_";
  protected final String TEXT_540 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_541 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_542 = " =updateStringBuffer_";
  ...
  protected final String TEXT_557 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_558 = " = new StringBuffer(insert_";
  protected final String TEXT_559 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_560 = ".insert(insert_";
  protected final String TEXT_561 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_562 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_563 = " =insertStringBuffer_";
  ...
  protected final String TEXT_567 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_581 = NL + "                java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_598 = NL + "                java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_614 = "    " + NL + "                java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_622 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_623 = " = new StringBuffer(delete_";
  protected final String TEXT_624 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_625 = ".insert(delete_";
  protected final String TEXT_626 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_627 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_628 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_632 = ".prepareStatement(delete_";
  protected final String TEXT_633 = ");";
  protected final String TEXT_634 = NL + "                StringBuffer query_";
  protected final String TEXT_635 = " = null;";
  protected final String TEXT_636 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_637 = " = insert_";
  protected final String TEXT_638 = ".split(\"\\\\?\");";
  protected final String TEXT_639 = NL + "\t\t\tupdate_";
  protected final String TEXT_640 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  ...
  protected final String TEXT_646 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_647 = " = insert_";
  protected final String TEXT_648 = ".split(\"\\\\?\");";
  protected final String TEXT_649 = NL + "\t\t\tdelete_";
  protected final String TEXT_650 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_651 = " = delete_";
  protected final String TEXT_652 = ".split(\"\\\\?\");";
  protected final String TEXT_653 = NL + "\t\t\treplace_";
  protected final String TEXT_654 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_655 = " = replace_";
  protected final String TEXT_656 = ".split(\"\\\\?\");";
  protected final String TEXT_657 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_658 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_659 = " = insertIgnore_";
  protected final String TEXT_660 = ".split(\"\\\\?\");";
  protected final String TEXT_661 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_662 = " = insert_";
  protected final String TEXT_663 = ".split(\"\\\\?\");";
  protected final String TEXT_664 = NL + "                // Initialize SRID" + NL + "                int SRID_";
  protected final String TEXT_665 = " = 0;" + NL + "                int dimension_";
  protected final String TEXT_666 = " = 0;" + NL + "                boolean firstGeometry_";
  protected final String TEXT_667 = " = true;";
  protected final String TEXT_668 = NL + NL + "        class ClobTypeUtil_";
  protected final String TEXT_669 = " {" + NL + "            public Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "                oracle.sql.CLOB tempClob = null;" + NL + "                try{" + NL + "                    // If the temporary CLOB has not yet been created, create one" + NL + "                    tempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "                    // Open the temporary CLOB in readwrite mode, to enable writing" + NL + "                    tempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "                    // Get the output stream to write" + NL + "                    java.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "                    if(data instanceof java.sql.Clob) {" + NL + "                        java.sql.Clob inClob = (java.sql.Clob) data;" + NL + "                        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "                        char[] chs = new char[128];" + NL + "                        int len = 0;" + NL + "                        while ((len = inReader.read(chs)) != -1) {" + NL + "                            tempClobWriter.write(chs, 0, len);" + NL + "                        }" + NL + "                    }else if(data instanceof String) {" + NL + "                       // Write the data into the temporary CLOB" + NL + "                        tempClobWriter.write((String)data);" + NL + "                    }else{" + NL + "                        return data;" + NL + "                    }" + NL + "                    // Flush and close the stream" + NL + "                    tempClobWriter.flush();" + NL + "                    tempClobWriter.close();" + NL + "                    // Close the temporary CLOB" + NL + "                    tempClob.close();" + NL + "                } catch( java.sql.SQLException sqlexp){";
  protected final String TEXT_670 = NL + "                    tempClob.freeTemporary();" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_671 = NL + "                    tempClob.freeTemporary();" + NL + "                    exp.printStackTrace();" + NL + "                }" + NL + "                return tempClob;" + NL + "            }" + NL + "        }" + NL + "        ClobTypeUtil_";
  protected final String TEXT_672 = " clobTypeUtil_";
  protected final String TEXT_673 = "=new ClobTypeUtil_";
  protected final String TEXT_674 = "();";
  protected final String TEXT_675 = NL + NL + "        class BlobTypeUtil_";
  protected final String TEXT_676 = " {" + NL + "            public Object getBLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException {" + NL + "                if(!(data instanceof java.sql.Blob) || (data instanceof oracle.sql.BLOB)) {" + NL + "                \treturn data;" + NL + "                }" + NL + "" + NL + "                oracle.sql.BLOB blob = null;" + NL + "                java.io.InputStream in = null;" + NL + "                java.io.OutputStream out = null;" + NL + "                try{" + NL + "                \t//in" + NL + "                \tjava.sql.Blob blobData = (java.sql.Blob) data;" + NL + "                \tin = blobData.getBinaryStream();" + NL + "" + NL + "                \t//out" + NL + "                \tblob = oracle.sql.BLOB.createTemporary(conn, true, oracle.sql.BLOB.DURATION_SESSION);" + NL + "                    blob.open(oracle.sql.BLOB.MODE_READWRITE);" + NL + "                    //blob = conn.createBlob(); oracle jdbc don't support it" + NL + "                \tout = blob.setBinaryStream(1);" + NL + "" + NL + "                    byte[] cache = new byte[8192];" + NL + "                    int len = 0;" + NL + "                    while ((len = in.read(cache)) != -1) {" + NL + "                        out.write(cache, 0, len);" + NL + "                    }" + NL + "" + NL + "                    return blob;" + NL + "                } catch(java.sql.SQLException sqlexp){";
  protected final String TEXT_677 = NL + "                \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_678 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_679 = NL + "                   \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_680 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    exp.printStackTrace();" + NL + "                } finally {" + NL + "                \tif(out!=null) {" + NL + "                \t\ttry {" + NL + "                \t\t\tout.flush();" + NL + "                    \t\tout.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_681 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "            \t \tif(in!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tin.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_682 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "                    if(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.close();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_683 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "" + NL + "                return null;" + NL + "" + NL + "            }" + NL + "" + NL + "        }" + NL + "        BlobTypeUtil_";
  protected final String TEXT_684 = " blobTypeUtil_";
  protected final String TEXT_685 = "=new BlobTypeUtil_";
  protected final String TEXT_686 = "();";
  protected final String TEXT_687 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_688 = " =null;" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_689 = " =null;" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_690 = " =null;";
  protected final String TEXT_691 = NL + "            StringBuffer query_";
  ...
  protected final String TEXT_697 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_698 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_699 = " = null;";
  protected final String TEXT_700 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_701 = " = null;";
  protected final String TEXT_702 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_703 = " = null;";
  protected final String TEXT_704 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_708 = NL + NL + NL + NL;
