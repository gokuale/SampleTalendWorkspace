...
public class TTeradataOutputSparkstreamingconfigJava {
  protected static String nl;
  public static synchronized TTeradataOutputSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataOutputSparkstreamingconfigJava result = new TTeradataOutputSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_45 = NL + "int deletedCount_";
  protected final String TEXT_46 = " = 0;" + NL + "String dbUser_";
  protected final String TEXT_47 = " = ";
  protected final String TEXT_48 = ";" + NL + "String dbschema_";
  protected final String TEXT_49 = " = ";
  protected final String TEXT_50 = ";" + NL + "String tableName_";
  protected final String TEXT_51 = ";" + NL + "if(dbschema_";
  ...
  protected final String TEXT_58 = ";" + NL + "}" + NL + "Class.forName(\"com.teradata.jdbc.TeraDriver\");" + NL + "java.sql.Connection conn_";
  protected final String TEXT_59 = " = java.sql.DriverManager.getConnection(";
  ...
  protected final String TEXT_65 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  protected final String TEXT_66 = ")));";
  protected final String TEXT_67 = NL + "            stmtDrop_";
  protected final String TEXT_68 = ".execute(\"";
  protected final String TEXT_69 = "\" ";
  protected final String TEXT_70 = ");";
  protected final String TEXT_71 = NL + "            stmtDrop_";
  protected final String TEXT_72 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_73 = " = conn_";
  protected final String TEXT_74 = ".createStatement();";
  protected final String TEXT_75 = NL + "                              stmtCreate_";
  protected final String TEXT_76 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_96 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_97 = "));";
  protected final String TEXT_98 = NL + "                    stmtCreate_";
  protected final String TEXT_99 = ".execute(((\"";
  protected final String TEXT_100 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_101 = ".";
  protected final String TEXT_102 = ", \"";
  protected final String TEXT_103 = "\")";
  protected final String TEXT_104 = ".toUpperCase()";
  ...
  protected final String TEXT_113 = NL + "                    String keyCheckTable_";
  protected final String TEXT_114 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_115 = "+\"][\"+";
  protected final String TEXT_116 = "+\"][\"+";
  protected final String TEXT_117 = "+\"][\"+";
  protected final String TEXT_118 = "+\"][\"+";
  protected final String TEXT_119 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_120 = " + \"]\";";
  protected final String TEXT_121 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_122 = " = conn_";
  protected final String TEXT_123 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_124 = " + \"]\";";
  protected final String TEXT_125 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_126 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_127 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_128 = ")== null){//}";
  protected final String TEXT_129 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_130 = " = conn_";
  protected final String TEXT_131 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_132 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_133 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_134 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_135 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_136 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_141 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_142 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_143 = " = tableNameForSearch_";
  protected final String TEXT_144 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_145 = " = tableNameForSearch_";
  protected final String TEXT_146 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_147 = " = dbMetaData_";
  protected final String TEXT_148 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_149 = ", tableNameForSearch_";
  protected final String TEXT_150 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_151 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_152 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_153 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_185 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_186 = " = rsTable_";
  protected final String TEXT_187 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  ...
  protected final String TEXT_198 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_199 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_200 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_201 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_207 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_208 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_209 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_210 = " == null || dbschema_";
  protected final String TEXT_211 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_212 = " = conn_";
  protected final String TEXT_213 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_214 = " = stmtSchema_";
  protected final String TEXT_215 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_216 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_217 = " = rsSchema_";
  protected final String TEXT_218 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_219 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_220 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_235 = ".trim().length() ==0) && defaultSchema_";
  ...
  protected final String TEXT_308 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_309 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_310 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_316 = NL + "            stmtClear_";
  ...
  protected final String TEXT_324 = NL + "                              stmtTruncCount_";
  protected final String TEXT_325 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_326 = "));";
  protected final String TEXT_327 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_328 = " = stmtTruncCount_";
  protected final String TEXT_329 = ".executeQuery(\"";
  protected final String TEXT_330 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_331 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_332 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_336 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_343 = ".commit();";
  protected final String TEXT_344 = NL + "            stmtTrunc_";
  protected final String TEXT_345 = ".executeUpdate(\"";
  protected final String TEXT_346 = "\");";
  protected final String TEXT_347 = NL + "                if(!conn_";
  protected final String TEXT_348 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_349 = ".commit();" + NL + "                }";
  protected final String TEXT_350 = NL + "            deletedCount_";
  protected final String TEXT_351 = " += rsTruncCountNumber_";
  protected final String TEXT_352 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_353 = ".close();";
  protected final String TEXT_354 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_355 = " = conn_";
  protected final String TEXT_356 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_357 = " = stmtTruncCount_";
  protected final String TEXT_358 = ".executeQuery(\"";
  protected final String TEXT_359 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_367 = NL + "            while(rsTruncCount_";
  protected final String TEXT_368 = ".next()) {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_372 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_373 = ".close();";
  protected final String TEXT_374 = NL + NL + "conn_";
  protected final String TEXT_375 = ".close();" + NL;
  protected final String TEXT_376 = NL + "rdd_";
  protected final String TEXT_377 = ".foreachRDD(new org.apache.spark.api.java.function.Function<org.apache.spark.api.java.JavaRDD<";
  protected final String TEXT_378 = ">, Void>() {" + NL + "\t@Override" + NL + "    public Void call(org.apache.spark.api.java.JavaRDD<";
  protected final String TEXT_379 = "> current_rdd) throws Exception {" + NL + "    \tcurrent_rdd.foreachPartition(new ";
  protected final String TEXT_380 = "_OutputFunction(job));" + NL + "        return null;" + NL + "\t}" + NL + "});";
...
if(columnList != null && columnList.size() > 0) {
    ...
    stringBuffer.append(storage.getUser());
    stringBuffer.append(TEXT_48);
    stringBuffer.append(cid);
    stringBuffer.append(TEXT_49);
    stringBuffer.append(storage.getDBName());
