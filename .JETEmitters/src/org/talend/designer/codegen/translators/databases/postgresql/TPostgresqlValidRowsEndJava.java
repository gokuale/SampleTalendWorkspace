...
public class TPostgresqlValidRowsEndJava
{
  protected static String nl;
  public static synchronized TPostgresqlValidRowsEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresqlValidRowsEndJava result = new TPostgresqlValidRowsEndJava();
    nl = null;
    return result;
  }
