...
public class TMSSqlOutputMainJava {
  ...
  protected final String TEXT_357 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_358 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_359 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_360 = " = rsTable_";
  protected final String TEXT_361 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_362 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_388 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_399 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_407 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_432 = NL + "            java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_438 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_439 = " = stmtTruncCount_";
  protected final String TEXT_440 = ".executeQuery(\"";
  protected final String TEXT_441 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_442 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_443 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_447 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_458 = NL + "                if(!conn_";
  protected final String TEXT_459 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_460 = ".commit();" + NL + "                }";
  protected final String TEXT_461 = NL + "            deletedCount_";
  protected final String TEXT_462 = " += rsTruncCountNumber_";
  protected final String TEXT_463 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_464 = ".close();";
  protected final String TEXT_465 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_466 = " = conn_";
  protected final String TEXT_467 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_468 = " = stmtTruncCount_";
  protected final String TEXT_469 = ".executeQuery(\"";
  protected final String TEXT_470 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_471 = " = conn_";
  protected final String TEXT_472 = ".createStatement();";
  protected final String TEXT_473 = NL + "                conn_";
  protected final String TEXT_474 = ".commit();";
  protected final String TEXT_475 = NL + "            stmtTrunc_";
  protected final String TEXT_476 = ".executeUpdate(\"";
  protected final String TEXT_477 = "\");";
  protected final String TEXT_478 = NL + "            while(rsTruncCount_";
  protected final String TEXT_479 = ".next()) {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_483 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_484 = ".close();";
  ...
  protected final String TEXT_514 = " = null;" + NL + "        // [%connection%][psmt][tableName]" + NL + "        String keyPsmt_";
  protected final String TEXT_515 = " = conn_";
  protected final String TEXT_516 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_517 = " + \"]\";" + NL + "\t\tif(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_518 = ")== null){" + NL + "\t\t\tpstmt_";
  protected final String TEXT_519 = " = conn_";
  protected final String TEXT_520 = ".prepareStatement(insert_";
  protected final String TEXT_521 = ");" + NL + "\t\t\tGlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_522 = ", pstmt_";
  protected final String TEXT_523 = ");" + NL + "\t\t}else{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_524 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_561 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_583 = "\");" + NL + "        pstmtInsert_";
  protected final String TEXT_584 = " = conn_";
  protected final String TEXT_585 = ".prepareStatement(insert_";
  protected final String TEXT_586 = ");" + NL + "        pstmtUpdate_";
  ...
  protected final String TEXT_593 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_594 = ".";
  protected final String TEXT_595 = ", \"";
  protected final String TEXT_596 = "\")+\") VALUES (";
  protected final String TEXT_597 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_598 = ".";
  protected final String TEXT_599 = ")+\")\";";
  protected final String TEXT_600 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_601 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_602 = " + \"] (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_603 = ".";
  protected final String TEXT_604 = ", \"";
  protected final String TEXT_605 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_611 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_612 = ".";
  protected final String TEXT_613 = ", \"";
  protected final String TEXT_614 = "\")+\" WHERE ";
  protected final String TEXT_615 = "\";";
  protected final String TEXT_616 = NL + "\t\t\t\tString update_";
  protected final String TEXT_617 = " = \"UPDATE [\" + tableName_";
  protected final String TEXT_618 = " + \"] SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_630 = NL + "        String delete_";
  protected final String TEXT_631 = " = \"DELETE FROM [\" + tableName_";
  ...
  protected final String TEXT_662 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  protected final String TEXT_663 = " + \"] WHERE ";
  protected final String TEXT_664 = "\");" + NL + "        pstmtInsert_";
  protected final String TEXT_665 = " = conn_";
  protected final String TEXT_666 = ".prepareStatement(insert_";
  protected final String TEXT_667 = ");";
  protected final String TEXT_668 = NL + "       \t";
  protected final String TEXT_669 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_670 = " = insert_";
  protected final String TEXT_671 = ".split(\"\\\\?\");";
  protected final String TEXT_672 = NL + "\t\t\tupdate_";
  protected final String TEXT_673 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_674 = " = update_";
  protected final String TEXT_675 = ".split(\"\\\\?\");";
  protected final String TEXT_676 = NL + "\t\t\tupdate_";
  protected final String TEXT_677 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_678 = " = update_";
  protected final String TEXT_679 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_680 = " = insert_";
  protected final String TEXT_681 = ".split(\"\\\\?\");";
  protected final String TEXT_682 = NL + "\t\t\tdelete_";
  protected final String TEXT_683 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_684 = " = delete_";
  protected final String TEXT_685 = ".split(\"\\\\?\");";
  protected final String TEXT_686 = NL + "\t\t\treplace_";
  protected final String TEXT_687 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_688 = " = replace_";
  protected final String TEXT_689 = ".split(\"\\\\?\");";
  protected final String TEXT_690 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_691 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_692 = " = insertIgnore_";
  protected final String TEXT_693 = ".split(\"\\\\?\");";
  protected final String TEXT_694 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_695 = " = insert_";
  ...
  protected final String TEXT_705 = NL + "\t\tif ( isShareIdentity_";
  protected final String TEXT_706 = " ) {" + NL + "        \tstmt_";
  protected final String TEXT_707 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_708 = " +\"] ON\");" + NL + "        }";
  ...
  protected final String TEXT_733 = ".addBatch();" + NL + "        \t\tnb_line_";
  ...
  protected final String TEXT_742 = ".executeUpdate();";
  protected final String TEXT_743 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_754 = NL + "                        rejectedCount_";
  protected final String TEXT_755 = " = rejectedCount_";
  protected final String TEXT_756 = " + 1;";
  protected final String TEXT_757 = NL + "                        ";
  protected final String TEXT_758 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_759 = NL + "                        ";
  protected final String TEXT_760 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_761 = ";";
  protected final String TEXT_762 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_763 = NL + "            }";
  protected final String TEXT_764 = NL + "\t\t     \tint counter";
  protected final String TEXT_765 = " = rowCount";
  protected final String TEXT_766 = " * ";
  protected final String TEXT_767 = " + 1;" + NL + "" + NL + "\t\t     \t \t";
  protected final String TEXT_768 = NL + "\t\t     \tint counter";
  protected final String TEXT_769 = " = rowCount";
  protected final String TEXT_770 = " * ";
  protected final String TEXT_771 = " + 1;" + NL + "" + NL + "\t\t     \t \t";
  protected final String TEXT_772 = NL + "\t\t                        counter";
  protected final String TEXT_773 = "++;" + NL + "\t\t                        ";
  protected final String TEXT_774 = NL + "\t\t\t\t\t\t\t\tint count_dyn_";
  protected final String TEXT_775 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_776 = ".";
  protected final String TEXT_777 = ", pstmt_";
  protected final String TEXT_778 = ", counter";
  protected final String TEXT_779 = "-1, \"";
  protected final String TEXT_780 = "\");" + NL + "\t\t\t\t\t\t\t\tcounter";
  protected final String TEXT_781 = "+=count_dyn_";
  protected final String TEXT_782 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_783 = NL + NL + "\t\t                sInsertColValue";
  protected final String TEXT_784 = " = new BufferLine_";
  ...
  protected final String TEXT_793 = NL + "\t\t                );" + NL + "" + NL + "\t\t                sInsertColValueList";
  protected final String TEXT_794 = ".add(sInsertColValue";
  protected final String TEXT_795 = ");" + NL + "" + NL + "\t\t                rowCount";
  protected final String TEXT_796 = "++;" + NL + "\t\t";
  protected final String TEXT_797 = NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_798 = "++;" + NL + "\t\t";
  protected final String TEXT_799 = NL + "\t\t                if(rowCount";
  protected final String TEXT_800 = " == ";
  protected final String TEXT_801 = "){" + NL + "\t\t                    insertedCount_";
  protected final String TEXT_802 = " = insertedCount_";
  protected final String TEXT_803 = " + pstmt_";
  protected final String TEXT_804 = ".executeUpdate();" + NL + "\t\t                    sInsertColValueList";
  protected final String TEXT_805 = ".clear();" + NL + "\t\t                    rowCount";
  protected final String TEXT_806 = " = 0;" + NL + "\t\t                    counter";
  protected final String TEXT_807 = "=1;" + NL + "\t\t                }" + NL + NL + NL + NL;
  protected final String TEXT_808 = NL + "            try {";
  protected final String TEXT_809 = NL + "                    ";
  protected final String TEXT_810 = NL + "                        query_";
  protected final String TEXT_811 = " = ";
  protected final String TEXT_812 = ";";
  protected final String TEXT_813 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_814 = ",";
  protected final String TEXT_815 = ".";
  protected final String TEXT_816 = ", ";
  protected final String TEXT_817 = ",updateSQLSplits_";
  protected final String TEXT_818 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_819 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_820 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_838 = NL + "\t\t\t\t\t\t\tquery_";
  ...
  protected final String TEXT_848 = NL + "    \t\tpstmt_";
  protected final String TEXT_849 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_850 = "++;" + NL + "    \t\t";
  protected final String TEXT_851 = NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_852 = "++;" + NL + "    \t\t";
  protected final String TEXT_853 = NL + "            try {";
  ...
  protected final String TEXT_858 = ".executeUpdate();" + NL + "        \t    ";
  protected final String TEXT_859 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_860 = " = true;";
  protected final String TEXT_861 = NL + "                    throw(e);";
  ...
  protected final String TEXT_878 = NL + "                        System.err.println(e.getMessage());";
  ...
  protected final String TEXT_884 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_885 = " = pstmt_";
  protected final String TEXT_886 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_887 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_888 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_889 = " = rs_";
  protected final String TEXT_890 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_891 = " > 0) {";
  protected final String TEXT_892 = NL + "            try {";
  protected final String TEXT_893 = NL + "                        ";
  protected final String TEXT_894 = NL + "                            query_";
  protected final String TEXT_895 = " = ";
  protected final String TEXT_896 = ";";
  protected final String TEXT_897 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_898 = ",";
  protected final String TEXT_899 = ".";
  protected final String TEXT_900 = ", ";
  protected final String TEXT_901 = ",updateSQLSplits_";
  ...
  protected final String TEXT_934 = NL + "            try {";
  protected final String TEXT_935 = NL + "                    updatedCount_";
  protected final String TEXT_936 = " = updatedCount_";
  protected final String TEXT_937 = " + pstmtUpdate_";
  protected final String TEXT_938 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_939 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_940 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_947 = "Struct();";
  protected final String TEXT_948 = NL + "                                ";
  protected final String TEXT_949 = ".";
  protected final String TEXT_950 = " = ";
  protected final String TEXT_951 = ".";
  protected final String TEXT_952 = ";";
  protected final String TEXT_953 = NL + "                            rejectedCount_";
  protected final String TEXT_954 = " = rejectedCount_";
  protected final String TEXT_955 = " + 1;";
  protected final String TEXT_956 = NL + "                            ";
  protected final String TEXT_957 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_958 = NL + "                            ";
  protected final String TEXT_959 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_960 = ";";
  protected final String TEXT_961 = NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_962 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_963 = NL + "            try {";
  ...
  protected final String TEXT_983 = NL + "            try {";
  protected final String TEXT_984 = NL + "                    insertedCount_";
  protected final String TEXT_985 = " = insertedCount_";
  protected final String TEXT_986 = " + pstmtInsert_";
  protected final String TEXT_987 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_988 = "++;";
  protected final String TEXT_989 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_990 = " = true;";
  protected final String TEXT_991 = NL + "                        throw(e);";
  protected final String TEXT_992 = NL + "                    \tnb_line_";
  protected final String TEXT_993 = "++;" + NL + "                    \t";
  protected final String TEXT_994 = NL + "                            ";
  protected final String TEXT_995 = " = new ";
  protected final String TEXT_996 = "Struct();";
  protected final String TEXT_997 = NL + "                                ";
  protected final String TEXT_998 = ".";
  protected final String TEXT_999 = " = ";
  protected final String TEXT_1000 = ".";
  protected final String TEXT_1001 = ";";
  protected final String TEXT_1002 = NL + "                            rejectedCount_";
  protected final String TEXT_1003 = " = rejectedCount_";
  protected final String TEXT_1004 = " + 1;";
  protected final String TEXT_1005 = NL + "                            ";
  protected final String TEXT_1006 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1007 = NL + "                            ";
  protected final String TEXT_1008 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1009 = ";";
  protected final String TEXT_1010 = NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_1011 = NL + "                }" + NL + "            }";
  protected final String TEXT_1012 = NL + "            int updateFlag_";
  protected final String TEXT_1013 = "=0;";
  protected final String TEXT_1014 = NL + "            try {";
  protected final String TEXT_1015 = NL + "                    ";
  protected final String TEXT_1016 = NL + "                        query_";
  protected final String TEXT_1017 = " = ";
  protected final String TEXT_1018 = ";";
  protected final String TEXT_1019 = NL + "\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1020 = ",";
  protected final String TEXT_1021 = ".";
  protected final String TEXT_1022 = ", ";
  protected final String TEXT_1023 = ",updateSQLSplits_";
  protected final String TEXT_1024 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_1025 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_1026 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_1054 = NL + "                updateFlag_";
  protected final String TEXT_1055 = "=pstmtUpdate_";
  protected final String TEXT_1056 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_1057 = " = updatedCount_";
  protected final String TEXT_1058 = "+updateFlag_";
  protected final String TEXT_1059 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_1060 = " == 0) {" + NL + "            \t";
  protected final String TEXT_1061 = NL + "\t\t\t\tquery_";
  protected final String TEXT_1062 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_1063 = NL + "                        ";
  protected final String TEXT_1064 = NL + "                            query_";
  protected final String TEXT_1065 = " = ";
  protected final String TEXT_1066 = ";";
  protected final String TEXT_1067 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1068 = ",";
  protected final String TEXT_1069 = ".";
  protected final String TEXT_1070 = ", ";
  protected final String TEXT_1071 = ",insertSQLSplits_";
  protected final String TEXT_1072 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1073 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1074 = ".";
  protected final String TEXT_1075 = ", pstmtInsert_";
  protected final String TEXT_1076 = ", ";
  protected final String TEXT_1077 = ", \"";
  protected final String TEXT_1078 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_1079 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1080 = "_QUERY\", query_";
  protected final String TEXT_1081 = ".toString().trim());";
  protected final String TEXT_1082 = NL + "                    insertedCount_";
  protected final String TEXT_1083 = " = insertedCount_";
  protected final String TEXT_1084 = " + pstmtInsert_";
  protected final String TEXT_1085 = ".executeUpdate();" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_1086 = "++;";
  protected final String TEXT_1087 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_1088 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_1089 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_1110 = NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_1111 = NL + "                }";
  protected final String TEXT_1112 = NL + "            try {";
  ...
  protected final String TEXT_1119 = NL + "                        query_";
  protected final String TEXT_1120 = " = ";
  protected final String TEXT_1121 = ";";
  protected final String TEXT_1122 = NL + "                globalMap.put(\"";
  protected final String TEXT_1123 = "_QUERY\", query_";
  protected final String TEXT_1124 = ".toString().trim());";
  protected final String TEXT_1125 = NL + "         \t";
  protected final String TEXT_1126 = NL + "    \t\tpstmt_";
  protected final String TEXT_1127 = ".addBatch();" + NL + "    \t\tnb_line_";
  ...
  protected final String TEXT_1133 = " = deletedCount_";
  protected final String TEXT_1134 = " + pstmt_";
  protected final String TEXT_1135 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1136 = "++;";
  protected final String TEXT_1137 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1138 = " = true;";
  protected final String TEXT_1139 = NL + "                    throw(e);";
  protected final String TEXT_1140 = NL + "                \tnb_line_";
  ...
  protected final String TEXT_1150 = NL + "                        rejectedCount_";
  protected final String TEXT_1151 = " = rejectedCount_";
  protected final String TEXT_1152 = " + 1;";
  protected final String TEXT_1153 = NL + "                        ";
  protected final String TEXT_1154 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1155 = NL + "                        ";
  protected final String TEXT_1156 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1157 = ";";
  protected final String TEXT_1158 = NL + "                        System.err.println(e.getMessage());";
  ...
  protected final String TEXT_1163 = NL + NL + "        java.sql.ResultSet rs_";
  protected final String TEXT_1164 = " = pstmt_";
  protected final String TEXT_1165 = ".executeQuery();" + NL + "        int checkCount_";
  protected final String TEXT_1166 = " = -1;" + NL + "        while(rs_";
  protected final String TEXT_1167 = ".next()) {" + NL + "            checkCount_";
  protected final String TEXT_1168 = " = rs_";
  protected final String TEXT_1169 = ".getInt(1);" + NL + "        }" + NL + "" + NL + "        if (checkCount_";
  protected final String TEXT_1170 = " < 1) {";
  protected final String TEXT_1171 = NL + "            try {";
  protected final String TEXT_1172 = NL + "                    ";
  protected final String TEXT_1173 = NL + "                        query_";
  protected final String TEXT_1174 = " = ";
  protected final String TEXT_1175 = ";";
  protected final String TEXT_1176 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1177 = ".";
  protected final String TEXT_1178 = ", pstmtInsert_";
  protected final String TEXT_1179 = ", ";
  protected final String TEXT_1180 = ", \"";
  protected final String TEXT_1181 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_1182 = NL + "                globalMap.put(\"";
  protected final String TEXT_1183 = "_QUERY\", query_";
  protected final String TEXT_1184 = ".toString().trim());";
  protected final String TEXT_1185 = NL + "            try {";
  protected final String TEXT_1186 = NL + "                insertedCount_";
  ...
  protected final String TEXT_1206 = " + 1;" + NL + "                \t";
  protected final String TEXT_1207 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1208 = NL + "                    ";
  protected final String TEXT_1209 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1210 = ";";
  protected final String TEXT_1211 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1212 = NL + "                }" + NL + "            }";
  protected final String TEXT_1213 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_1224 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_1225 = " > 0) && (batchSize_";
  protected final String TEXT_1226 = " <= batchSizeCounter_";
  protected final String TEXT_1227 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1228 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1229 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1230 = ": pstmt_";
  protected final String TEXT_1231 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1232 = " == -2 || countEach_";
  protected final String TEXT_1233 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1234 = " += countEach_";
  protected final String TEXT_1235 = ";" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1236 = NL + "            \t    \t";
  protected final String TEXT_1237 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1238 = " += countSum_";
  protected final String TEXT_1239 = ";" + NL + "            \t    \t";
  protected final String TEXT_1240 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1241 = " += countSum_";
  protected final String TEXT_1242 = ";" + NL + "            \t    \t";
  protected final String TEXT_1243 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1244 = " += countSum_";
  protected final String TEXT_1245 = ";" + NL + "            \t    \t";
  protected final String TEXT_1246 = NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_1247 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1248 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1249 = NL + "                \tint countSum_";
  protected final String TEXT_1250 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1251 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1252 = " += (countEach_";
  protected final String TEXT_1253 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1254 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1255 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1256 = " += countSum_";
  protected final String TEXT_1257 = ";" + NL + "            \t    \t";
  protected final String TEXT_1258 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1259 = " += countSum_";
  protected final String TEXT_1260 = ";" + NL + "            \t    \t";
  protected final String TEXT_1261 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1262 = " += countSum_";
  protected final String TEXT_1263 = ";" + NL + "            \t    \t";
  protected final String TEXT_1264 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1265 = NL + "                }" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1266 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1267 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1268 = " <= commitCounter_";
  protected final String TEXT_1269 = ") {";
  protected final String TEXT_1270 = NL + "                if ((batchSize_";
  protected final String TEXT_1271 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1272 = " > 0)) {" + NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_1273 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_1274 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1275 = ": pstmt_";
  protected final String TEXT_1276 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1277 = " == -2 || countEach_";
  protected final String TEXT_1278 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1279 = " += countEach_";
  protected final String TEXT_1280 = ";" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1281 = NL + "            \t    \t";
  protected final String TEXT_1282 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1283 = " += countSum_";
  protected final String TEXT_1284 = ";" + NL + "            \t    \t";
  protected final String TEXT_1285 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1286 = " += countSum_";
  protected final String TEXT_1287 = ";" + NL + "            \t    \t";
  protected final String TEXT_1288 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1289 = " += countSum_";
  protected final String TEXT_1290 = ";" + NL + "            \t    \t";
  protected final String TEXT_1291 = NL + "                batchSizeCounter_";
  protected final String TEXT_1292 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1293 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1294 = NL + "                \tint countSum_";
  protected final String TEXT_1295 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1296 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1297 = " += (countEach_";
  protected final String TEXT_1298 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1299 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1300 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1301 = " += countSum_";
  ...
  protected final String TEXT_1306 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1307 = " += countSum_";
  protected final String TEXT_1308 = ";" + NL + "            \t    \t";
  protected final String TEXT_1309 = NL + "                        System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1310 = NL + "                }" + NL + "            }";
  protected final String TEXT_1311 = NL + "                \t";
  protected final String TEXT_1312 = NL + "                \tconn_";
  protected final String TEXT_1313 = ".commit();" + NL + "            \t\t";
  protected final String TEXT_1314 = NL + "                \tcommitCounter_";
  protected final String TEXT_1315 = "=0;" + NL + "                }";
  protected final String TEXT_1316 = NL + "\t\tif (isShareIdentity_";
  protected final String TEXT_1317 = " ) {" + NL + "        \t stmt_";
  protected final String TEXT_1318 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_1319 = " +\"] OFF\");" + NL + "        }";
