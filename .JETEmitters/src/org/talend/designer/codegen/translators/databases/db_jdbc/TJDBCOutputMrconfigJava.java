...
public class TJDBCOutputMrconfigJava
{
  protected static String nl;
  public static synchronized TJDBCOutputMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJDBCOutputMrconfigJava result = new TJDBCOutputMrconfigJava();
    nl = null;
    return result;
  }
