...
public class THBaseOutputSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized THBaseOutputSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    THBaseOutputSparkstreamingconfigJava result = new THBaseOutputSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_10 = ".foreach(new ";
  protected final String TEXT_11 = "_ForeachRDD(job));";
