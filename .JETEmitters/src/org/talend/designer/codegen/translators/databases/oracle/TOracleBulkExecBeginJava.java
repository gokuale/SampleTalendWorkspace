...
public class TOracleBulkExecBeginJava {
  ...
  protected final String TEXT_362 = ".equals";
  protected final String TEXT_363 = "IgnoreCase";
  ...
  protected final String TEXT_368 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_369 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_386 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_392 = " - Droping table ";
  ...
  protected final String TEXT_400 = " - Drop table ";
  ...
  protected final String TEXT_405 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_409 = " - Creating table ";
  ...
  protected final String TEXT_417 = " - Create table ";
  ...
  protected final String TEXT_427 = " - Clearing table ";
  ...
  protected final String TEXT_435 = "- Clear table ";
  protected final String TEXT_436 = "\" + tableName_";
  protected final String TEXT_437 = " + \"";
  protected final String TEXT_438 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_439 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_440 = ".close();" + NL + "\t\t";
  ...
  protected final String TEXT_450 = " - Trancating table ";
  ...
  protected final String TEXT_458 = " - Truncate table ";
  protected final String TEXT_459 = "\" + tableName_";
  protected final String TEXT_460 = " + \"";
  protected final String TEXT_461 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_462 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_463 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_464 = " += rsTruncCount_";
  protected final String TEXT_465 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_466 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_467 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_468 = ".close();" + NL + "\t\t";
  protected final String TEXT_469 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_470 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_471 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_472 = NL + "    String ctlf_";
  protected final String TEXT_473 = " = ";
  protected final String TEXT_474 = ";" + NL + "    String logf_";
  protected final String TEXT_475 = " = ";
  protected final String TEXT_476 = "+\".log\";";
  protected final String TEXT_477 = NL + "    java.lang.StringBuilder optionClause_";
  protected final String TEXT_478 = " = new java.lang.StringBuilder();" + NL + "    optionClause_";
  protected final String TEXT_479 = ".append(\"OPTIONS (\");";
  protected final String TEXT_480 = NL + "            optionClause_";
  ...
  protected final String TEXT_486 = NL + "                    optionClause_";
  protected final String TEXT_487 = ".append(\"";
  protected final String TEXT_488 = "=";
  protected final String TEXT_489 = "\");";
  protected final String TEXT_490 = NL + "                if(";
  protected final String TEXT_491 = ".split(\",\").length>1){" + NL + "                    optionClause_";
  protected final String TEXT_492 = ".append(\"";
  protected final String TEXT_493 = "=(\"+";
  protected final String TEXT_494 = "+\")\");" + NL + "                }else{" + NL + "                    optionClause_";
  protected final String TEXT_495 = ".append(\"";
  protected final String TEXT_496 = "=\"+";
  protected final String TEXT_497 = ");" + NL + "                }";
  protected final String TEXT_498 = NL + "                optionClause_";
  protected final String TEXT_499 = ".append(\"";
  protected final String TEXT_500 = "=";
  protected final String TEXT_501 = "\");";
  protected final String TEXT_502 = NL + "                optionClause_";
  protected final String TEXT_503 = ".append(\"";
  protected final String TEXT_504 = "='\"+";
  protected final String TEXT_505 = "+\"'\");";
  protected final String TEXT_506 = NL + "                optionClause_";
  protected final String TEXT_507 = ".append(\"";
  protected final String TEXT_508 = "=";
  protected final String TEXT_509 = "\");";
  protected final String TEXT_510 = NL + "                optionClause_";
  protected final String TEXT_511 = ".append(\"";
  protected final String TEXT_512 = "=\"+";
  protected final String TEXT_513 = ");";
  protected final String TEXT_514 = NL + "    optionClause_";
  protected final String TEXT_515 = ".append(\")\");";
  protected final String TEXT_516 = NL + "    String dataf_";
  protected final String TEXT_517 = " = ";
  protected final String TEXT_518 = " + Thread.currentThread().getId();" + NL + "" + NL + "    String ctlf_";
  protected final String TEXT_519 = " = dataf_";
  protected final String TEXT_520 = " + \".ctl\";" + NL + "" + NL + "    String badf_";
  protected final String TEXT_521 = " = dataf_";
  protected final String TEXT_522 = " + \".bad\";" + NL + "" + NL + "    String dscf_";
  protected final String TEXT_523 = " = dataf_";
  protected final String TEXT_524 = " + \".dsc\";" + NL + "" + NL + "    String logf_";
  protected final String TEXT_525 = " = dataf_";
  protected final String TEXT_526 = " + \".log\";" + NL + "" + NL + "    dataf_";
  protected final String TEXT_527 = " = ";
  protected final String TEXT_528 = ";" + NL + "" + NL + "    java.io.File badFile_";
  protected final String TEXT_529 = " = new java.io.File(badf_";
  protected final String TEXT_530 = ");" + NL + "" + NL + "    if(badFile_";
  protected final String TEXT_531 = ".exists()){" + NL + "" + NL + "        badFile_";
  protected final String TEXT_532 = ".delete();" + NL + "" + NL + "    }" + NL + "    java.io.BufferedWriter bw_";
  protected final String TEXT_533 = " = new java.io.BufferedWriter(new java.io.FileWriter(ctlf_";
  protected final String TEXT_534 = "));" + NL + "    java.io.PrintWriter pw_";
  protected final String TEXT_535 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_536 = " ,false) ;" + NL + "" + NL + "    pw_";
  protected final String TEXT_537 = ".println(optionClause_";
  protected final String TEXT_538 = ".toString());" + NL + "" + NL + "    pw_";
  protected final String TEXT_539 = ".println(\"LOAD DATA\");" + NL + "    pw_";
  protected final String TEXT_540 = ".println(\"CHARACTERSET '\"+";
  protected final String TEXT_541 = "+\"'\") ;" + NL + "    bw_";
  protected final String TEXT_542 = ".write(\"INFILE '\" + dataf_";
  protected final String TEXT_543 = " + \"'\");" + NL;
  protected final String TEXT_544 = NL + "        bw_";
  protected final String TEXT_545 = ".write(\" \\\"str '|'\\\" \");";
  protected final String TEXT_546 = NL + NL + NL;
  protected final String TEXT_547 = NL + "        bw_";
  protected final String TEXT_548 = ".write(\" \\\"str '\" + ";
  protected final String TEXT_549 = " + \"'\\\"\");";
  protected final String TEXT_550 = NL + "        bw_";
  protected final String TEXT_551 = ".write(\" \\\"fix \" + ";
  protected final String TEXT_552 = " + \"\\\"\");";
  protected final String TEXT_553 = NL + "        bw_";
  protected final String TEXT_554 = ".write(\" \\\"var \" + ";
  protected final String TEXT_555 = " + \"\\\"\");";
  protected final String TEXT_556 = NL + "    pw_";
  protected final String TEXT_557 = ".println(\"\");" + NL + "    pw_";
  protected final String TEXT_558 = ".println(\"BADFILE '\" + badf_";
  protected final String TEXT_559 = " + \"'\" );" + NL + "    pw_";
  protected final String TEXT_560 = ".println(\"DISCARDFILE '\" + dscf_";
  protected final String TEXT_561 = " + \"'\");";
  protected final String TEXT_562 = NL + "        pw_";
  protected final String TEXT_563 = ".println(\"PRESERVE BLANKS\");";
  protected final String TEXT_564 = NL + "        bw_";
  protected final String TEXT_565 = ".write(";
  protected final String TEXT_566 = ");";
  protected final String TEXT_567 = NL + "            pw_";
  protected final String TEXT_568 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_569 = ");" + NL + "            pw_";
  protected final String TEXT_570 = ".println(\"INSERT\");";
  protected final String TEXT_571 = NL + "            pw_";
  protected final String TEXT_572 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_573 = ");" + NL + "            pw_";
  protected final String TEXT_574 = ".println(\"";
  protected final String TEXT_575 = "\");";
  protected final String TEXT_576 = NL + "                pw_";
  protected final String TEXT_577 = ".println(\"WHEN \" + ";
  protected final String TEXT_578 = ");";
  protected final String TEXT_579 = NL + "            bw_";
  protected final String TEXT_580 = ".write(\"FIELDS TERMINATED BY ";
  protected final String TEXT_581 = "\");";
  protected final String TEXT_582 = NL + "            bw_";
  protected final String TEXT_583 = ".write(\"FIELDS TERMINATED BY \\\"\"+ ";
  protected final String TEXT_584 = " + \"\\\"\");";
  protected final String TEXT_585 = NL + "                bw_";
  protected final String TEXT_586 = ".write(\" OPTIONALLY ENCLOSED BY \");";
  protected final String TEXT_587 = NL + "                bw_";
  protected final String TEXT_588 = ".write(\"FIELDS ENCLOSED BY \");";
  protected final String TEXT_589 = NL + "            bw_";
  protected final String TEXT_590 = ".write(\"'\" + ";
  protected final String TEXT_591 = " + \"'\");";
  protected final String TEXT_592 = NL + "                bw_";
  protected final String TEXT_593 = ".write(\" AND '\" + ";
  protected final String TEXT_594 = " + \"'\");";
  protected final String TEXT_595 = NL + "            pw_";
  protected final String TEXT_596 = ".println(\"\");";
  protected final String TEXT_597 = NL + "            pw_";
  protected final String TEXT_598 = ".println(\"\");";
  protected final String TEXT_599 = NL + "            pw_";
  protected final String TEXT_600 = ".println(\"TRAILING NULLCOLS\");";
  protected final String TEXT_601 = NL + "            pw_";
  protected final String TEXT_602 = ".println(\"";
  protected final String TEXT_603 = "\");";
  protected final String TEXT_604 = NL + "    bw_";
  protected final String TEXT_605 = ".close();" + NL + "    pw_";
  protected final String TEXT_606 = ".close();";
  protected final String TEXT_607 = NL + NL + "String command_";
  protected final String TEXT_608 = " = \"sqlldr '\" + dbUser_";
  protected final String TEXT_609 = " + \"/\" + dbPwd_";
  protected final String TEXT_610 = " + \"@\" + serviceUrl_";
  protected final String TEXT_611 = " + \"' CONTROL='\" + ctlf_";
  protected final String TEXT_612 = " + \"' LOG='\" + logf_";
  protected final String TEXT_613 = " + \"'\";" + NL;
  protected final String TEXT_614 = NL + "    try{" + NL + "    java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_615 = " = conn_";
  protected final String TEXT_616 = ".createStatement();";
  protected final String TEXT_617 = NL + "        log.info(\"";
  protected final String TEXT_618 = " - Creating temp table ";
  protected final String TEXT_619 = "\" + tableName_";
  protected final String TEXT_620 = " + \"";
  protected final String TEXT_621 = ".\" );";
  protected final String TEXT_622 = NL + "    stmtCreateTmp_";
  protected final String TEXT_623 = ".execute(\"";
  protected final String TEXT_624 = ")\");" + NL + "    stmtCreateTmp_";
  protected final String TEXT_625 = ".close();";
  protected final String TEXT_626 = NL + "        log.info(\"";
  protected final String TEXT_627 = " - Create temp table ";
  protected final String TEXT_628 = "\" + tableName_";
  protected final String TEXT_629 = " + \"";
  protected final String TEXT_630 = " has succeeded.\");" + NL + "        log.info(\"";
  protected final String TEXT_631 = " - Executing command:'\" + command_";
  protected final String TEXT_632 = " + \"'.\");";
  protected final String TEXT_633 = NL + "    final Process process_";
  protected final String TEXT_634 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_635 = ");";
  protected final String TEXT_636 = NL + "        java.util.ArrayList<String> envParam_";
  protected final String TEXT_637 = "=new java.util.ArrayList<String>();" + NL + "        java.util.Map<String, String> systemEnvMap_";
  protected final String TEXT_638 = " = System.getenv();" + NL + "        for (java.util.Map.Entry<String, String> entry : systemEnvMap_";
  protected final String TEXT_639 = ".entrySet())" + NL + "        {" + NL + "           envParam_";
  protected final String TEXT_640 = ".add(entry.getKey() + \"=\" + entry.getValue());" + NL + "        }";
  protected final String TEXT_641 = NL + "        envParam_";
  protected final String TEXT_642 = ".add(\"NLS_LANGUAGE=";
  protected final String TEXT_643 = "\");";
  protected final String TEXT_644 = NL + "        envParam_";
  protected final String TEXT_645 = ".add(\"NLS_DATE_LANGUAGE=";
  protected final String TEXT_646 = "\");";
  protected final String TEXT_647 = NL + "            envParam_";
  protected final String TEXT_648 = ".add(\"NLS_TERRITORY=";
  protected final String TEXT_649 = "\");";
  protected final String TEXT_650 = NL + "        envParam_";
  protected final String TEXT_651 = ".add(\"";
  protected final String TEXT_652 = "=";
  protected final String TEXT_653 = "\");";
  protected final String TEXT_654 = NL + "        log.info(\"";
  protected final String TEXT_655 = " - Executing command:'\" + command_";
  ...
  protected final String TEXT_659 = ",envParam_";
  protected final String TEXT_660 = ".toArray(new String[0]));";
  protected final String TEXT_661 = NL + NL + "//System.out.println(command_";
  protected final String TEXT_662 = ");" + NL + "" + NL + "Thread normal_";
  protected final String TEXT_663 = " = new Thread() {" + NL + "    public void run() {" + NL + "        try {" + NL + "            java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_664 = ".getInputStream()));" + NL + "            String line = \"\";" + NL + "            try {" + NL + "                while((line = reader.readLine()) != null) {";
  protected final String TEXT_665 = NL + "                        System.out.println(line);";
  protected final String TEXT_666 = NL + "                        globalMap.put(\"";
  protected final String TEXT_667 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_668 = "_OUTPUT\") + \"\\n\" + line);";
  protected final String TEXT_669 = NL + "                }" + NL + "            } finally {" + NL + "                 reader.close();" + NL + "            }" + NL + "        }catch(java.io.IOException ioe) {";
  protected final String TEXT_670 = NL + "            ioe.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "};" + NL + "" + NL + "normal_";
  protected final String TEXT_671 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_672 = " = new Thread() {" + NL + "    public void run() {" + NL + "       try {" + NL + "           java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_673 = ".getErrorStream()));" + NL + "           String line = \"\";" + NL + "           try {" + NL + "               while((line = reader.readLine()) != null) {" + NL + "                  globalMap.put(\"";
  protected final String TEXT_674 = "_SQLLOAD_ERROR\", \"true\");";
  protected final String TEXT_675 = NL + "                       System.err.println(line);";
  protected final String TEXT_676 = NL + "                       globalMap.put(\"";
  protected final String TEXT_677 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_678 = "_OUTPUT\")+\"\\n\"+line);";
  protected final String TEXT_679 = NL + "               }" + NL + "            } finally {" + NL + "                reader.close();" + NL + "            }" + NL + "        } catch(java.io.IOException ioe) {";
  protected final String TEXT_680 = NL + "           ioe.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "};" + NL + "" + NL + "error_";
  protected final String TEXT_681 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_682 = ".waitFor();" + NL + "" + NL + "int exitCode_";
  protected final String TEXT_683 = " = process_";
  protected final String TEXT_684 = ".exitValue();" + NL + "" + NL + "" + NL + "normal_";
  protected final String TEXT_685 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_686 = ".interrupt();" + NL + "" + NL + "if (\"true\".equals((String)globalMap.get(\"";
  protected final String TEXT_687 = "_SQLLOAD_ERROR\"))) {" + NL + "    throw new TalendException(new java.lang.Exception() , \"";
  protected final String TEXT_688 = "\" , globalMap);" + NL + "}";
  protected final String TEXT_689 = NL + "    log.info(\"";
  protected final String TEXT_690 = " - Excute command: '\" + command_";
  protected final String TEXT_691 = " + \"' has finished.\");" + NL + "    log.info(\"";
  protected final String TEXT_692 = " - Retrieving information from oracle log file: '\" + logf_";
  protected final String TEXT_693 = " + \"'.\");";
  protected final String TEXT_694 = NL + "java.io.BufferedReader lr_";
  protected final String TEXT_695 = " = new java.io.BufferedReader(new java.io.FileReader(logf_";
  protected final String TEXT_696 = "));" + NL + "int nb_line_data_";
  protected final String TEXT_697 = " = 0;" + NL + "int nb_line_bad_";
  protected final String TEXT_698 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_699 = " = 0;" + NL + "int nb_line_discarded_";
  protected final String TEXT_700 = " = 0;" + NL + "" + NL + "/*  1.get log file all lines count" + NL + "    2.get \"Total logical records read\" line number from file end." + NL + "    3.get \"Total logical records read\" and \"Total logical records rejected\" count. */" + NL + "String tempLine_";
  protected final String TEXT_701 = " = \"\";" + NL + "int countLines_";
  protected final String TEXT_702 = " =0;//log file lines count" + NL + "//1" + NL + "class LogUtil_";
  protected final String TEXT_703 = "{" + NL + "    public int getNumber(java.io.BufferedReader br)  throws java.io.IOException {" + NL + "        int number=0;" + NL + "        java.util.regex.Pattern pattern = java.util.regex.Pattern.compile(\"\\\\d{1,}\");" + NL + "        String tempLine = br.readLine();" + NL + "        if(tempLine!=null){" + NL + "            String str_number = tempLine.substring(tempLine.indexOf(\":\") + 1).trim();" + NL + "            boolean isNumber= pattern.matcher(str_number).matches();" + NL + "            if(isNumber){" + NL + "                number = Integer.parseInt(str_number);" + NL + "            }" + NL + "        }" + NL + "        return number;" + NL + "    }" + NL + "}" + NL + "int lastTableLine_";
  protected final String TEXT_704 = " = 0;//Line Number of the last table name" + NL + "while ((tempLine_";
  protected final String TEXT_705 = " = lr_";
  protected final String TEXT_706 = ".readLine() )!= null) {" + NL + "    countLines_";
  protected final String TEXT_707 = "++;" + NL + "    if(tempLine_";
  protected final String TEXT_708 = ".toUpperCase().indexOf(\"TABLE \"+(tableName_";
  protected final String TEXT_709 = ").toUpperCase())>-1){" + NL + "        lastTableLine_";
  protected final String TEXT_710 = " = countLines_";
  protected final String TEXT_711 = ";" + NL + "    }" + NL + "}" + NL + "lr_";
  protected final String TEXT_712 = ".close();" + NL + "//need new instance to readLine ." + NL + "lr_";
  protected final String TEXT_713 = " = new java.io.BufferedReader(new java.io.FileReader(logf_";
  protected final String TEXT_714 = "));" + NL + "for (int i_";
  protected final String TEXT_715 = "=0; i_";
  protected final String TEXT_716 = "<= lastTableLine_";
  protected final String TEXT_717 = "; i_";
  protected final String TEXT_718 = "++) {" + NL + "    lr_";
  protected final String TEXT_719 = ".readLine();" + NL + "}" + NL + "    boolean isNumber_";
  protected final String TEXT_720 = "=false;" + NL + "    tempLine_";
  protected final String TEXT_721 = " = lr_";
  protected final String TEXT_722 = ".readLine();" + NL + "    int emptyLineNum_";
  protected final String TEXT_723 = " =0;//The number of empty block" + NL + "    boolean isFirstEmptyLine_";
  protected final String TEXT_724 = " = false;//Is the first empty line of empty block" + NL + "for (int i_";
  protected final String TEXT_725 = "=lastTableLine_";
  protected final String TEXT_726 = "+2; i_";
  protected final String TEXT_727 = "<= countLines_";
  protected final String TEXT_728 = "; i_";
  protected final String TEXT_729 = "++) {" + NL + "    tempLine_";
  protected final String TEXT_730 = " = lr_";
  protected final String TEXT_731 = ".readLine();" + NL + "    if(tempLine_";
  protected final String TEXT_732 = "!=null && tempLine_";
  protected final String TEXT_733 = ".trim().length()>0){" + NL + "        if(emptyLineNum_";
  protected final String TEXT_734 = "==2){" + NL + "            break;" + NL + "        }" + NL + "        isFirstEmptyLine_";
  protected final String TEXT_735 = " = false;" + NL + "        continue;//skip rows now empty" + NL + "    }else if (!isFirstEmptyLine_";
  protected final String TEXT_736 = "){//skip empty rows" + NL + "        isFirstEmptyLine_";
  protected final String TEXT_737 = " = true;" + NL + "        emptyLineNum_";
  protected final String TEXT_738 = "++;" + NL + "    }" + NL + "}" + NL + "    LogUtil_";
  protected final String TEXT_739 = " lu_";
  protected final String TEXT_740 = " = new LogUtil_";
  protected final String TEXT_741 = "();" + NL + "    nb_line_data_";
  protected final String TEXT_742 = " = lu_";
  protected final String TEXT_743 = ".getNumber(lr_";
  protected final String TEXT_744 = ");//get the number of data line" + NL + "    nb_line_bad_";
  protected final String TEXT_745 = " = lu_";
  protected final String TEXT_746 = ".getNumber(lr_";
  protected final String TEXT_747 = ");//get the number of reject data line" + NL + "    nb_line_discarded_";
  protected final String TEXT_748 = " = lu_";
  protected final String TEXT_749 = ".getNumber(lr_";
  protected final String TEXT_750 = ");//get the number of discarded data line" + NL + "    nb_line_inserted_";
  protected final String TEXT_751 = " = nb_line_data_";
  protected final String TEXT_752 = " - nb_line_bad_";
  protected final String TEXT_753 = " - nb_line_discarded_";
  protected final String TEXT_754 = ";" + NL + "lr_";
  protected final String TEXT_755 = ".close();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_756 = "_NB_LINE_DATA\", nb_line_data_";
  protected final String TEXT_757 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_758 = "_NB_LINE_BAD\", nb_line_bad_";
  protected final String TEXT_759 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_760 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  protected final String TEXT_761 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_762 = "_RETURN_CODE\", exitCode_";
  protected final String TEXT_763 = ");";
  protected final String TEXT_764 = NL + "    log.info(\"";
  protected final String TEXT_765 = " - Retrieved number of line: \" + nb_line_data_";
  protected final String TEXT_766 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_767 = " - Retrieved number of bad line: \" + nb_line_bad_";
  protected final String TEXT_768 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_769 = " - Retrieved number of inserted line: \" + nb_line_inserted_";
  protected final String TEXT_770 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_771 = " - Retrieved information from oracle log file: '\" + logf_";
  protected final String TEXT_772 = " + \"' finish.\");";
