...
public class TMysqlOutputSparkstreamingconfigJava {
  protected static String nl;
  public static synchronized TMysqlOutputSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMysqlOutputSparkstreamingconfigJava result = new TMysqlOutputSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_48 = ";" + NL + "Class.forName(\"org.gjt.mm.mysql.Driver\");" + NL + "java.sql.Connection conn_";
  protected final String TEXT_49 = " = java.sql.DriverManager.getConnection(";
  ...
  protected final String TEXT_266 = NL + "                                if(whetherExist_";
  protected final String TEXT_267 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_271 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_272 = "));";
  protected final String TEXT_273 = NL + "                                    stmtDrop_";
  protected final String TEXT_274 = ".execute(\"";
  protected final String TEXT_275 = "\" ";
  protected final String TEXT_276 = ");";
  protected final String TEXT_277 = NL + "                                    stmtDrop_";
  protected final String TEXT_278 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  protected final String TEXT_279 = " = conn_";
  protected final String TEXT_280 = ".createStatement();";
  protected final String TEXT_281 = NL + "                                                  stmtCreate_";
  protected final String TEXT_282 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_298 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_299 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_300 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_317 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_318 = " = stmtTruncCount_";
  protected final String TEXT_319 = ".executeQuery(\"";
  protected final String TEXT_320 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_321 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_322 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_326 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_327 = " = conn_";
  protected final String TEXT_328 = ".createStatement();";
  protected final String TEXT_329 = NL + "                              stmtTrunc_";
  protected final String TEXT_330 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_331 = "));";
  protected final String TEXT_332 = NL + "                conn_";
  protected final String TEXT_333 = ".commit();";
  protected final String TEXT_334 = NL + "            stmtTrunc_";
  protected final String TEXT_335 = ".executeUpdate(\"";
  protected final String TEXT_336 = "\");";
  protected final String TEXT_337 = NL + "                if(!conn_";
  protected final String TEXT_338 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_339 = ".commit();" + NL + "                }";
  protected final String TEXT_340 = NL + "            deletedCount_";
  protected final String TEXT_341 = " += rsTruncCountNumber_";
  protected final String TEXT_342 = ";" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_346 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_347 = " = stmtTruncCount_";
  protected final String TEXT_348 = ".executeQuery(\"";
  protected final String TEXT_349 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_357 = NL + "            while(rsTruncCount_";
  protected final String TEXT_358 = ".next()) {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_362 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_363 = ".close();";
  protected final String TEXT_364 = NL + NL + "conn_";
  protected final String TEXT_365 = ".close();" + NL;
  protected final String TEXT_366 = NL + "rdd_";
  protected final String TEXT_367 = ".foreachRDD(new org.apache.spark.api.java.function.Function<org.apache.spark.api.java.JavaRDD<";
  protected final String TEXT_368 = ">, Void>() {" + NL + "\t@Override" + NL + "    public Void call(org.apache.spark.api.java.JavaRDD<";
  protected final String TEXT_369 = "> current_rdd) throws Exception {" + NL + "    \tcurrent_rdd.foreachPartition(new ";
  protected final String TEXT_370 = "_OutputFunction(job));" + NL + "        return null;" + NL + "\t}" + NL + "});";
