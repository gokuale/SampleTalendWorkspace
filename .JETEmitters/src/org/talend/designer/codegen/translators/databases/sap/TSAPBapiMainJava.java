...
public class TSAPBapiMainJava
{
  protected static String nl;
  public static synchronized TSAPBapiMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPBapiMainJava result = new TSAPBapiMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_44 = " = null;" + NL + "\t\t\t" + NL + "\t\t\tif(";
  protected final String TEXT_45 = ".";
  protected final String TEXT_46 = "!=null && ";
  protected final String TEXT_47 = ".";
  protected final String TEXT_48 = ".getDocument()!=null) {" + NL + "\t\t\t\ttemplate_";
  protected final String TEXT_49 = ".setXml(";
  protected final String TEXT_50 = ".";
  protected final String TEXT_51 = ".getDocument());" + NL + "\t\t\t\t" + NL + "\t\t\t\torg.dom4j.Document outputDocument_";
  protected final String TEXT_52 = " = template_";
  protected final String TEXT_53 = ".execute();" + NL + "\t\t\t\t";
  protected final String TEXT_54 = NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_55 = ".";
  protected final String TEXT_56 = " = new routines.system.Document();" + NL + "\t\t\t\t";
  protected final String TEXT_57 = ".";
  protected final String TEXT_58 = ".setDocument(outputDocument_";
...
LogUtil log = null;
    ...
    stringBuffer.append(inputDocumentColumn.getLabel() );
