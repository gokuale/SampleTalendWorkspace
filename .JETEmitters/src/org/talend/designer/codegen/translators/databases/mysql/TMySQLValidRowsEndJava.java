...
public class TMySQLValidRowsEndJava
{
  protected static String nl;
  public static synchronized TMySQLValidRowsEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMySQLValidRowsEndJava result = new TMySQLValidRowsEndJava();
    nl = null;
    return result;
  }
