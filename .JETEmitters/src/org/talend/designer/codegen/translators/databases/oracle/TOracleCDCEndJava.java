...
public class TOracleCDCEndJava
{
  protected static String nl;
  public static synchronized TOracleCDCEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleCDCEndJava result = new TOracleCDCEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_71 = NL + "\t\t\tqueryUpdatePrefix_";
  protected final String TEXT_72 = "= \"UPDATE \"+dataTableName_";
  protected final String TEXT_73 = "+\" SET TALEND_CDC_STATE='x'\";" + NL + "\t\t\t";
  protected final String TEXT_74 = NL + "\t\t\tstmt_";
  protected final String TEXT_75 = ".executeUpdate(queryUpdatePrefix_";
  protected final String TEXT_76 = "+queryLockUpdate_";
  protected final String TEXT_77 = "+\" TALEND_CDC_STATE ='1'\");" + NL + "\t\t\t";
  protected final String TEXT_78 = NL + "\t\t\t\tString queryResetLocks_";
  protected final String TEXT_79 = " = \"DELETE FROM \"+dataTableName_";
  protected final String TEXT_80 = " +\" WHERE TALEND_CDC_STATE='1'\";" + NL + "\t\t\t\t";
  protected final String TEXT_81 = NL + "\t\t\t\tstmt_";
  protected final String TEXT_82 = ".executeQuery(queryResetLocks_";
  protected final String TEXT_83 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_84 = NL + "\t\t\t\t";
  protected final String TEXT_85 = NL + "\t\t\t\tstmt_";
  protected final String TEXT_86 = ".execute(sql_log_";
  protected final String TEXT_87 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_88 = NL + "\t\t\t";
  protected final String TEXT_89 = NL + "\t\t\t\tString queryResetLocks_";
  protected final String TEXT_90 = " = \"DELETE FROM \"+dataTableName_";
  protected final String TEXT_91 = " +\" WHERE TALEND_CDC_SUBSCRIBERS_NAME='\"+";
  protected final String TEXT_92 = "+\"' AND TALEND_CDC_STATE='1'\";" + NL + "\t\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\t\tstmt_";
  protected final String TEXT_94 = ".executeQuery(queryResetLocks_";
  protected final String TEXT_95 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_96 = NL + "\t\t\t";
  protected final String TEXT_97 = NL + "\t\tstmt_";
  protected final String TEXT_98 = ".close();" + NL + "" + NL + "\t\t";
  protected final String TEXT_99 = NL + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_100 = "_NB_LINE\",nb_line_";
  protected final String TEXT_101 = ");" + NL + "\t";
  protected final String TEXT_102 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tif(lcrPosition_";
  protected final String TEXT_103 = "!=null){" + NL + "\t        \txStreamOut_";
  protected final String TEXT_104 = ".setProcessedLowWatermark(lcrPosition_";
  protected final String TEXT_105 = ",oracle.streams.XStreamOut.DEFAULT_MODE);" + NL + "\t        \tlcrPosition_";
  protected final String TEXT_106 = " = null;" + NL + "        \t}" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_107 = NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_108 = "_NB_LINE\",nb_line_";
  protected final String TEXT_109 = ");" + NL + "\t\t\ttry {" + NL + "\t\t\t\t";
  protected final String TEXT_110 = NL + "\t\t\t\txStreamOut_";
  protected final String TEXT_111 = ".detach(oracle.streams.XStreamOut.DEFAULT_MODE);" + NL + "\t\t\t\t";
  protected final String TEXT_112 = NL + "\t\t\t} catch (oracle.streams.StreamsException e_";
  protected final String TEXT_113 = ") {" + NL + "\t\t\t\tSystem.err.println(\"Cannot detach from the outbound server: \" + ";
  ...
  public String generate(Object argument)
  {
	...
	boolean keepCDCDatas=Boolean.TRUE.toString().equals(ElementParameterParser.getValue(node, "__KEEP_CDC_DATAS__"));
    ...
    log4jCodeGenerateUtil.logInfo(node,"info",cid+" - Executing SQL:\"+queryUpdatePrefix_"+cid+"+queryLockUpdate_"+cid+"+\" TALEND_CDC_STATE ='1'");
    ...
    log4jCodeGenerateUtil.logInfo(node,"info",cid+" - Executing SQL:\"+queryResetLocks_"+cid+"+\"");
    ...
    stringBuffer.append(TEXT_109);
            	...
            	log4jCodeGenerateUtil.logInfo(node,"info",cid+" - Try to detach from outbound server:\"+"+ outBoundServer+"+\"");
            	
    stringBuffer.append(TEXT_110);
    stringBuffer.append(cid);
    stringBuffer.append(TEXT_111);
    
				log4jCodeGenerateUtil.logInfo(node,"info",cid+" - Detached successfully.");
    ...
    stringBuffer.append(TEXT_114);
				...
				log4jCodeGenerateUtil.logInfo(node,"error",cid+" - Cannot detach from the outbound server: \"+"+ outBoundServer+"+\"");
