...
public class TInformixCDCEndJava
{
  protected static String nl;
  public static synchronized TInformixCDCEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInformixCDCEndJava result = new TInformixCDCEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_73 = "+\" SET TALEND_CDC_STATE='x' WHERE TALEND_CDC_STATE='1' AND TALEND_CDC_SUBSCRIBERS_NAME='\"+";
  protected final String TEXT_74 = "+\"'\";" + NL + "\t";
  protected final String TEXT_75 = NL + "   \t\t\tstmt_";
  protected final String TEXT_76 = ".executeUpdate(queryUpdatePrefix_";
  protected final String TEXT_77 = "+queryLockUpdate_";
  protected final String TEXT_78 = ");";
  protected final String TEXT_79 = NL + "\t\t\tString queryResetLocks_";
  protected final String TEXT_80 = " = \"DELETE FROM \"+dataTableName_";
  protected final String TEXT_81 = " +\" WHERE TALEND_CDC_SUBSCRIBERS_NAME='\"+";
  protected final String TEXT_82 = "+\"' AND TALEND_CDC_STATE='1'\";" + NL + "\t";
  protected final String TEXT_83 = NL + "\t\t\tstmt_";
  protected final String TEXT_84 = ".executeUpdate(queryResetLocks_";
  protected final String TEXT_85 = ");" + NL + "\t";
  protected final String TEXT_86 = NL + "\t\t\tif(!conn_";
  protected final String TEXT_87 = ".getAutoCommit()) {" + NL + "\t\t\t\t";
