...
public class TOracleInvalidRowsBeginJava
{
  protected static String nl;
  public static synchronized TOracleInvalidRowsBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleInvalidRowsBeginJava result = new TOracleInvalidRowsBeginJava();
    nl = null;
    return result;
  }
  ...
  public String generate(Object argument)
  {
    ...
    stringBuffer.append(TEXT_207);
		...
		protected String getWhereString(){
			...
			sb.append(" NOT REGEXP_LIKE (").append(getAnalyzedColumn()).append(", ").append(getPatternString()).append(")");			
