...
public class TMysqlOutputSparkconfigJava {
  protected static String nl;
  public static synchronized TMysqlOutputSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMysqlOutputSparkconfigJava result = new TMysqlOutputSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_365 = ".close();" + NL + "" + NL + "rdd_";
  protected final String TEXT_366 = ".foreachPartition(new ";
  protected final String TEXT_367 = "_OutputFunction(job));";
