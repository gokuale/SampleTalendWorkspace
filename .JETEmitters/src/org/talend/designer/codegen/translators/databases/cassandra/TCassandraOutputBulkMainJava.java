...
public class TCassandraOutputBulkMainJava
{
  ...
  protected final String TEXT_34 = NL + "\tif(true){" + NL + "\t\tthrow new java.lang.Exception(\"A key should be specified in the schema.\");" + NL + "\t}";
  protected final String TEXT_35 = NL + "long timestamp_";
  protected final String TEXT_36 = " = System.currentTimeMillis() * 1000;" + NL + "nb_line_";
  protected final String TEXT_37 = " ++;";
  protected final String TEXT_38 = NL + "\tlog.debug(\"";
  protected final String TEXT_39 = " - Writing the record \" + (nb_line_";
  protected final String TEXT_40 = ") + \" to the SSTable directory.\");";
  protected final String TEXT_41 = NL + "\twriter_";
  protected final String TEXT_42 = ".addColumn(org.apache.cassandra.utils.ByteBufferUtil.bytes(\"";
  protected final String TEXT_43 = "\"),";
  protected final String TEXT_44 = ",timestamp_";
