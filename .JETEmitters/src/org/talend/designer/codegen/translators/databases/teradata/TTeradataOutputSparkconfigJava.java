...
public class TTeradataOutputSparkconfigJava {
  protected static String nl;
  public static synchronized TTeradataOutputSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataOutputSparkconfigJava result = new TTeradataOutputSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_375 = ".close();" + NL + "" + NL + "rdd_";
  protected final String TEXT_376 = ".foreachPartition(new ";
  protected final String TEXT_377 = "_OutputFunction(job));";
