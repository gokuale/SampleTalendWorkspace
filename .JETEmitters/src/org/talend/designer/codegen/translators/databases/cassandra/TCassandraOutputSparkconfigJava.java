...
public class TCassandraOutputSparkconfigJava
{
  protected static String nl;
  public static synchronized TCassandraOutputSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCassandraOutputSparkconfigJava result = new TCassandraOutputSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_112 = NL + "\t\trdd_";
  protected final String TEXT_113 = ".rdd().conf().set(";
  protected final String TEXT_114 = ", ";
  protected final String TEXT_115 = ");\t" + NL + "\t";
  protected final String TEXT_116 = NL + "\tjava.util.Map<String, String> columnMapping_";
  protected final String TEXT_117 = " = new java.util.HashMap<String, String>();" + NL + "\t";
  protected final String TEXT_118 = NL + "\t\t\tcolumnMapping_";
  protected final String TEXT_119 = ".put(\"";
  protected final String TEXT_120 = "\", \"";
  protected final String TEXT_121 = "\");" + NL + "    \t";
  protected final String TEXT_122 = NL + "\tcom.datastax.spark.connector.japi.CassandraJavaUtil.javaFunctions(rdd_";
  protected final String TEXT_123 = ").writerBuilder(" + NL + "    \t\t";
  protected final String TEXT_124 = ", ";
  protected final String TEXT_125 = ", " + NL + "    \t\tcom.datastax.spark.connector.japi.CassandraJavaUtil.mapToRow(";
  protected final String TEXT_126 = ".class, columnMapping_";
  protected final String TEXT_127 = ")" + NL + "\t\t)" + NL + "\t\t.withColumnSelector(com.datastax.spark.connector.japi.CassandraJavaUtil.someColumns(";
  protected final String TEXT_128 = "))" + NL + "\t\t.saveToCassandra();";
  protected final String TEXT_129 = NL + "\trdd_";
  protected final String TEXT_130 = ".foreachPartition(new ";
  protected final String TEXT_131 = "_OutputFunction(job));";
