...
public class TPostgresqlInvalidRowsEndJava
{
  protected static String nl;
  public static synchronized TPostgresqlInvalidRowsEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresqlInvalidRowsEndJava result = new TPostgresqlInvalidRowsEndJava();
    nl = null;
    return result;
  }
