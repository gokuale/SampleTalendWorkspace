...
public class TActionRejectBeginJava
{
  protected static String nl;
  public static synchronized TActionRejectBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TActionRejectBeginJava result = new TActionRejectBeginJava();
    nl = null;
    return result;
  }
