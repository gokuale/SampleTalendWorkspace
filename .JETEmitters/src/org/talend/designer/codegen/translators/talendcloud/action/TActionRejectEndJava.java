...
public class TActionRejectEndJava
{
  protected static String nl;
  public static synchronized TActionRejectEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TActionRejectEndJava result = new TActionRejectEndJava();
    nl = null;
    return result;
  }
