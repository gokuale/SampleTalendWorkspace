...
public class THDFSOutputBeginJava
{
  ...
  protected final String TEXT_96 = "\t\t\t" + NL + "\t\torg.apache.hadoop.fs.FSDataOutputStream fsDataOutputStream_";
  ...
  protected final String TEXT_100 = ")) {" + NL + "    \t\t\tfsDataOutputStream_";
  protected final String TEXT_101 = " = fs_";
  protected final String TEXT_102 = ".create(path_";
  protected final String TEXT_103 = ",false);" + NL + "    \t\t} else {" + NL + "\t\t\t\tfsDataOutputStream_";
  protected final String TEXT_104 = " = fs_";
  protected final String TEXT_105 = ".append(path_";
  protected final String TEXT_106 = ");" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_107 = NL + "\t\t\tfsDataOutputStream_";
  protected final String TEXT_108 = " = fs_";
  protected final String TEXT_109 = ".create(path_";
  protected final String TEXT_110 = ", ";
  protected final String TEXT_111 = ");" + NL + "\t\t";
  protected final String TEXT_112 = NL + "\t\t\tjava.io.Writer out";
  protected final String TEXT_113 = " = null;" + NL + "\t\t\tout";
  protected final String TEXT_114 = "=new java.io.BufferedWriter(new java.io.OutputStreamWriter(fsDataOutputStream_";
  protected final String TEXT_115 = ",";
  protected final String TEXT_116 = "));" + NL + "\t";
  protected final String TEXT_117 = NL + "\t\t\t\torg.apache.hadoop.io.compress.GzipCodec codec_";
  protected final String TEXT_118 = " = new org.apache.hadoop.io.compress.GzipCodec();" + NL + "\t\t\t\tcodec_";
  protected final String TEXT_119 = ".setConf(conf_";
  protected final String TEXT_120 = ");";
  protected final String TEXT_121 = NL + "\t\t\t\torg.apache.hadoop.io.compress.CompressionCodec codec_";
  protected final String TEXT_122 = " = org.apache.hadoop.util.ReflectionUtils.newInstance(org.apache.hadoop.io.compress.BZip2Codec.class, conf_";
  protected final String TEXT_123 = ");";
  protected final String TEXT_124 = NL + "\t\t\torg.apache.hadoop.io.compress.CompressionOutputStream out";
  protected final String TEXT_125 = " = codec_";
  protected final String TEXT_126 = ".createOutputStream(fsDataOutputStream_";
  protected final String TEXT_127 = ");";
  protected final String TEXT_128 = NL + "\t\t\tboolean fileExistAndHasContent_";
  protected final String TEXT_129 = " = false;" + NL + "\t\t\tif(fs_";
  protected final String TEXT_130 = ".exists(path_";
  protected final String TEXT_131 = ")) {" + NL + "\t\t\t\torg.apache.hadoop.fs.FileStatus statu_";
  protected final String TEXT_132 = " = fs_";
  protected final String TEXT_133 = ".getFileStatus(path_";
  protected final String TEXT_134 = ");" + NL + "\t\t\t\tfileExistAndHasContent_";
  protected final String TEXT_135 = " = (!statu_";
  protected final String TEXT_136 = ".isDir()) && (statu_";
  protected final String TEXT_137 = ".getLen() != 0);" + NL + "\t\t\t}" + NL + "\t\t\tif(!fileExistAndHasContent_";
  protected final String TEXT_138 = ") {";
  protected final String TEXT_139 = NL + "\t\t\tStringBuilder header_";
  protected final String TEXT_140 = " = new StringBuilder();";
  protected final String TEXT_141 = NL + "\t\t\t\theader_";
  ...
  protected final String TEXT_150 = NL + "\t\t\tout";
  protected final String TEXT_151 = ".write(header_";
  protected final String TEXT_152 = ".toString());";
  protected final String TEXT_153 = NL + "\t\t\tout";
  protected final String TEXT_154 = ".write(header_";
  protected final String TEXT_155 = ".toString().getBytes(";
  protected final String TEXT_156 = "));";
  protected final String TEXT_157 = NL + "\t\t\t}";
  protected final String TEXT_158 = NL + NL + "\t\t";
  protected final String TEXT_159 = NL;
  protected final String TEXT_160 = NL + "\torg.apache.hadoop.io.SequenceFile.Writer writer_";
  protected final String TEXT_161 = " = new org.apache.hadoop.io.SequenceFile.Writer(fs_";
  protected final String TEXT_162 = ", conf_";
  protected final String TEXT_163 = ", path_";
  protected final String TEXT_164 = ", ";
  protected final String TEXT_165 = ".class, ";
  protected final String TEXT_166 = ".class);" + NL + "\t";
  protected final String TEXT_167 = NL + "\torg.apache.hadoop.io.SequenceFile.Writer writer_";
  protected final String TEXT_168 = " = org.apache.hadoop.io.SequenceFile.createWriter(fs_";
  protected final String TEXT_169 = ", conf_";
  protected final String TEXT_170 = ", path_";
  protected final String TEXT_171 = ", ";
  protected final String TEXT_172 = ".class, ";
  protected final String TEXT_173 = ".class, org.apache.hadoop.io.SequenceFile.CompressionType.BLOCK, new org.apache.hadoop.io.compress.GzipCodec());";
  protected final String TEXT_174 = NL + "\torg.apache.hadoop.io.SequenceFile.Writer writer_";
  protected final String TEXT_175 = " = org.apache.hadoop.io.SequenceFile.createWriter(fs_";
  protected final String TEXT_176 = ", conf_";
  protected final String TEXT_177 = ", path_";
  protected final String TEXT_178 = ", ";
  protected final String TEXT_179 = ".class, ";
  protected final String TEXT_180 = ".class, org.apache.hadoop.io.SequenceFile.CompressionType.BLOCK, new org.apache.hadoop.io.compress.BZip2Codec());";
  protected final String TEXT_181 = NL + "\t\t\tList<";
  protected final String TEXT_182 = "Struct> ";
  protected final String TEXT_183 = "_list_";
  protected final String TEXT_184 = "= new java.util.ArrayList<";
