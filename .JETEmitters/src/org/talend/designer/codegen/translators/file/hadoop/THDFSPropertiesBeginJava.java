...
public class THDFSPropertiesBeginJava
{
  ...
  protected final String TEXT_94 = "Struct();" + NL + "\torg.apache.hadoop.fs.Path path_";
  protected final String TEXT_95 = " = new org.apache.hadoop.fs.Path(";
  protected final String TEXT_96 = ");" + NL + "\t" + NL + "\tif(fs_";
  protected final String TEXT_97 = ".exists(path_";
  protected final String TEXT_98 = ")) {" + NL + "\t    ";
  protected final String TEXT_99 = ".abs_path = path_";
  protected final String TEXT_100 = ".toString();" + NL + "\t    ";
  protected final String TEXT_101 = ".dirname = path_";
  protected final String TEXT_102 = ".getParent().toString();" + NL + "\t    ";
  protected final String TEXT_103 = ".basename = path_";
  protected final String TEXT_104 = ".getName();" + NL + "\t    " + NL + "\t    org.apache.hadoop.fs.FileStatus statu_";
  protected final String TEXT_105 = " = fs_";
  protected final String TEXT_106 = ".getFileStatus(path_";
  protected final String TEXT_107 = ");" + NL + "\t    " + NL + "\t    StringBuffer stringBuffer_";
  protected final String TEXT_108 = " = new StringBuffer();" + NL + "\t    stringBuffer_";
  protected final String TEXT_109 = ".append(statu_";
  protected final String TEXT_110 = ".getPermission());" + NL + "\t    stringBuffer_";
  protected final String TEXT_111 = ".append(\"(owner=\");" + NL + "\t    stringBuffer_";
  protected final String TEXT_112 = ".append(statu_";
  protected final String TEXT_113 = ".getOwner());" + NL + "\t    stringBuffer_";
  protected final String TEXT_114 = ".append(\",\");" + NL + "\t    stringBuffer_";
  protected final String TEXT_115 = ".append(\"group=\");" + NL + "\t    stringBuffer_";
  protected final String TEXT_116 = ".append(statu_";
  protected final String TEXT_117 = ".getGroup());" + NL + "\t    stringBuffer_";
  protected final String TEXT_118 = ".append(\")\");" + NL + "\t    ";
  protected final String TEXT_119 = ".mode_string = stringBuffer_";
  protected final String TEXT_120 = ".toString();" + NL + "\t    " + NL + "\t    ";
  protected final String TEXT_121 = ".size = statu_";
  protected final String TEXT_122 = ".getLen();" + NL + "\t    ";
  protected final String TEXT_123 = ".mtime = statu_";
  protected final String TEXT_124 = ".getModificationTime();" + NL + "\t    ";
  protected final String TEXT_125 = ".mtime_string =(new java.util.Date(statu_";
  protected final String TEXT_126 = ".getModificationTime())).toString();" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_127 = NL + "\t\t\tif(!statu_";
  protected final String TEXT_128 = ".isDir()) {" + NL + "\t\t\t\torg.apache.hadoop.fs.FileChecksum checksum_";
  protected final String TEXT_129 = " = fs_";
  protected final String TEXT_130 = ".getFileChecksum(path_";
  protected final String TEXT_131 = ");" + NL + "\t\t\t\tif(checksum_";
  protected final String TEXT_132 = "!=null) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_133 = ".md5 = checksum_";
  protected final String TEXT_134 = ".toString();" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_135 = NL + "\t\t" + NL + "\t\t" + NL + "\t}" + NL + "\t";
  protected final String TEXT_136 = NL + "\telse {" + NL + "\t\tlog.warn(\"";
  protected final String TEXT_137 = " - file or directory : \" + path_";
  protected final String TEXT_138 = " + \" does not exist.\");" + NL + "\t}" + NL + "\t";
