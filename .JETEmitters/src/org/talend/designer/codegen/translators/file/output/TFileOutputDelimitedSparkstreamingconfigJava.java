...
public class TFileOutputDelimitedSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TFileOutputDelimitedSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputDelimitedSparkstreamingconfigJava result = new TFileOutputDelimitedSparkstreamingconfigJava();
    nl = null;
    return result;
  }
