...
public class TFileOutputXMLSparkconfigJava
{
  protected static String nl;
  public static synchronized TFileOutputXMLSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputXMLSparkconfigJava result = new TFileOutputXMLSparkconfigJava();
    nl = null;
    return result;
  }
