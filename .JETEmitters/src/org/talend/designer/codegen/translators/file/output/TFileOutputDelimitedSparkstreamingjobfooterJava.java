...
public class TFileOutputDelimitedSparkstreamingjobfooterJava
{
  protected static String nl;
  public static synchronized TFileOutputDelimitedSparkstreamingjobfooterJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputDelimitedSparkstreamingjobfooterJava result = new TFileOutputDelimitedSparkstreamingjobfooterJava();
    nl = null;
    return result;
  }
