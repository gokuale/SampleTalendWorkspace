...
public class TFileInputParquetSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TFileInputParquetSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileInputParquetSparkstreamingcodeJava result = new TFileInputParquetSparkstreamingcodeJava();
    nl = null;
    return result;
  }
