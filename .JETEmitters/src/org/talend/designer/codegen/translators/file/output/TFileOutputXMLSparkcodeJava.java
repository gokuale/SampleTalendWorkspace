...
public class TFileOutputXMLSparkcodeJava
{
  protected static String nl;
  public static synchronized TFileOutputXMLSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputXMLSparkcodeJava result = new TFileOutputXMLSparkcodeJava();
    nl = null;
    return result;
  }
