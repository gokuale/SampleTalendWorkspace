...
public class TFileOutputJSONSparkconfigJava
{
  protected static String nl;
  public static synchronized TFileOutputJSONSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputJSONSparkconfigJava result = new TFileOutputJSONSparkconfigJava();
    nl = null;
    return result;
  }
