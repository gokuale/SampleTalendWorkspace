...
public class TFileOutputDelimitedSparkconfigJava
{
  protected static String nl;
  public static synchronized TFileOutputDelimitedSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputDelimitedSparkconfigJava result = new TFileOutputDelimitedSparkconfigJava();
    nl = null;
    return result;
  }
