...
public class TFileOutputPositionalSparkconfigJava
{
  protected static String nl;
  public static synchronized TFileOutputPositionalSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputPositionalSparkconfigJava result = new TFileOutputPositionalSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_8 = ".saveAsHadoopFile(";
  protected final String TEXT_9 = ", NullWritable.class, ";
  protected final String TEXT_10 = ".class, ";
  protected final String TEXT_11 = "StructOutputFormat.class);";
  protected final String TEXT_12 = NL + "            FileSystem.setDefaultUri(ctx.hadoopConfiguration(), currentURI_";
  protected final String TEXT_13 = "_config);" + NL + "            fs = FileSystem.get(ctx.hadoopConfiguration());";
