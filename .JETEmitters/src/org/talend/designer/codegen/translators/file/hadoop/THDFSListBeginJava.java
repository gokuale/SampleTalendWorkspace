...
public class THDFSListBeginJava
{
  ...
  protected final String TEXT_92 = NL + "\tjava.util.List<String> maskList_";
  protected final String TEXT_93 = " = new java.util.ArrayList<String>();" + NL + "\t";
  protected final String TEXT_94 = NL + "\t    maskList_";
  protected final String TEXT_95 = ".add(\"*\");" + NL + "\t    ";
  protected final String TEXT_96 = NL + "\t    maskList_";
  protected final String TEXT_97 = ".add(\".*\");" + NL + "\t    ";
  protected final String TEXT_98 = " " + NL + "    \tmaskList_";
  protected final String TEXT_99 = ".add(";
  protected final String TEXT_100 = ");" + NL + "  \t";
  protected final String TEXT_101 = NL + "  \t" + NL + "  \tint NB_FILE";
  protected final String TEXT_102 = " = 0;" + NL + "  \t" + NL + "  \tfor (String filemask_";
  protected final String TEXT_103 = " : maskList_";
  protected final String TEXT_104 = ") {//TD1024" + NL + "\t";
  protected final String TEXT_105 = NL + "\t\tfilemask_";
  protected final String TEXT_106 = " = org.apache.oro.text.GlobCompiler.globToPerl5(filemask_";
  protected final String TEXT_107 = ".toCharArray(), org.apache.oro.text.GlobCompiler.DEFAULT_MASK);" + NL + "\t";
  protected final String TEXT_108 = "   " + NL + "\t\tString excludefilemask_";
  protected final String TEXT_109 = " = ";
  protected final String TEXT_110 = ";" + NL + "    \tList<java.util.regex.Pattern> excludefileNameEachPattern_";
  protected final String TEXT_111 = " = new java.util.ArrayList<java.util.regex.Pattern>();" + NL + "\t   \tif(excludefilemask_";
  protected final String TEXT_112 = "!=null && !\"\".equals(excludefilemask_";
  protected final String TEXT_113 = ")) {" + NL + "\t\t  \tfor(String excludefilemaskEach_";
  protected final String TEXT_114 = " : excludefilemask_";
  protected final String TEXT_115 = ".split(\",\")) {" + NL + "\t\t  \t";
  protected final String TEXT_116 = NL + "\t\t  \t\texcludefilemaskEach_";
  protected final String TEXT_117 = " = org.apache.oro.text.GlobCompiler.globToPerl5(excludefilemaskEach_";
  protected final String TEXT_118 = ".toCharArray(), org.apache.oro.text.GlobCompiler.DEFAULT_MASK);" + NL + "\t\t  \t";
  protected final String TEXT_119 = NL + "\t\t\t\texcludefileNameEachPattern_";
  protected final String TEXT_120 = ".add(java.util.regex.Pattern.compile(excludefilemaskEach_";
  protected final String TEXT_121 = ",java.util.regex.Pattern.CASE_INSENSITIVE));" + NL + "\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\texcludefileNameEachPattern_";
  protected final String TEXT_123 = ".add(java.util.regex.Pattern.compile(excludefilemaskEach_";
  ...
  protected final String TEXT_129 = NL + "\tjava.util.regex.Pattern fileNamePattern_";
  protected final String TEXT_130 = " = java.util.regex.Pattern.compile(filemask_";
  protected final String TEXT_131 = ", java.util.regex.Pattern.CASE_INSENSITIVE);" + NL + "\t";
  protected final String TEXT_132 = NL + "\t" + NL + "\torg.apache.hadoop.fs.Path hdfsdir_";
  protected final String TEXT_133 = " = new org.apache.hadoop.fs.Path(";
  protected final String TEXT_134 = ");" + NL + "\tfinal java.util.List<org.apache.hadoop.fs.FileStatus> status_";
  protected final String TEXT_135 = " = new java.util.ArrayList<org.apache.hadoop.fs.FileStatus>();" + NL + "\tfinal org.apache.hadoop.fs.FileSystem filesystem_";
  protected final String TEXT_136 = " = fs_";
  protected final String TEXT_137 = ";" + NL + "\tfilesystem_";
  protected final String TEXT_138 = ".listStatus(hdfsdir_";
  protected final String TEXT_139 = ",new org.apache.hadoop.fs.PathFilter() {" + NL + "\t" + NL + "\t\tpublic boolean accept(org.apache.hadoop.fs.Path path) {" + NL + "\t\t\ttry {" + NL + "\t\t\t\torg.apache.hadoop.fs.FileStatus statu = filesystem_";
  protected final String TEXT_140 = ".getFileStatus(path);" + NL + "\t\t\t\tif(statu.isDir()) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_141 = NL + "\t\t\t\t\tstatus_";
  protected final String TEXT_142 = ".add(statu);" + NL + "\t\t\t\t\t";
  protected final String TEXT_143 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_144 = NL + "\t\t\t\t\tfilesystem_";
  protected final String TEXT_145 = ".listStatus(path, this);" + NL + "\t\t\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\t";
  protected final String TEXT_147 = NL + "\t\t\t\t\tstatus_";
  protected final String TEXT_148 = ".add(statu);" + NL + "\t\t\t\t\t";
  protected final String TEXT_149 = NL + "\t\t\t\t}" + NL + "\t\t\t} catch (java.io.FileNotFoundException e) {" + NL + "\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t" + NL + "        \t\t";
  protected final String TEXT_150 = NL + "               \tlog.error(\"";
  protected final String TEXT_151 = " - \" + e.getMessage());";
  protected final String TEXT_152 = NL + "\t\t\t} catch (java.io.IOException e) {" + NL + "\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t" + NL + "\t\t\t    ";
  protected final String TEXT_153 = NL + "               \tlog.error(\"";
  protected final String TEXT_154 = " - \" + e.getMessage());";
  protected final String TEXT_155 = NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "" + NL + "\t});" + NL + "\t" + NL + "\t";
  protected final String TEXT_156 = NL + "\tjava.util.Collections.sort(status_";
  protected final String TEXT_157 = ");" + NL + "\t";
  protected final String TEXT_158 = NL + "\tjava.util.Collections.sort(status_";
  protected final String TEXT_159 = ",new java.util.Comparator<org.apache.hadoop.fs.FileStatus>() {" + NL + "\t" + NL + "\t\tpublic int compare(org.apache.hadoop.fs.FileStatus f1, org.apache.hadoop.fs.FileStatus f2) {" + NL + "\t\t\tint result = 0;" + NL + "\t\t\tboolean f1IsFile = !f1.isDir(); " + NL + "\t\t\tboolean f2IsFile = !f2.isDir();" + NL + "\t\t\t" + NL + "\t\t\tif((f1IsFile && f2IsFile) || (!f1IsFile && !f2IsFile)) {" + NL + "\t\t\t\tresult = f1.getPath().getName().compareTo(f2.getPath().getName());" + NL + "\t\t\t} else if(f1IsFile && !f2IsFile) {" + NL + "\t\t\t\tresult = 1;" + NL + "\t\t\t} else if(!f1IsFile && f2IsFile) {" + NL + "\t\t\t\tresult = -1;" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\treturn ";
  protected final String TEXT_160 = "-";
  protected final String TEXT_161 = "result;" + NL + "\t\t}" + NL + "\t\t\t\t" + NL + "\t});" + NL + "\t";
  ...
  protected final String TEXT_172 = " - Start to list files\");" + NL + "\t";
  protected final String TEXT_173 = NL + "\tfor(int i_";
  protected final String TEXT_174 = "=0;i_";
  protected final String TEXT_175 = "<status_";
  protected final String TEXT_176 = ".size();i_";
  protected final String TEXT_177 = "++) {//TD512" + NL + "\t\torg.apache.hadoop.fs.FileStatus file_";
  protected final String TEXT_178 = " = status_";
  protected final String TEXT_179 = ".get(i_";
  protected final String TEXT_180 = ");" + NL + "\t\torg.apache.hadoop.fs.Path path_";
  protected final String TEXT_181 = " = file_";
  protected final String TEXT_182 = ".getPath();" + NL + "\t\tString fileName_";
  protected final String TEXT_183 = " = path_";
  protected final String TEXT_184 = ".getName();" + NL + "\t\t" + NL + "\t\tif (!fileNamePattern_";
  protected final String TEXT_185 = ".matcher(fileName_";
  protected final String TEXT_186 = ").matches()){" + NL + "          continue;" + NL + "        }" + NL + "        " + NL + "\t\t";
  protected final String TEXT_187 = " " + NL + "        boolean isExclude_";
  protected final String TEXT_188 = " = false;" + NL + "        for(java.util.regex.Pattern pattern : excludefileNameEachPattern_";
  protected final String TEXT_189 = ") {" + NL + "        \tif(pattern.matcher(fileName_";
  protected final String TEXT_190 = ").matches()) {" + NL + "        \t\tisExclude_";
  protected final String TEXT_191 = " = true;" + NL + "        \t\tbreak;" + NL + "        \t}" + NL + "        }" + NL + "        if(isExclude_";
  protected final String TEXT_192 = ") {" + NL + "          continue;" + NL + "        }" + NL + "\t\t";
  protected final String TEXT_193 = NL + "\t\t" + NL + "\t\tString currentFileName_";
  protected final String TEXT_194 = " = fileName_";
  protected final String TEXT_195 = ";" + NL + "\t\tString currentFilePath_";
  protected final String TEXT_196 = " = path_";
  protected final String TEXT_197 = ".toString();" + NL + "\t\tString currentFileDirectory_";
  protected final String TEXT_198 = " = path_";
  protected final String TEXT_199 = ".getParent().toString();" + NL + "\t\tString currentFileExtension_";
  protected final String TEXT_200 = " = \"\";" + NL + "\t\tif(!file_";
  protected final String TEXT_201 = ".isDir() && fileName_";
  protected final String TEXT_202 = ".contains(\".\")) {" + NL + "\t\t\tcurrentFileExtension_";
  protected final String TEXT_203 = " = fileName_";
  protected final String TEXT_204 = ".substring(fileName_";
  protected final String TEXT_205 = ".lastIndexOf(\".\")+1);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tNB_FILE";
  protected final String TEXT_206 = " ++;" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_207 = "_CURRENT_FILE\", currentFileName_";
  protected final String TEXT_208 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_209 = "_CURRENT_FILEPATH\", currentFilePath_";
  protected final String TEXT_210 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_211 = "_CURRENT_FILEDIRECTORY\", currentFileDirectory_";
  protected final String TEXT_212 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_213 = "_CURRENT_FILEEXTENSION\", currentFileExtension_";
  protected final String TEXT_214 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_215 = "_NB_FILE\", NB_FILE";
  protected final String TEXT_216 = ");" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_217 = NL + "\t\tlog.info(\"";
  protected final String TEXT_218 = " - Current file or directory path : \" + currentFilePath_";
