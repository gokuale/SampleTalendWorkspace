...
public class TFileOutputParquetSparkstreamingconfigJava
{
  ...
  protected final String TEXT_41 = "()).saveAsHadoopFiles(";
  ...
  protected final String TEXT_44 = NL + "            FileSystem.setDefaultUri(ctx.sparkContext().hadoopConfiguration(), currentURI_";
  protected final String TEXT_45 = "_config);" + NL + "            fs = FileSystem.get(ctx.sparkContext().hadoopConfiguration());";
