...
public class TFileOutputPositionalSparkstreamingjobfooterJava
{
  protected static String nl;
  public static synchronized TFileOutputPositionalSparkstreamingjobfooterJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputPositionalSparkstreamingjobfooterJava result = new TFileOutputPositionalSparkstreamingjobfooterJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_6 = "_footer = FileSystem.getDefaultUri(ctx.sparkContext().hadoopConfiguration());" + NL + "                    FileSystem.setDefaultUri(ctx.sparkContext().hadoopConfiguration(), new java.net.URI(";
  protected final String TEXT_7 = "));" + NL + "                    fs = FileSystem.get(ctx.sparkContext().hadoopConfiguration());";
  ...
  protected final String TEXT_31 = NL + "                    FileSystem.setDefaultUri(ctx.sparkContext().hadoopConfiguration(), currentURI_";
  protected final String TEXT_32 = "_footer);" + NL + "                    fs = FileSystem.get(ctx.sparkContext().hadoopConfiguration());";
