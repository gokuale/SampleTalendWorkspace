...
public class THDFSPutBeginJava
{
  ...
  protected final String TEXT_94 = " = 0;" + NL + "\t" + NL + "\tfs_";
  protected final String TEXT_95 = ".mkdirs(new org.apache.hadoop.fs.Path(";
  protected final String TEXT_96 = "));" + NL + "\tjava.util.List<String> msg_";
  protected final String TEXT_97 = " = new java.util.ArrayList<String>();" + NL + "    java.util.List<java.util.Map<String,String>> list_";
  ...
  protected final String TEXT_109 = "\t" + NL + "" + NL + "\tString localdir_";
  protected final String TEXT_110 = "  = ";
  protected final String TEXT_111 = ";\t" + NL + "\tfor (java.util.Map<String, String> map_";
