...
public class TFileOutputXMLSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TFileOutputXMLSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputXMLSparkstreamingcodeJava result = new TFileOutputXMLSparkstreamingcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_38 = " = new java.util.ArrayList<String>();" + NL + "" + NL + "        headers_";
  protected final String TEXT_39 = ".add(\"<?xml version=\\\"1.0\\\" encoding=\\\"\" + ";
