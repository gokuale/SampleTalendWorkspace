...
public class TFileOutputJSONSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TFileOutputJSONSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputJSONSparkstreamingconfigJava result = new TFileOutputJSONSparkstreamingconfigJava();
    nl = null;
    return result;
  }
