...
public class THDFSRenameBeginJava
{
  ...
  protected final String TEXT_93 = " = 0;" + NL + "\t" + NL + "    java.util.List<java.util.Map<String,String>> list_";
  protected final String TEXT_94 = " = new java.util.ArrayList<java.util.Map<String,String>>();\t" + NL + "\t";
  protected final String TEXT_95 = "    " + NL + "\t\tjava.util.Map<String,String> map_";
  protected final String TEXT_96 = "_";
  protected final String TEXT_97 = " = new java.util.HashMap<String,String>();" + NL + "\t\tmap_";
  protected final String TEXT_98 = "_";
  protected final String TEXT_99 = ".put(";
  protected final String TEXT_100 = ",";
  protected final String TEXT_101 = ");\t\t" + NL + "\t \tlist_";
  protected final String TEXT_102 = ".add(map_";
  protected final String TEXT_103 = "_";
  protected final String TEXT_104 = ");       " + NL + "\t";
  protected final String TEXT_105 = "\t" + NL + "" + NL + "\tfor (java.util.Map<String, String> map_";
  protected final String TEXT_106 = " : list_";
