...
public class TRecommendSparkconfigJava
{
  protected static String nl;
  public static synchronized TRecommendSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRecommendSparkconfigJava result = new TRecommendSparkconfigJava();
    nl = null;
    return result;
  }
