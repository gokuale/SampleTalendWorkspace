...
public class TRecommendSparkcodeJava
{
  protected static String nl;
  public static synchronized TRecommendSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRecommendSparkcodeJava result = new TRecommendSparkcodeJava();
    nl = null;
    return result;
  }
